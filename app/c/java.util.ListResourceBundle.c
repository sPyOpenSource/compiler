...
void func_java_util_ListResourceBundle__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 51 , L307488715 , bytecode index = 
    ...
    ; 
    //  line no 52 , L758572926 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
struct java_lang_Object* func_java_util_ListResourceBundle_handleGetObject__Ljava_lang_String_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_String* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 70 , L990679445 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 70;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 71 , L913065088 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    ...
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L50503805;
    ; 
    //  line no 73 , L1557989809 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[2].obj;
    stack[sp++].i = local[3].i;
    // arrload __refer  ,  L1557989809 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    if(stack[--sp].i  == 0) goto L146874094;
    ; 
    //  line no 74 , L2123222442 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    stack[sp++].i = local[3].i;
    // arrload __refer  ,  L2123222442 bc index = 
    {
        s32 idx = stack[--sp].i;
        JArray *arr = rstack[--sp].obj;
        if (!arr) {
    ...
    goto L746280996;
    L50503805:
    //  line no 76 , L50503805 , bytecode index = 
    // aconst null
    rstack[sp++].obj = NULL;
    method_exit(runtime);
    return rstack[sp - 1].obj;
...
struct java_util_Enumeration* func_java_util_ListResourceBundle_getKeys___Ljava_util_Enumeration_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 85 , L1555990397 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 85;
    rstack[sp++].obj = rlocal[0].obj;
    // invokevirtual java/util/ListResourceBundle.getContents()[[Ljava/lang/Object;
    ...
    ; 
    //  line no 87 , L1544078442 , bytecode index = 
