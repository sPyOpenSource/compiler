...
void func_java_util_Collections_000242__init___Ljava_lang_Object_2_V(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 4815 , L1155769010 , bytecode index = 
    ...
    // it's a empty method
    ; 
    //  line no 4816 , L269892014 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    //  lconst 1
    stack[sp].j = 1;
    sp += 2;
...
struct java_util_Spliterator* func_java_util_Collections_000242_trySplit___Ljava_util_Spliterator_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 4820 , L489411441 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 4820;
    // aconst null
    rstack[sp++].obj = NULL;
...
s8 func_java_util_Collections_000242_tryAdvance__Ljava_util_function_Consumer_2_Z(JThreadRuntime *runtime, struct java_util_function_Consumer* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 4825 , L1711185459 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 4825;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    --sp; //pop
    ; 
    //  line no 4826 , L25936709 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    if(stack[--sp].i  <= 0) goto L1123559518;
    ; 
    //  line no 4827 , L649769713 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // dup
    ...
    ((struct java_util_Collections_000242*)rstack[sp + 0].obj)->est_0 = stack[sp + 1].j;
    ; 
    //  line no 4828 , L925150995 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 4829 , L1760219993 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    method_exit(runtime);
    return stack[sp - 1].i;
    L1123559518:
    //  line no 4831 , L1123559518 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    method_exit(runtime);
    return stack[sp - 1].i;
...
void func_java_util_Collections_000242_forEachRemaining__Ljava_util_function_Consumer_2_V(JThreadRuntime *runtime, struct java_util_function_Consumer* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 4836 , L403547747 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 4836;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    --sp; //pop
    ; 
    //  line no 4837 , L172215878 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
s64 func_java_util_Collections_000242_estimateSize___J(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 4841 , L1112456099 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/Collections$2 est J
    stack[sp - 1].j = ((struct java_util_Collections_000242*)rstack[sp - 1].obj)->est_0;
    sp += 1;
...
s32 func_java_util_Collections_000242_characteristics___I(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 4846 , L589363823 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 4846;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/Collections$2 val$element Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct java_util_Collections_000242*)rstack[sp - 1].obj)->val_00024element_1;
    sp += 0;
    if(rstack[--sp].obj  == NULL) goto L2052457859;
    //  sipush 256
    stack[sp++].i = 256;
    goto L1299327689;
    L2052457859:
    ...
    ; 
    //  line no 4848 , L1408279755 , bytecode index = 
