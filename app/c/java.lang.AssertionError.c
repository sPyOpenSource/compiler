...
void func_java_lang_AssertionError__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 49 , L1587819720 , bytecode index = 
    ...
    ; 
    //  line no 50 , L1002191352 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_lang_AssertionError__init___Ljava_lang_String_2_V(JThreadRuntime *runtime, struct java_lang_String* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 58 , L704024720 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 58;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 59 , L1452012306 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_lang_AssertionError__init___Ljava_lang_Object_2_V(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 74 , L1486566962 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 74;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 75 , L1173643169 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // instanceof java/lang/Throwable
    stack[sp - 1].i = instance_of_classname_index(rstack[sp - 1].obj, 181);
    if(stack[--sp].i  == 0) goto L1282287470;
    ; 
    //  line no 76 , L1397616978 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    --sp; //pop
    L1282287470:
    //  line no 77 , L1282287470 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_lang_AssertionError__init___Z_V(JThreadRuntime *runtime, s8 p0){
    ...
    local[0].i = p0;
    ; 
    //  line no 88 , L889729797 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 88;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 89 , L148912029 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_lang_AssertionError__init___C_V(JThreadRuntime *runtime, u16 p0){
    ...
    local[0].i = p0;
    ; 
    //  line no 100 , L1436664465 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 100;
    rstack[sp++].obj = rlocal[0].obj;
    stack[sp++].i = local[1].i;
    ...
    ; 
    //  line no 101 , L558187323 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_lang_AssertionError__init___I_V(JThreadRuntime *runtime, s32 p0){
    ...
    local[0].i = p0;
    ; 
    //  line no 112 , L1088872417 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 112;
    rstack[sp++].obj = rlocal[0].obj;
    stack[sp++].i = local[1].i;
    ...
    ; 
    //  line no 113 , L453523494 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_lang_AssertionError__init___J_V(JThreadRuntime *runtime, s64 p0){
    ...
    local[0].j = p0;
    ; 
    //  line no 124 , L1052967153 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 124;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 125 , L1210898719 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_lang_AssertionError__init___F_V(JThreadRuntime *runtime, f32 p0){
    ...
    local[0].f = p0;
    ; 
    //  line no 136 , L2104028992 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 136;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 137 , L1527430292 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_lang_AssertionError__init___D_V(JThreadRuntime *runtime, f64 p0){
    ...
    local[0].d = p0;
    ; 
    //  line no 148 , L521960438 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 148;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 149 , L632587706 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_lang_AssertionError__init___Ljava_lang_String_2Ljava_lang_Throwable_2_V(JThreadRuntime *runtime, struct java_lang_String* p0, struct java_lang_Throwable* p1){
    ...
    rlocal[1].obj = p1;
    ; 
    //  line no 165 , L1567885839 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 165;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 166 , L558569884 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
