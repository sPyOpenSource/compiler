// CLASS: org/luaj/vm2/lib/StringLib$_char extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_StringLib_00024_1char_static {};



__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_lib_StringLib_00024_1char[] = {
    func_org_luaj_vm2_lib_StringLib_00024_1char_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024_1char_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024_1char_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_StringLib_00024_1char_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_StringLib_00024_1char[] = {
    {317, 1, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_lib_StringLib_00024_1char}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1char_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_StringLib_00024_1char__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1969, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 151 , L1836887461 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_StringLib_00024_1char__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_StringLib_00024_1char__init____V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_StringLib_00024_1char_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1970, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 153 , L2113989903 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 153;
    ...
    ; 
    //  line no 154 , L185583672 , bytecode index = 
    ...
    ; 
    //  line no 155 , L60181881 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    ...
    stack[sp++].i = local[2].i;
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L1861329337;
    ; 
    //  line no 156 , L1606272155 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 157 , L1702178880 , bytecode index = 
    stack[sp++].i = local[6].i;
    if(stack[--sp].i  < 0) goto L693417450;
    stack[sp++].i = local[6].i;
    //  sipush 256
    stack[sp++].i = 256;
    sp -= 2;
    if(stack[sp + 0].i  < stack[sp + 1].i) goto L1254827280;
    L693417450:
    stack[sp++].i = local[5].i;
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3455);
    ...
    // invokestatic org/luaj/vm2/lib/StringLib$_char.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
    ...
    --sp; //pop
    L1254827280:
    //  line no 158 , L1254827280 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    stack[sp++].i = local[4].i;
    stack[sp++].i = local[6].i;
    stack[sp - 1].i = (s8)stack[sp - 1].i; 
    // arrstore s8  ,  L1254827280 bc index = 
    {
        ;
        s8 value = stack[--sp].i;
        s32 idx = stack[--sp].i;
    ...
    ; 
    //  line no 155 , L2078517710 , bytecode index = 
    // iinc slot 4 value 1
    local[4].i += 1;
    // iinc slot 5 value 1
    local[5].i += 1;
    ...
    goto L457893088;
    L1861329337:
    //  line no 160 , L1861329337 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
...
void bridge_org_luaj_vm2_lib_StringLib_00024_1char_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_StringLib_00024_1char_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
