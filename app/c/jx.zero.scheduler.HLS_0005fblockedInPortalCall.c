...
VMTable vmtable_jx_zero_scheduler_HLS_1blockedInPortalCall[] = {
    {43, 1, arr_vmtable_jx_zero_scheduler_HLS_1blockedInPortalCall_from_jx_zero_scheduler_HLS_1blockedInPortalCall}, //0
    {5, 10, arr_vmtable_jx_zero_scheduler_HLS_1blockedInPortalCall_from_java_lang_Object}, //1
};
