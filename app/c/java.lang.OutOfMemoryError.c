...
// generation
// globals
//struct java_lang_OutOfMemoryError_static {};
...
void func_java_lang_OutOfMemoryError__init___Ljava_lang_String_2_V(JThreadRuntime *runtime, struct java_lang_String* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 6 , L567294307 , bytecode index = 
    ...
    ; 
    //  line no 7 , L527829831 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
// stack: 1
// args: 0
void func_java_lang_OutOfMemoryError__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 8 , L1020155847 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 8;
    rstack[sp++].obj = rlocal[0].obj;
