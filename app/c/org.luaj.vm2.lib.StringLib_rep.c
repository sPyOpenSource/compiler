// CLASS: org/luaj/vm2/lib/StringLib$rep extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_StringLib_00024rep_static {};



__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_lib_StringLib_00024rep[] = {
    func_org_luaj_vm2_lib_StringLib_00024rep_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024rep_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024rep_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_StringLib_00024rep_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_StringLib_00024rep[] = {
    {378, 1, arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_lib_StringLib_00024rep}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024rep_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_StringLib_00024rep__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3129, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 675 , L922150177 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_StringLib_00024rep__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_StringLib_00024rep__init____V(runtime, ins);
}
...
// stack: 5
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_StringLib_00024rep_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3130, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 677 , L814886797 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 677;
    ...
    ; 
    //  line no 678 , L1344345219 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    ; 
    //  line no 679 , L1375681611 , bytecode index = 
    ...
    ; 
    //  line no 680 , L343023757 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // invokevirtual org/luaj/vm2/LuaString.length()I
    {
        sp -= 0;
    ...
    ; 
    //  line no 681 , L901614537 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    ...
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L1171611746;
    ; 
    //  line no 682 , L1076250141 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // iconst_0
    stack[sp++].i = 0;
    rstack[sp++].obj = rlocal[4].obj;
    ...
    ; 
    //  line no 681 , L421293587 , bytecode index = 
    stack[sp++].i = local[6].i;
    stack[sp++].i = local[5].i;
    stack[sp - 2].i = stack[sp - 2].i + stack[sp - 1].i; 
    --sp;
    ...
    goto L1843397873;
    L1171611746:
    //  line no 684 , L1171611746 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
...
void bridge_org_luaj_vm2_lib_StringLib_00024rep_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_StringLib_00024rep_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
