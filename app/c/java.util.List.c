...
void func_java_util_List_sort__Ljava_util_Comparator_2_V(JThreadRuntime *runtime, struct java_util_Comparator* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 56 , L970535245 , bytecode index = 
    ...
    ; 
    //  line no 57 , L194481424 , bytecode index = 
    ...
    ; 
    //  line no 58 , L1534755892 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 59 , L1548081008 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    rlocal[4].obj = rstack[--sp].obj;
    rstack[sp++].obj = rlocal[4].obj;
    // arraylength  label  L1548081008
    if (!rstack[sp - 1].obj) {
        rstack[sp++].obj = construct_and_throw_exception(runtime, 1, 
        goto __ExceptionHandler;
    }
    ...
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L464400749;
    rstack[sp++].obj = rlocal[4].obj;
    stack[sp++].i = local[6].i;
    // arrload __refer  ,  L753321708 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    ; 
    //  line no 60 , L343563528 , bytecode index = 
    ...
    --sp; //pop
    ; 
    //  line no 61 , L1719072416 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    ...
    goto L753321708;
    L464400749:
    //  line no 63 , L464400749 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
