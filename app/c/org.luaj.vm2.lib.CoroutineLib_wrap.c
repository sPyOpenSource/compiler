// CLASS: org/luaj/vm2/lib/CoroutineLib$wrap extends org/luaj/vm2/lib/LibFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_CoroutineLib_00024wrap_static {};



__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_lib_CoroutineLib_00024wrap[] = {
    func_org_luaj_vm2_lib_CoroutineLib_00024wrap_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024wrap_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024wrap_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap[] = {
    {324, 1, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_lib_CoroutineLib_00024wrap}, //0
    {18, 9, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_lib_LibFunction}, //1
    {19, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_LuaFunction}, //2
    {1, 210, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_LuaValue}, //3
    {2, 63, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_org_luaj_vm2_Varargs}, //4
    {5, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrap_from_java_lang_Object}, //5
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_CoroutineLib_00024wrap__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_CoroutineLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3149, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 122 , L126147004 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 122;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/CoroutineLib$wrap this$0 Lorg/luaj/vm2/lib/CoroutineLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_CoroutineLib_00024wrap*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024wrap__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_CoroutineLib_00024wrap__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(runtime, ins);
}
...
// stack: 4
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_CoroutineLib_00024wrap_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3150, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 124 , L1113666007 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 124;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 125 , L1570117874 , bytecode index = 
    ...
    ++sp;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/CoroutineLib$wrap this$0 Lorg/luaj/vm2/lib/CoroutineLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_CoroutineLib_00024wrap*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    // invokespecial org/luaj/vm2/LuaThread.<init>(Lorg/luaj/vm2/Globals;Lorg/luaj/vm2/LuaValue;)V
    {
        sp -= 2;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_LuaThread__init___Lorg_luaj_vm2_Globals_2Lorg_luaj_vm2_LuaValue_2_V(runtime, rstack[sp + 0].obj, rstack[sp + 1].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 126 , L2088661957 , bytecode index = 
    // new org/luaj/vm2/lib/CoroutineLib$wrapper
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 345);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ++sp;
    rstack[sp++].obj = rlocal[3].obj;
    // invokespecial org/luaj/vm2/lib/CoroutineLib$wrapper.<init>(Lorg/luaj/vm2/LuaThread;)V
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_lib_CoroutineLib_00024wrapper__init___Lorg_luaj_vm2_LuaThread_2_V(runtime, rstack[sp + 0].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024wrap_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_CoroutineLib_00024wrap_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
