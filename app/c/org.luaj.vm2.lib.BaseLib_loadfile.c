// CLASS: org/luaj/vm2/lib/BaseLib$loadfile extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024loadfile_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_lib_BaseLib_00024loadfile[] = {
    func_org_luaj_vm2_lib_BaseLib_00024loadfile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024loadfile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024loadfile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024loadfile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile[] = {
    {185, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_lib_BaseLib_00024loadfile}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024loadfile_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_BaseLib_00024loadfile__init___Lorg_luaj_vm2_lib_BaseLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_BaseLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 944, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 208 , L1509309988 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 208;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/BaseLib$loadfile this$0 Lorg/luaj/vm2/lib/BaseLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_BaseLib_00024loadfile*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024loadfile__init___Lorg_luaj_vm2_lib_BaseLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024loadfile__init___Lorg_luaj_vm2_lib_BaseLib_2_V(runtime, ins);
}
...
// stack: 5
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_BaseLib_00024loadfile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 945, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 210 , L2091072548 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 210;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  != 0) goto L263053820;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    ...
    if(stack[--sp].i  == 0) goto L1740826931;
    L263053820:
    // iconst_1
    stack[sp++].i = 1;
    goto L69062746;
    ...
    ; 
    //  line no 211 , L1631227617 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    // invokevirtual org/luaj/vm2/Varargs.isstring(I)Z
    ...
    if(stack[--sp].i  == 0) goto L24650043;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    ...
    ; 
    //  line no 212 , L460741164 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    //  ldc 
    ...
    ; 
    //  line no 213 , L781091365 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_3
    stack[sp++].i = 3;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/BaseLib$loadfile this$0 Lorg/luaj/vm2/lib/BaseLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib_00024loadfile*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    sp += 0;
    // invokevirtual org/luaj/vm2/Varargs.optvalue(ILorg/luaj/vm2/LuaValue;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *,s32,struct org_luaj_vm2_LuaValue*) = find_method(__ins->vm_table, 2, 28);
        rstack[sp].obj = __func_p(runtime, stack[sp + 0].i, rstack[sp + 1].obj);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    ; 
    //  line no 214 , L1858015030 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    if(rstack[--sp].obj  != NULL) goto L25764044;
    ; 
    //  line no 215 , L671596011 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/BaseLib$loadfile this$0 Lorg/luaj/vm2/lib/BaseLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib_00024loadfile*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    goto L1925352804;
    L25764044:
    //  line no 216 , L25764044 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/BaseLib$loadfile this$0 Lorg/luaj/vm2/lib/BaseLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib_00024loadfile*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    L1925352804:
    //  line no 214 , L1925352804 , bytecode index = 
    method_exit(runtime);
...
void bridge_org_luaj_vm2_lib_BaseLib_00024loadfile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024loadfile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
