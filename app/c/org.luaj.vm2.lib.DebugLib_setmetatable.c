// CLASS: org/luaj/vm2/lib/DebugLib$setmetatable extends org/luaj/vm2/lib/TwoArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024setmetatable_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_lib_DebugLib_00024setmetatable[] = {
    func_org_luaj_vm2_lib_DebugLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_lib_TwoArgFunction[] = {
    func_org_luaj_vm2_lib_DebugLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //5
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //104
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable[] = {
    {166, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_lib_DebugLib_00024setmetatable}, //0
    {73, 5, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_lib_TwoArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setmetatable_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_DebugLib_00024setmetatable__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 878, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 314 , L1327234595 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_DebugLib_00024setmetatable__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024setmetatable__init____V(runtime, ins);
}
...
// stack: 2
// args: 2
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_DebugLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 879, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 316 , L1361393151 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 316;
    ...
    ; 
    //  line no 317 , L1901238627 , bytecode index = 
    ...
    L573136580:
    //  line no 318 , L573136580 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    // putstatic org/luaj/vm2/LuaNil s_metatable Lorg/luaj/vm2/LuaValue;
    sp -= 1;
    static_var_org_luaj_vm2_LuaNil.s_1metatable_45 = rstack[sp].obj;
    goto L1998949977;
    L1059524106:
    //  line no 319 , L1059524106 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    // putstatic org/luaj/vm2/LuaNumber s_metatable Lorg/luaj/vm2/LuaValue;
    sp -= 1;
    static_var_org_luaj_vm2_LuaNumber.s_1metatable_44 = rstack[sp].obj;
    goto L1998949977;
    L1524305331:
    //  line no 320 , L1524305331 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    // putstatic org/luaj/vm2/LuaBoolean s_metatable Lorg/luaj/vm2/LuaValue;
    sp -= 1;
    static_var_org_luaj_vm2_LuaBoolean.s_1metatable_46 = rstack[sp].obj;
    goto L1998949977;
    L443942537:
    //  line no 321 , L443942537 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    // putstatic org/luaj/vm2/LuaString s_metatable Lorg/luaj/vm2/LuaValue;
    sp -= 1;
    static_var_org_luaj_vm2_LuaString.s_1metatable_44 = rstack[sp].obj;
    goto L1998949977;
    L1916904573:
    //  line no 322 , L1916904573 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    // putstatic org/luaj/vm2/LuaFunction s_metatable Lorg/luaj/vm2/LuaValue;
    sp -= 1;
    static_var_org_luaj_vm2_LuaFunction.s_1metatable_44 = rstack[sp].obj;
    goto L1998949977;
    L1895143699:
    //  line no 323 , L1895143699 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    // putstatic org/luaj/vm2/LuaThread s_metatable Lorg/luaj/vm2/LuaValue;
    sp -= 1;
    static_var_org_luaj_vm2_LuaThread.s_1metatable_44 = rstack[sp].obj;
    goto L1998949977;
    L1638435724:
    //  line no 324 , L1638435724 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[3].obj;
    ...
    --sp; //pop
    L1998949977:
    //  line no 326 , L1998949977 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    method_exit(runtime);
...
void bridge_org_luaj_vm2_lib_DebugLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins, para[0].obj);
}
