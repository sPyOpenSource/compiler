// CLASS: org/luaj/vm2/lib/TableLib$remove extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_TableLib_00024remove_static {};



__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_lib_TableLib_00024remove[] = {
    func_org_luaj_vm2_lib_TableLib_00024remove_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_TableLib_00024remove_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_TableLib_00024remove_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_TableLib_00024remove_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_TableLib_00024remove[] = {
    {137, 1, arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_lib_TableLib_00024remove}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_TableLib_00024remove_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_TableLib_00024remove__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3234, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 127 , L1149217113 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_TableLib_00024remove__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_TableLib_00024remove__init____V(runtime, ins);
}
...
// stack: 4
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_TableLib_00024remove_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3235, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 129 , L121597447 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 129;
    ...
    ; 
    //  line no 130 , L748523772 , bytecode index = 
    ...
    ; 
    //  line no 131 , L353489239 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    ; 
    //  line no 132 , L1099925775 , bytecode index = 
    stack[sp++].i = local[4].i;
    stack[sp++].i = local[3].i;
    sp -= 2;
    if(stack[sp + 0].i  == stack[sp + 1].i) goto L1027377263;
    stack[sp++].i = local[4].i;
    // iconst_1
    stack[sp++].i = 1;
    sp -= 2;
    if(stack[sp + 0].i  < stack[sp + 1].i) goto L2103895364;
    stack[sp++].i = local[4].i;
    stack[sp++].i = local[3].i;
    // iconst_1
    stack[sp++].i = 1;
    ...
    if(stack[sp + 0].i  <= stack[sp + 1].i) goto L1027377263;
    L2103895364:
    //  line no 133 , L2103895364 , bytecode index = 
    // iconst_2
    stack[sp++].i = 2;
    ...
    // invokestatic org/luaj/vm2/lib/TableLib$remove.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
    ...
    --sp; //pop
    L1027377263:
    //  line no 135 , L1027377263 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    stack[sp++].i = local[4].i;
    // invokevirtual org/luaj/vm2/LuaTable.remove(I)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 33, 20);
        rstack[sp].obj = __func_p(runtime, stack[sp + 0].i);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
...
void bridge_org_luaj_vm2_lib_TableLib_00024remove_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_TableLib_00024remove_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
