...
void func_java_io_IOException__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 12 , L1987977423 , bytecode index = 
    ...
    ; 
    //  line no 13 , L61073295 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_io_IOException__init___Ljava_lang_String_2_V(JThreadRuntime *runtime, struct java_lang_String* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 23 , L396485834 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 23;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 24 , L283039401 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_io_IOException__init___Ljava_lang_String_2Ljava_lang_Throwable_2_V(JThreadRuntime *runtime, struct java_lang_String* p0, struct java_lang_Throwable* p1){
    ...
    rlocal[1].obj = p1;
    ; 
    //  line no 46 , L1243171897 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 46;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 47 , L1376151044 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_io_IOException__init___Ljava_lang_Throwable_2_V(JThreadRuntime *runtime, struct java_lang_Throwable* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 64 , L1443967876 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 64;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 65 , L1449772539 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
