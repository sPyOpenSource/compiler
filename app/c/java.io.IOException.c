...
// generation
// globals
//struct java_io_IOException_static {};
...
VMTable vmtable_java_io_IOException[] = {
    {152, 0, arr_vmtable_java_io_IOException_from_java_io_IOException}, //0
    {55, 0, arr_vmtable_java_io_IOException_from_java_lang_Exception}, //1
    {56, 5, arr_vmtable_java_io_IOException_from_java_lang_Throwable}, //2
    {5, 10, arr_vmtable_java_io_IOException_from_java_lang_Object}, //3
};
...
void func_java_io_IOException__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 11 , L519492428 , bytecode index = 
    ...
    ; 
    //  line no 12 , L1176968662 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_io_IOException__init___Ljava_lang_String_2_V(JThreadRuntime *runtime, struct java_lang_String* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 16 , L2085745483 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 16;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 17 , L1419064126 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
