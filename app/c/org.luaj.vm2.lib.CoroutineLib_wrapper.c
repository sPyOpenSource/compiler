// CLASS: org/luaj/vm2/lib/CoroutineLib$wrapper extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_CoroutineLib_00024wrapper_static {};



__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_lib_CoroutineLib_00024wrapper[] = {
    func_org_luaj_vm2_lib_CoroutineLib_00024wrapper_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024wrapper_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024wrapper_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024wrapper_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper[] = {
    {345, 1, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_lib_CoroutineLib_00024wrapper}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024wrapper_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_CoroutineLib_00024wrapper__init___Lorg_luaj_vm2_LuaThread_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_LuaThread* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2412, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 132 , L592248663 , bytecode index = 
    ...
    ; 
    //  line no 133 , L1585776625 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/CoroutineLib$wrapper luathread Lorg/luaj/vm2/LuaThread;
    sp -= 2;
    ((struct org_luaj_vm2_lib_CoroutineLib_00024wrapper*)rstack[sp + 0].obj)->luathread_47 = rstack[sp + 1].obj;
    ; 
    //  line no 134 , L1271570837 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024wrapper__init___Lorg_luaj_vm2_LuaThread_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_CoroutineLib_00024wrapper__init___Lorg_luaj_vm2_LuaThread_2_V(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_CoroutineLib_00024wrapper_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2413, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 136 , L1241128308 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 136;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/CoroutineLib$wrapper luathread Lorg/luaj/vm2/LuaThread;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_CoroutineLib_00024wrapper*)rstack[sp - 1].obj)->luathread_47;
    sp += 0;
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaThread.resume(Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_Varargs* (*__func_p) (JThreadRuntime *,struct org_luaj_vm2_Varargs*) = find_method(__ins->vm_table, 24, 8);
    ...
    ; 
    //  line no 137 , L1060512053 , bytecode index = 
    ...
    if(stack[--sp].i  == 0) goto L569305423;
    ; 
    //  line no 138 , L1807896178 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    L569305423:
    //  line no 140 , L569305423 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    // invokestatic org/luaj/vm2/lib/CoroutineLib$wrapper.error(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024wrapper_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_CoroutineLib_00024wrapper_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
