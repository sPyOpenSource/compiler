...
void func_jx_framebuffer_SubFramebuffer__init___Ljx_framebuffer_PackedFramebuffer_2IIII_V(JThreadRuntime *runtime, struct jx_framebuffer_PackedFramebuffer* p0, s32 p1, s32 p2, s32 p3, s32 p4){
    ...
    local[4].i = p4;
    ; 
    //  line no 10 , L1230701703 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 10;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ; 
    //  line no 11 , L90045638 , bytecode index = 
    ...
    rstack[sp++].obj = rlocal[1].obj;
    ; 
    //  line no 12 , L573487274 , bytecode index = 
    ...
    rstack[sp++].obj = rlocal[1].obj;
    ; 
    //  line no 13 , L154988899 , bytecode index = 
    ...
    rstack[sp++].obj = rlocal[1].obj;
    ; 
    //  line no 14 , L408069119 , bytecode index = 
    ...
    rstack[sp++].obj = rlocal[1].obj;
    ; 
    //  line no 15 , L1912850431 , bytecode index = 
    // invokeinterface jx/framebuffer/PackedFramebuffer.pixelOffset()I
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
    ...
    rstack[sp++].obj = rlocal[1].obj;
    ; 
    //  line no 16 , L633326333 , bytecode index = 
    // invokeinterface jx/framebuffer/PackedFramebuffer.scanlineOffset()I
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
    ...
    rstack[sp++].obj = rlocal[1].obj;
    ; 
    //  line no 17 , L1265012928 , bytecode index = 
    ...
    ; 
    //  line no 10 , L1176932104 , bytecode index = 
    ...
    ; 
    //  line no 20 , L712410124 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    stack[sp++].i = local[2].i;
    ...
    ; 
    //  line no 21 , L1900366749 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    stack[sp++].i = local[3].i;
    ...
    ; 
    //  line no 22 , L249177573 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    stack[sp++].i = local[4].i;
    ...
    ; 
    //  line no 23 , L2096539129 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    stack[sp++].i = local[5].i;
    ...
    ; 
    //  line no 29 , L1648232591 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
JArray * func_jx_framebuffer_SubFramebuffer_transformClippings___3Ljx_framebuffer_ClippingRectangle_2__3Ljx_framebuffer_ClippingRectangle_2(JThreadRuntime *runtime, JArray * p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 33 , L1716932897 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 33;
    ...
    ; 
    //  line no 35 , L801569151 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // arraylength  label  L801569151
    if (!rstack[sp - 1].obj) {
        rstack[sp++].obj = construct_and_throw_exception(runtime, 1, 
        goto __ExceptionHandler;
    }
    ...
    ; 
    //  line no 38 , L1026483832 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    ...
    stack[sp - 1].i = rstack[sp - 1].ins->prop.arr_length; 
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L905080434;
    ; 
    //  line no 39 , L761750706 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[4].i;
    // arrload __refer  ,  L761750706 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    ; 
    //  line no 40 , L1731217984 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    if(rstack[--sp].obj  == NULL) goto L1237762639;
    ; 
    //  line no 41 , L1877062907 , bytecode index = 
    ...
    // arrstore __refer  ,  L1877062907 bc index = 
    {
        ;
    ...
    L1237762639:
    //  line no 38 , L1237762639 , bytecode index = 
    // iinc slot 4 value 1
    local[4].i += 1;
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L1635378213;
    L905080434:
    //  line no 43 , L905080434 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    method_exit(runtime);
...
struct java_lang_String* func_jx_framebuffer_SubFramebuffer_framebufferType___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 48 , L473053293 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 48;
    //  ldc 
