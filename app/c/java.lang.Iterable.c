...
VMTable vmtable_java_lang_Iterable[] = {
    {91, 1, arr_vmtable_java_lang_Iterable_from_java_lang_Iterable}, //0
    {5, 10, arr_vmtable_java_lang_Iterable_from_java_lang_Object}, //1
};
...
struct java_util_Iterator* func_java_lang_Iterable_iterator___Ljava_util_Iterator_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 759, &rstack[0], NULL, &sp);
    __ExceptionHandler:
