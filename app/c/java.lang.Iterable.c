...
void func_java_lang_Iterable_forEach__Ljava_util_function_Consumer_2_V(JThreadRuntime *runtime, struct java_util_function_Consumer* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 73 , L1670993182 , bytecode index = 
    ...
    --sp; //pop
    ; 
    //  line no 74 , L20804602 , bytecode index = 
    ...
    if(stack[--sp].i  == 0) goto L1566511282;
    rstack[sp++].obj = rlocal[2].obj;
    ...
    ; 
    //  line no 75 , L1959239586 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 76 , L504336483 , bytecode index = 
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L1344519051;
    L1566511282:
    //  line no 77 , L1566511282 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
struct java_util_Spliterator* func_java_lang_Iterable_spliterator___Ljava_util_Spliterator_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 101 , L1984094095 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 101;
    rstack[sp++].obj = rlocal[0].obj;
    // invokeinterface java/lang/Iterable.iterator()Ljava/util/Iterator;
