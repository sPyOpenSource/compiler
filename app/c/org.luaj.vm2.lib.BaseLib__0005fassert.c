// CLASS: org/luaj/vm2/lib/BaseLib$_assert extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024_1assert_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_lib_BaseLib_00024_1assert[] = {
    func_org_luaj_vm2_lib_BaseLib_00024_1assert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024_1assert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024_1assert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024_1assert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert[] = {
    {163, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_lib_BaseLib_00024_1assert}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024_1assert_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_BaseLib_00024_1assert__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 132 , L2099802038 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_BaseLib_00024_1assert__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024_1assert__init____V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_BaseLib_00024_1assert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 134 , L2072724423 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 134;
    ...
    if(stack[--sp].i  != 0) goto L2058135834;
    ; 
    //  line no 135 , L1153907750 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    stack[sp++].i = 1;
    sp -= 2;
    if(stack[sp + 0].i  <= stack[sp + 1].i) goto L1090541608;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1779);
    ...
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1779);
    L1622458036:
    // invokestatic org/luaj/vm2/lib/BaseLib$_assert.error(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
    ...
    --sp; //pop
    L2058135834:
    //  line no 136 , L2058135834 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    method_exit(runtime);
...
void bridge_org_luaj_vm2_lib_BaseLib_00024_1assert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024_1assert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
