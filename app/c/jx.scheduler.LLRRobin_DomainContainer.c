...
void func_jx_scheduler_LLRRobin_00024DomainContainer__init___Ljx_scheduler_LLRRobin_2Ljx_zero_Domain_2_V(JThreadRuntime *runtime, struct jx_scheduler_LLRRobin* p0, struct jx_zero_Domain* p1){
    ...
    rlocal[1].obj = p1;
    ; 
    //  line no 265 , L965586344 , bytecode index = 
    ...
    // it's a empty method
    ; 
    //  line no 266 , L130764844 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 267 , L660339123 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 268 , L462039519 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // aconst null
    rstack[sp++].obj = NULL;
    ...
    ; 
    //  line no 269 , L1337866219 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
