// CLASS: org/luaj/vm2/lib/CoroutineLib$resume extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_CoroutineLib_00024resume_static {};



__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_lib_CoroutineLib_00024resume[] = {
    func_org_luaj_vm2_lib_CoroutineLib_00024resume_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024resume_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024resume_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024resume_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume[] = {
    {322, 1, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_lib_CoroutineLib_00024resume}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024resume_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_CoroutineLib_00024resume__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2824, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 95 , L944757319 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024resume__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_CoroutineLib_00024resume__init____V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_CoroutineLib_00024resume_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2825, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 97 , L1465691120 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 97;
    ...
    ; 
    //  line no 98 , L1128109696 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024resume_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_CoroutineLib_00024resume_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
