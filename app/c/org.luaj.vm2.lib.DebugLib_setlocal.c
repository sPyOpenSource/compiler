// CLASS: org/luaj/vm2/lib/DebugLib$setlocal extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024setlocal_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_lib_DebugLib_00024setlocal[] = {
    func_org_luaj_vm2_lib_DebugLib_00024setlocal_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setlocal_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setlocal_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setlocal_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal[] = {
    {154, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_lib_DebugLib_00024setlocal}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setlocal_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_DebugLib_00024setlocal__init___Lorg_luaj_vm2_lib_DebugLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_DebugLib* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 301 , L1634387050 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 301;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/DebugLib$setlocal this$0 Lorg/luaj/vm2/lib/DebugLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_DebugLib_00024setlocal*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024setlocal__init___Lorg_luaj_vm2_lib_DebugLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024setlocal__init___Lorg_luaj_vm2_lib_DebugLib_2_V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_DebugLib_00024setlocal_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 303 , L302366050 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 303;
    // iconst_1
    stack[sp++].i = 1;
    ...
    ; 
    //  line no 304 , L2129821055 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  == 0) goto L1225568095;
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    L1225568095:
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/DebugLib$setlocal this$0 Lorg/luaj/vm2/lib/DebugLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_DebugLib_00024setlocal*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    ; 
    //  line no 305 , L1550228904 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    ; 
    //  line no 306 , L831654622 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    ; 
    //  line no 307 , L491273700 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    ; 
    //  line no 308 , L1077072774 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/DebugLib$setlocal this$0 Lorg/luaj/vm2/lib/DebugLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_DebugLib_00024setlocal*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    ; 
    //  line no 309 , L684822005 , bytecode index = 
    rstack[sp++].obj = rlocal[7].obj;
    if(rstack[--sp].obj  == NULL) goto L154449611;
    rstack[sp++].obj = rlocal[7].obj;
    stack[sp++].i = local[5].i;
    rstack[sp++].obj = rlocal[6].obj;
    // invokevirtual org/luaj/vm2/lib/DebugLib$CallFrame.setLocal(ILorg/luaj/vm2/LuaValue;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 2;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_Varargs* (*__func_p) (JThreadRuntime *,s32,struct org_luaj_vm2_LuaValue*) = find_method(__ins->vm_table, 110, 6);
    ...
    goto L1439632660;
    L154449611:
    // getstatic org/luaj/vm2/lib/DebugLib$setlocal NONE Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024setlocal_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024setlocal_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
