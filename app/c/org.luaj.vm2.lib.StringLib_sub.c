// CLASS: org/luaj/vm2/lib/StringLib$sub extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_StringLib_00024sub_static {};



__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_lib_StringLib_00024sub[] = {
    func_org_luaj_vm2_lib_StringLib_00024sub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024sub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024sub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_StringLib_00024sub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_StringLib_00024sub[] = {
    {32, 1, arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_lib_StringLib_00024sub}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024sub_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_StringLib_00024sub__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 715 , L1566502717 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_StringLib_00024sub__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_StringLib_00024sub__init____V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_StringLib_00024sub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 717 , L1824835605 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 717;
    ...
    ; 
    //  line no 718 , L981661423 , bytecode index = 
    ...
    ; 
    //  line no 720 , L269468037 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    ; 
    //  line no 721 , L1681595665 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_3
    stack[sp++].i = 3;
    // iconst_-1
    ...
    ; 
    //  line no 723 , L787867107 , bytecode index = 
    stack[sp++].i = local[4].i;
    // iconst_1
    stack[sp++].i = 1;
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L57494364;
    ; 
    //  line no 724 , L1828757853 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    local[4].i = stack[--sp].i;
    L57494364:
    //  line no 725 , L57494364 , bytecode index = 
    stack[sp++].i = local[5].i;
    stack[sp++].i = local[3].i;
    sp -= 2;
    if(stack[sp + 0].i  <= stack[sp + 1].i) goto L1374677625;
    ; 
    //  line no 726 , L1345636186 , bytecode index = 
    stack[sp++].i = local[3].i;
    local[5].i = stack[--sp].i;
    L1374677625:
    //  line no 728 , L1374677625 , bytecode index = 
    stack[sp++].i = local[4].i;
    stack[sp++].i = local[5].i;
    sp -= 2;
    if(stack[sp + 0].i  > stack[sp + 1].i) goto L963269035;
    ; 
    //  line no 729 , L1359484306 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    stack[sp++].i = local[4].i;
    // iconst_1
    stack[sp++].i = 1;
    ...
    L963269035:
    //  line no 731 , L963269035 , bytecode index = 
    // getstatic org/luaj/vm2/lib/StringLib$sub EMPTYSTRING Lorg/luaj/vm2/LuaString;
...
void bridge_org_luaj_vm2_lib_StringLib_00024sub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_StringLib_00024sub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
