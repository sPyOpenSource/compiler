// CLASS: org/luaj/vm2/lib/BaseLib$tostring extends org/luaj/vm2/lib/LibFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024tostring_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_lib_BaseLib_00024tostring[] = {
    func_org_luaj_vm2_lib_BaseLib_00024tostring_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024tostring_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024tostring_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024tostring[] = {
    {354, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_lib_BaseLib_00024tostring}, //0
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_lib_LibFunction}, //1
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_LuaFunction}, //2
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_LuaValue}, //3
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_org_luaj_vm2_Varargs}, //4
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tostring_from_java_lang_Object}, //5
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_BaseLib_00024tostring__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2575, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 349 , L70482685 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_BaseLib_00024tostring__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024tostring__init____V(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_BaseLib_00024tostring_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2576, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 351 , L66747889 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 351;
    rstack[sp++].obj = rlocal[1].obj;
    // getstatic org/luaj/vm2/lib/BaseLib$tostring TOSTRING Lorg/luaj/vm2/LuaString;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.TOSTRING_38;
    sp += 1;
    ...
    ; 
    //  line no 352 , L1306067302 , bytecode index = 
    ...
    if(stack[--sp].i  != 0) goto L1377992370;
    ; 
    //  line no 353 , L1523683407 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    L1377992370:
    //  line no 354 , L1377992370 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 355 , L169110289 , bytecode index = 
    ...
    if(stack[--sp].i  != 0) goto L256084228;
    ; 
    //  line no 356 , L1322623408 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L256084228:
    //  line no 357 , L256084228 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    // invokestatic org/luaj/vm2/lib/BaseLib$tostring.valueOf(Ljava/lang/String;)Lorg/luaj/vm2/LuaString;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024tostring_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024tostring_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
