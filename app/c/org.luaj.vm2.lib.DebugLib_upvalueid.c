// CLASS: org/luaj/vm2/lib/DebugLib$upvalueid extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024upvalueid_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_lib_DebugLib_00024upvalueid[] = {
    func_org_luaj_vm2_lib_DebugLib_00024upvalueid_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024upvalueid_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024upvalueid_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024upvalueid_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid[] = {
    {201, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_lib_DebugLib_00024upvalueid}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvalueid_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_DebugLib_00024upvalueid__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1015, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 373 , L1810518740 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_DebugLib_00024upvalueid__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024upvalueid__init____V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_DebugLib_00024upvalueid_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1016, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 375 , L1547883191 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 375;
    ...
    ; 
    //  line no 376 , L1650113431 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    ; 
    //  line no 377 , L1528769018 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // instanceof org/luaj/vm2/LuaClosure
    stack[sp - 1].i = instance_of_classname_index(rstack[sp - 1].obj, 1783);
    if(stack[--sp].i  == 0) goto L183155105;
    ; 
    //  line no 378 , L1089930529 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    ...
    ; 
    //  line no 379 , L2001115307 , bytecode index = 
    ...
    sp += 0;
    if(rstack[--sp].obj  == NULL) goto L183155105;
    ...
    sp -= 2;
    if(stack[sp + 0].i  > stack[sp + 1].i) goto L183155105;
    ; 
    //  line no 380 , L1429483328 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    // getfield org/luaj/vm2/LuaClosure upValues [Lorg/luaj/vm2/UpValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaClosure*)rstack[sp - 1].obj)->upValues_47;
    sp += 0;
    ...
    --sp;
    // arrload __refer  ,  L1429483328 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    // invokestatic org/luaj/vm2/lib/DebugLib$upvalueid.valueOf(I)Lorg/luaj/vm2/LuaInteger;
    {
        sp -= 2;
    ...
    L183155105:
    //  line no 383 , L183155105 , bytecode index = 
    // getstatic org/luaj/vm2/lib/DebugLib$upvalueid NIL Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024upvalueid_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024upvalueid_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
