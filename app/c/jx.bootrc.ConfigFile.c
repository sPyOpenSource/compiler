...
void func_jx_bootrc_ConfigFile__init___Ljx_zero_ReadOnlyMemory_2_V(JThreadRuntime *runtime, struct jx_zero_ReadOnlyMemory* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 10 , L541698497 , bytecode index = 
    ...
    // it's a empty method
    ; 
    //  line no 7 , L519492428 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 8 , L1176968662 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 33 , L297490204 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    //  sipush 256
    stack[sp++].i = 256;
    ...
    ; 
    //  line no 11 , L2085745483 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 12 , L1419064126 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield jx/bootrc/ConfigFile mem Ljx/zero/ReadOnlyMemory;
    sp -= 2;
    ((struct jx_bootrc_ConfigFile*)rstack[sp + 0].obj)->mem_2 = rstack[sp + 1].obj;
    L706895319:
    //  line no 14 , L706895319 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 15 , L1642785848 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    if(rstack[--sp].obj  != NULL) goto L307400933;
    goto L1872973138;
    L307400933:
    //  line no 16 , L307400933 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    ...
    rlocal[2].obj = rstack[--sp].obj;
    ; 
    //  line no 17 , L1465346452 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    ...
    if(stack[--sp].i  == 0) goto L706895319;
    rstack[sp++].obj = rlocal[2].obj;
    // iconst_0
    stack[sp++].i = 0;
    ...
    stack[sp++].i = 35;
    sp -= 2;
    if(stack[sp + 0].i  != stack[sp + 1].i) goto L1634387050;
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L706895319;
    L1634387050:
    //  line no 18 , L1634387050 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    //  bipush 61
    stack[sp++].i = 61;
    ...
    ; 
    //  line no 19 , L1740223770 , bytecode index = 
    // new jx/bootrc/Pair
    ...
    // iconst_0
    stack[sp++].i = 0;
    // arrload __refer  ,  L1740223770 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    ; 
    //  line no 22 , L302366050 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 23 , L2129821055 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    --sp; //pop
    ; 
    //  line no 24 , L1225568095 , bytecode index = 
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L706895319;
    L1872973138:
    //  line no 25 , L1872973138 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
struct java_lang_String* func_jx_bootrc_ConfigFile_get__Ljava_lang_String_2_Ljava_lang_String_2(JThreadRuntime *runtime, struct java_lang_String* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 27 , L1550228904 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 27;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/bootrc/ConfigFile name2value Ljava/util/Hashtable;
...
struct java_lang_String* func_jx_bootrc_ConfigFile_readline___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 37 , L491273700 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 37;
    // iconst_0
    stack[sp++].i = 0;
    ...
    L1077072774:
    //  line no 38 , L1077072774 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L684822005;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/bootrc/ConfigFile mem Ljx/zero/ReadOnlyMemory;
    rstack[sp - 1].obj = ((struct jx_bootrc_ConfigFile*)rstack[sp - 1].obj)->mem_2;
    sp += 0;
    ...
    if(stack[sp + 0].i  == stack[sp + 1].i) goto L684822005;
    ; 
    //  line no 39 , L1439632660 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    // arrstore u16  ,  L1439632660 bc index = 
    {
        ;
    ...
    ; 
    //  line no 40 , L62343880 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ...
    ; 
    //  line no 41 , L665698670 , bytecode index = 
    // iinc slot 2 value 1
    local[2].i += 1;
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L1077072774;
    L684822005:
    //  line no 43 , L684822005 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/bootrc/ConfigFile pos I
    stack[sp - 1].i = ((struct jx_bootrc_ConfigFile*)rstack[sp - 1].obj)->pos_3;
    sp += 0;
    ...
    sp -= 2;
    if(stack[sp + 0].i  < stack[sp + 1].i) goto L193178046;
    stack[sp++].i = local[2].i;
    if(stack[--sp].i  != 0) goto L193178046;
    // aconst null
    rstack[sp++].obj = NULL;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L193178046:
    //  line no 44 , L193178046 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ...
    ((struct jx_bootrc_ConfigFile*)rstack[sp + 0].obj)->pos_3 = stack[sp + 1].i;
    ; 
    //  line no 45 , L638169719 , bytecode index = 
    ...
    rlocal[3].obj = rstack[--sp].obj;
    ; 
    //  line no 46 , L533810548 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    ; 
