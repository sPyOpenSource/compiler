// CLASS: org/luaj/vm2/lib/PackageLib$preload_searcher extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_PackageLib_00024preload_1searcher_static {};



__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_lib_PackageLib_00024preload_1searcher[] = {
    func_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher[] = {
    {285, 1, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_lib_PackageLib_00024preload_1searcher}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_PackageLib_00024preload_1searcher__init___Lorg_luaj_vm2_lib_PackageLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_PackageLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1738, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 246 , L1269339945 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 246;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/PackageLib$preload_searcher this$0 Lorg/luaj/vm2/lib/PackageLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_PackageLib_00024preload_1searcher*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_PackageLib_00024preload_1searcher__init___Lorg_luaj_vm2_lib_PackageLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_PackageLib_00024preload_1searcher__init___Lorg_luaj_vm2_lib_PackageLib_2_V(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1739, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 248 , L2036324408 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 248;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    ...
    ; 
    //  line no 249 , L453007883 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/PackageLib$preload_searcher this$0 Lorg/luaj/vm2/lib/PackageLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_PackageLib_00024preload_1searcher*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    ; 
    //  line no 250 , L337545117 , bytecode index = 
    ...
    if(stack[--sp].i  == 0) goto L278753868;
    ; 
    //  line no 251 , L386201215 , bytecode index = 
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3041);
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3042);
    // invokevirtual java/lang/StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
    ...
    // invokestatic org/luaj/vm2/lib/PackageLib$preload_searcher.valueOf(Ljava/lang/String;)Lorg/luaj/vm2/LuaString;
    {
        sp -= 2;
    ...
    goto L239937174;
    L278753868:
    //  line no 252 , L278753868 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    L239937174:
    //  line no 250 , L239937174 , bytecode index = 
    method_exit(runtime);
...
void bridge_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_PackageLib_00024preload_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
