// CLASS: org/luaj/vm2/lib/DebugLib$setupvalue extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024setupvalue_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_lib_DebugLib_00024setupvalue[] = {
    func_org_luaj_vm2_lib_DebugLib_00024setupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue[] = {
    {238, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_lib_DebugLib_00024setupvalue}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setupvalue_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_DebugLib_00024setupvalue__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1291, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 331 , L1139609587 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_DebugLib_00024setupvalue__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024setupvalue__init____V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_DebugLib_00024setupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1292, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 333 , L173060252 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 333;
    ...
    ; 
    //  line no 334 , L1302877661 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    ; 
    //  line no 335 , L1720797452 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_3
    stack[sp++].i = 3;
    ...
    ; 
    //  line no 336 , L562561015 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // instanceof org/luaj/vm2/LuaClosure
    stack[sp - 1].i = instance_of_classname_index(rstack[sp - 1].obj, 1783);
    if(stack[--sp].i  == 0) goto L777813771;
    ; 
    //  line no 337 , L567656864 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    ...
    ; 
    //  line no 338 , L1306535359 , bytecode index = 
    ...
    ; 
    //  line no 339 , L1401295795 , bytecode index = 
    rstack[sp++].obj = rlocal[6].obj;
    if(rstack[--sp].obj  == NULL) goto L777813771;
    ; 
    //  line no 340 , L519019247 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    ...
    --sp;
    // arrload __refer  ,  L519019247 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    ; 
    //  line no 341 , L288919635 , bytecode index = 
    rstack[sp++].obj = rlocal[6].obj;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L777813771:
    //  line no 344 , L777813771 , bytecode index = 
    // getstatic org/luaj/vm2/lib/DebugLib$setupvalue NIL Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024setupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024setupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
