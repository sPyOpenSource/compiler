...
void func_jx_fs_FSInterfaceDomain_init__Ljx_zero_Naming_2_3Ljava_lang_String_2_V(JThreadRuntime *runtime, struct jx_fs_FSInterfaceDomain* p0, struct jx_zero_Naming* p1, JArray * p2){
    ...
    rlocal[2].obj = p2;
    ; 
    //  line no 41 , L201719260 , bytecode index = 
    ...
    ; 
    //  line no 42 , L635371680 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    //  ldc 
    ...
    ; 
    //  line no 43 , L1293226111 , bytecode index = 
    ...
    ; 
    //  line no 45 , L2068598972 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_0
    stack[sp++].i = 0;
    // arrload __refer  ,  L2068598972 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    ; 
    //  line no 47 , L1485089044 , bytecode index = 
    ...
    ; 
    //  line no 48 , L84113572 , bytecode index = 
    ...
    ; 
    //  line no 50 , L1626343059 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 52 , L2032169857 , bytecode index = 
    ...
    --sp; //pop
    ; 
    //  line no 53 , L76659128 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_jx_fs_FSInterfaceDomain__init___Ljx_zero_Naming_2Ljx_devices_bio_BlockIO_2_V(JThreadRuntime *runtime, struct jx_zero_Naming* p0, struct jx_devices_bio_BlockIO* p1){
    ...
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    // try catch :L2053996178 L11249189 L159290353 (
    ; 
    //  line no 55 , L1515877023 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 55;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    L2053996178:
    __frame->bytecodeIndex = 
    //  line no 57 , L2053996178 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 59 , L1263668904 , bytecode index = 
    // getstatic jx/zero/Debug out Ljx/zero/debug/DebugPrintStream;
    rstack[sp].obj =static_var_jx_zero_Debug.out_2;
    sp += 1;
    //  ldc 
    ...
    ; 
    //  line no 60 , L370475881 , bytecode index = 
    // getstatic jx/zero/Debug out Ljx/zero/debug/DebugPrintStream;
    rstack[sp].obj =static_var_jx_zero_Debug.out_2;
    sp += 1;
    ...
    ; 
    //  line no 63 , L1795816257 , bytecode index = 
    ...
    rlocal[3].obj = rstack[--sp].obj;
    ; 
    //  line no 69 , L1649320501 , bytecode index = 
    // getstatic jx/zero/Debug out Ljx/zero/debug/DebugPrintStream;
    rstack[sp].obj =static_var_jx_zero_Debug.out_2;
    sp += 1;
    //  ldc 
    ...
    L11249189:
    __frame->bytecodeIndex = 
    //  line no 75 , L11249189 , bytecode index = 
    goto L959629210;
    L159290353:
    //  line no 72 , L159290353 , bytecode index = 
    rlocal[3].obj = rstack[--sp].obj;
    ; 
    //  line no 73 , L125994398 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    ...
    ; 
    //  line no 74 , L603305436 , bytecode index = 
    // new java/lang/Error
    ...
    // athrow
    //     L603305436 in labeltable is :L603305436
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 74;
    ...
    L959629210:
    //  line no 76 , L959629210 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        case 0 : goto L159290353;
        default: goto __ExceptionHandlerNotFound;
    }
    __ExceptionHandlerNotFound:
    method_exit(runtime);
