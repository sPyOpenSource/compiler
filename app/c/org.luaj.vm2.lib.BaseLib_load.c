// CLASS: org/luaj/vm2/lib/BaseLib$load extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024load_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_lib_BaseLib_00024load[] = {
    func_org_luaj_vm2_lib_BaseLib_00024load_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024load_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024load_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024load_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024load[] = {
    {173, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_lib_BaseLib_00024load}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024load_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_BaseLib_00024load__init___Lorg_luaj_vm2_lib_BaseLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_BaseLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 915, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 193 , L1404932042 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 193;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/BaseLib$load this$0 Lorg/luaj/vm2/lib/BaseLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_BaseLib_00024load*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024load__init___Lorg_luaj_vm2_lib_BaseLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024load__init___Lorg_luaj_vm2_lib_BaseLib_2_V(runtime, ins);
}
...
// stack: 5
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_BaseLib_00024load_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 916, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 195 , L1043358826 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 195;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 196 , L1558079303 , bytecode index = 
    ...
    if(stack[--sp].i  != 0) goto L1671590089;
    rstack[sp++].obj = rlocal[2].obj;
    ...
    if(stack[--sp].i  != 0) goto L1671590089;
    ; 
    //  line no 197 , L58488213 , bytecode index = 
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1878);
    ...
    // athrow
    //     L58488213 in labeltable is :L58488213
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 197;
    ...
    L1671590089:
    //  line no 199 , L1671590089 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    rstack[sp++].obj = rlocal[2].obj;
    ...
    if(stack[--sp].i  == 0) goto L1053967012;
    rstack[sp++].obj = rlocal[2].obj;
    ...
    L1053967012:
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1879);
    L295304806:
    ...
    ; 
    //  line no 200 , L1632497828 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_3
    stack[sp++].i = 3;
    //  ldc 
    ...
    ; 
    //  line no 201 , L33419717 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_4
    stack[sp++].i = 4;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/BaseLib$load this$0 Lorg/luaj/vm2/lib/BaseLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib_00024load*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    ; 
    //  line no 202 , L764826684 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/BaseLib$load this$0 Lorg/luaj/vm2/lib/BaseLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib_00024load*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    if(stack[--sp].i  == 0) goto L1940055334;
    rstack[sp++].obj = rlocal[2].obj;
    ...
    // invokevirtual org/luaj/vm2/LuaString.toInputStream()Ljava/io/InputStream;
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct java_io_InputStream* (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 31, 91);
        rstack[sp].obj = __func_p(runtime);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    goto L2103763750;
    L1940055334:
    //  line no 203 , L1940055334 , bytecode index = 
    // new org/luaj/vm2/lib/BaseLib$StringInputStream
    ...
    // invokespecial org/luaj/vm2/lib/BaseLib$StringInputStream.<init>(Lorg/luaj/vm2/LuaValue;)V
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_lib_BaseLib_00024StringInputStream__init___Lorg_luaj_vm2_LuaValue_2_V(runtime, rstack[sp + 0].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 202 , L335107734 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_BaseLib_00024load_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024load_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
