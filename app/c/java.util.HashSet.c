...
void func_java_util_HashSet__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 66 , L1989811701 , bytecode index = 
    ...
    ; 
    //  line no 67 , L1106681476 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 68 , L2037764568 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_HashSet__init___I_V(JThreadRuntime *runtime, s32 p0){
    ...
    local[0].i = p0;
    ; 
    //  line no 78 , L605052357 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 78;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial java/util/AbstractSet.<init>()V
    ...
    ; 
    //  line no 79 , L1365767549 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // new java/util/HashMap
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 139);
    // dup
    ...
    ((struct java_util_HashSet*)rstack[sp + 0].obj)->map_1 = rstack[sp + 1].obj;
    ; 
    //  line no 80 , L105579928 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_HashSet__init___IF_V(JThreadRuntime *runtime, s32 p0, f32 p1){
    ...
    local[1].f = p1;
    ; 
    //  line no 91 , L1042306518 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 91;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial java/util/AbstractSet.<init>()V
    ...
    ; 
    //  line no 92 , L1342346098 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // new java/util/HashMap
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 139);
    // dup
    ...
    ((struct java_util_HashSet*)rstack[sp + 0].obj)->map_1 = rstack[sp + 1].obj;
    ; 
    //  line no 93 , L238762799 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_HashSet__init___IFZ_V(JThreadRuntime *runtime, s32 p0, f32 p1, s8 p2){
    ...
    local[2].i = p2;
    ; 
    //  line no 107 , L1824837049 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 107;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial java/util/AbstractSet.<init>()V
    ...
    ; 
    //  line no 108 , L672746064 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // aconst null
    rstack[sp++].obj = NULL;
    // putfield java/util/HashSet map Ljava/util/HashMap;
    ...
    ((struct java_util_HashSet*)rstack[sp + 0].obj)->map_1 = rstack[sp + 1].obj;
    ; 
    //  line no 109 , L2133655103 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_HashSet__init___Ljava_util_Collection_2_V(JThreadRuntime *runtime, struct java_util_Collection* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 119 , L1345900725 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 119;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial java/util/AbstractSet.<init>()V
    ...
    ; 
    //  line no 120 , L839998248 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // new java/util/HashMap
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 139);
    // dup
    ...
    ((struct java_util_HashSet*)rstack[sp + 0].obj)->map_1 = rstack[sp + 1].obj;
    ; 
    //  line no 121 , L718571091 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    --sp; //pop
    ; 
    //  line no 122 , L1807015220 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
s8 func_java_util_HashSet_add__Ljava_lang_Object_2_Z(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 135 , L1173346575 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 135;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    if(stack[--sp].i  == 0) goto L1267149311;
    ; 
    //  line no 137 , L102174918 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    method_exit(runtime);
    return stack[sp - 1].i;
    L1267149311:
    //  line no 141 , L1267149311 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 142 , L52514534 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    method_exit(runtime);
    return stack[sp - 1].i;
...
void func_java_util_HashSet_clear___V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 151 , L1242027525 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 151;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/HashSet map Ljava/util/HashMap;
    ...
    ; 
    //  line no 152 , L1948810915 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
struct java_lang_Object* func_java_util_HashSet_clone___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 160 , L735937428 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 160;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 161 , L1604247316 , bytecode index = 
    ...
    L1752461090:
    //  line no 162 , L1752461090 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  == 0) goto L788625466;
    ; 
    //  line no 163 , L1753714541 , bytecode index = 
    ...
    goto L1752461090;
    L788625466:
    //  line no 164 , L788625466 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    method_exit(runtime);
...
s8 func_java_util_HashSet_contains__Ljava_lang_Object_2_Z(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 174 , L177140066 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 174;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/HashSet map Ljava/util/HashMap;
...
s8 func_java_util_HashSet_isEmpty___Z(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 182 , L2059572982 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 182;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/HashSet map Ljava/util/HashMap;
...
struct java_util_Iterator* func_java_util_HashSet_iterator___Ljava_util_Iterator_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 191 , L36657658 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 191;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/HashSet map Ljava/util/HashMap;
...
s8 func_java_util_HashSet_remove__Ljava_lang_Object_2_Z(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 200 , L375466577 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 200;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/HashSet map Ljava/util/HashMap;
    ...
    if(rstack[--sp].obj  == NULL) goto L1423983012;
    // iconst_1
    stack[sp++].i = 1;
    goto L746074699;
    L1423983012:
...
s32 func_java_util_HashSet_size___I(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 208 , L405896924 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 208;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/HashSet map Ljava/util/HashMap;
...
void func_java_util_HashSet_internalAdd__Ljava_lang_Object_2_V(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 223 , L596470015 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 223;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/HashSet map Ljava/util/HashMap;
    ...
    --sp; //pop
    ; 
    //  line no 224 , L1267105885 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_HashSet_writeObject__Ljava_io_ObjectOutputStream_2_V(JThreadRuntime *runtime, struct java_io_ObjectOutputStream* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 229 , L1095352419 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 229;
    rstack[sp++].obj = rlocal[0].obj;
    // invokevirtual java/util/HashSet.iterator()Ljava/util/Iterator;
    ...
    rlocal[2].obj = rstack[--sp].obj;
    ; 
    //  line no 230 , L164332069 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/HashSet map Ljava/util/HashMap;
    rstack[sp - 1].obj = ((struct java_util_HashSet*)rstack[sp - 1].obj)->map_1;
    ...
    ; 
    //  line no 231 , L1991278377 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/HashSet map Ljava/util/HashMap;
    rstack[sp - 1].obj = ((struct java_util_HashSet*)rstack[sp - 1].obj)->map_1;
    ...
    ; 
    //  line no 232 , L951031848 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    L929697158:
    //  line no 233 , L929697158 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // invokeinterface java/util/Iterator.hasNext()Z
    {
        sp -= 0;
    ...
    if(stack[--sp].i  == 0) goto L1650813924;
    ; 
    //  line no 234 , L400103862 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[2].obj;
    // invokeinterface java/util/Iterator.next()Ljava/lang/Object;
    {
    ...
    goto L929697158;
    L1650813924:
    //  line no 235 , L1650813924 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_HashSet_readObject__Ljava_io_ObjectInputStream_2_V(JThreadRuntime *runtime, struct java_io_ObjectInputStream* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 245 , L873634936 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 245;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 246 , L2103569237 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 247 , L573200870 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual java/io/ObjectInputStream.readInt()I
    {
        sp -= 0;
    ...
    ; 
    //  line no 249 , L1819940427 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // new java/util/HashMap
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 139);
    // dup
    ...
    ((struct java_util_HashSet*)rstack[sp + 0].obj)->map_1 = rstack[sp + 1].obj;
    ; 
    //  line no 251 , L1277933280 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    ...
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L1324829744;
    ; 
    //  line no 253 , L1921242091 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 254 , L1670313965 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    goto L1046665075;
    L1324829744:
    //  line no 256 , L1324829744 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
JArray * func_java_util_HashSet_toArray___3Ljava_lang_Object_2__3Ljava_lang_Object_2(JThreadRuntime *runtime, JArray * p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 260 , L1399701152 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 260;
    ...
    // athrow
    //     L1399701152 in labeltable is :L1399701152
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 260;
