// CLASS: org/luaj/vm2/lib/StringLib$dump extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_StringLib_00024dump_static {};



__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_lib_StringLib_00024dump[] = {
    func_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_StringLib_00024dump[] = {
    {300, 1, arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_lib_StringLib_00024dump}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024dump_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_StringLib_00024dump__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1898, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 175 , L532297836 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_StringLib_00024dump__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_StringLib_00024dump__init____V(runtime, ins);
}

ExceptionItem arr_extable_func_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2[] = {
    { , , 1457}
};
ExceptionTable extable_func_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2 = {1, arr_extable_func_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2};

// locals: 5
// stack: 5
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1899, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    // try catch :L917704874 L1992525817 L947173397 (
    ; 
    //  line no 177 , L1568159144 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 177;
    ...
    ; 
    //  line no 178 , L1935689965 , bytecode index = 
    ...
    L917704874:
    __frame->bytecodeIndex = 
    //  line no 180 , L917704874 , bytecode index = 
    ...
    // iconst_1
    stack[sp++].i = 1;
    // invokevirtual org/luaj/vm2/Varargs.optboolean(IZ)Z
    {
        sp -= 2;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        s8 (*__func_p) (JThreadRuntime *,s32,s8) = find_method(__ins->vm_table, 2, 14);
    ...
    // invokestatic org/luaj/vm2/compiler/DumpState.dump(Lorg/luaj/vm2/Prototype;Ljava/io/OutputStream;Z)I
    {
        sp -= 4;
        stack[sp].i = func_org_luaj_vm2_compiler_DumpState_dump__Lorg_luaj_vm2_Prototype_2Ljava_io_OutputStream_2Z_I(runtime, rstack[sp + 0].obj, rstack[sp + 1].obj, rstack[sp + 2].obj, stack[sp + 3].i);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    --sp; //pop
    ; 
    //  line no 181 , L427226423 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    ...
    L947173397:
    //  line no 182 , L947173397 , bytecode index = 
    rlocal[4].obj = rstack[--sp].obj;
    ; 
    //  line no 183 , L73351708 , bytecode index = 
    ...
    // invokestatic org/luaj/vm2/lib/StringLib$dump.error(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_StringLib_00024dump_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
