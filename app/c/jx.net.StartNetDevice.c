...
void func_jx_net_StartNetDevice__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 15 , L648786246 , bytecode index = 
...
struct metaxa_os_devices_net_D3C905* func_jx_net_StartNetDevice_init3com__Ljx_zero_Naming_2_Lmetaxa_os_devices_net_D3C905_2(JThreadRuntime *runtime, struct jx_net_StartNetDevice* p0, struct jx_zero_Naming* p1){
    ...
    rlocal[1].obj = p1;
    ; 
    //  line no 18 , L1710814638 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 18;
    ...
    ; 
    //  line no 19 , L1125964210 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    //  ldc 
    ...
    ; 
    //  line no 21 , L944140566 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    //  ldc 
    ...
    ; 
    //  line no 22 , L1534754611 , bytecode index = 
    // getstatic jx/zero/Debug out Ljx/zero/debug/DebugPrintStream;
    rstack[sp].obj =static_var_jx_zero_Debug.out_2;
    sp += 1;
    //  ldc 
    ...
    ; 
    //  line no 23 , L2030937207 , bytecode index = 
    ...
    ; 
    //  line no 24 , L1551446957 , bytecode index = 
    ...
    ; 
    //  line no 25 , L1471948789 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    if(rstack[--sp].obj  != NULL) goto L1605851606;
    // aconst null
    rstack[sp++].obj = NULL;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L1605851606:
    //  line no 26 , L1605851606 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    // iconst_0
    stack[sp++].i = 0;
    // arrload __refer  ,  L1605851606 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    ; 
    //  line no 28 , L1267556427 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    if(rstack[--sp].obj  != NULL) goto L1585239756;
    // aconst null
    rstack[sp++].obj = NULL;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L1585239756:
    //  line no 30 , L1585239756 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    ...
    if(stack[--sp].i  != 0) goto L1758056825;
    ; 
    //  line no 31 , L223693919 , bytecode index = 
    // new java/lang/Error
    ...
    // athrow
    //     L223693919 in labeltable is :L223693919
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 31;
    ...
    L1758056825:
    //  line no 34 , L1758056825 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    // aconst null
    rstack[sp++].obj = NULL;
    ...
    ; 
    //  line no 35 , L771418758 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    ...
    ; 
    //  line no 37 , L361268035 , bytecode index = 
    // getstatic jx/zero/Debug out Ljx/zero/debug/DebugPrintStream;
    rstack[sp].obj =static_var_jx_zero_Debug.out_2;
    sp += 1;
    //  ldc 
    ...
    ; 
    //  line no 38 , L871160466 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    ...
    ; 
    //  line no 40 , L352083716 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    ; 
...
void func_jx_net_StartNetDevice_main___3Ljava_lang_String_2_V(JThreadRuntime *runtime, struct jx_net_StartNetDevice* p0, JArray * p1){
    ...
    rlocal[1].obj = p1;
    ; 
    //  line no 45 , L1072377306 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 45;
    ...
    rlocal[1].obj = rstack[--sp].obj;
    ; 
    //  line no 48 , L1787189503 , bytecode index = 
    ...
    // iconst_1
    stack[sp++].i = 1;
    // arrload __refer  ,  L1787189503 bc index = 
    {
        s32 idx = stack[--sp].i;
        JArray *arr = rstack[--sp].obj;
        if (!arr) {
    ...
    rlocal[3].obj = rstack[--sp].obj;
    ; 
    //  line no 49 , L477376212 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    rlocal[4].obj = rstack[--sp].obj;
    ; 
    //  line no 55 , L859654796 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    rlocal[2].obj = rstack[--sp].obj;
    ; 
    if(rstack[--sp].obj  == NULL) goto L231202600;
    ; 
    //  line no 56 , L821576394 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[2].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // iconst_0
    ...
    ; 
    //  line no 57 , L1774720883 , bytecode index = 
    method_exit(runtime);
    return;
    L231202600:
    //  line no 60 , L231202600 , bytecode index = 
    // new java/lang/Error
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 7);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    ...
    // athrow
    //     L231202600 in labeltable is :L231202600
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 60;
        throw_exception(runtime, rstack[sp - 1].obj);
