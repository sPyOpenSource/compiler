// CLASS: org/luaj/vm2/lib/Bit32Lib$Bit32Lib2 extends org/luaj/vm2/lib/TwoArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_static {};



__refer arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2[] = {
    func_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_lib_TwoArgFunction[] = {
    func_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //5
...
__refer arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //104
...
__refer arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2[] = {
    {382, 1, arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2}, //0
    {73, 5, arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_lib_TwoArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2817, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 96 , L697001207 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2__init____V(runtime, ins);
}
...
// stack: 2
// args: 2
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2818, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 99 , L670959005 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 99;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/Bit32Lib$Bit32Lib2 opcode I
    stack[sp - 1].i = ((struct org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2*)rstack[sp - 1].obj)->opcode_45;
    sp += 0;
    switch(stack[--sp].i){
        case 0:
            goto L70528019;
    ...
    L70528019:
    //  line no 100 , L70528019 , bytecode index = 
    ...
    // invokestatic org/luaj/vm2/lib/Bit32Lib.arshift(II)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
        rstack[sp].obj = func_org_luaj_vm2_lib_Bit32Lib_arshift__II_Lorg_luaj_vm2_LuaValue_2(runtime, rstack[sp + 0].obj, stack[sp + 1].i, stack[sp + 2].i);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    L731979931:
    //  line no 101 , L731979931 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaValue.checkint()I
    {
        sp -= 0;
    ...
    return rstack[sp - 1].obj;
    L2082740895:
    //  line no 102 , L2082740895 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaValue.checkint()I
    {
        sp -= 0;
    ...
    // invokestatic org/luaj/vm2/lib/Bit32Lib.lshift(II)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
        rstack[sp].obj = func_org_luaj_vm2_lib_Bit32Lib_lshift__II_Lorg_luaj_vm2_LuaValue_2(runtime, rstack[sp + 0].obj, stack[sp + 1].i, stack[sp + 2].i);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    return rstack[sp - 1].obj;
    L1492980244:
    //  line no 103 , L1492980244 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaValue.checkint()I
    {
        sp -= 0;
    ...
    return rstack[sp - 1].obj;
    L2106390956:
    //  line no 104 , L2106390956 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaValue.checkint()I
    {
        sp -= 0;
    ...
    // invokestatic org/luaj/vm2/lib/Bit32Lib.rshift(II)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
        rstack[sp].obj = func_org_luaj_vm2_lib_Bit32Lib_rshift__II_Lorg_luaj_vm2_LuaValue_2(runtime, rstack[sp + 0].obj, stack[sp + 1].i, stack[sp + 2].i);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    return rstack[sp - 1].obj;
    L1986679541:
    //  line no 106 , L1986679541 , bytecode index = 
    // getstatic org/luaj/vm2/lib/Bit32Lib$Bit32Lib2 NIL Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_Bit32Lib_00024Bit32Lib2_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins, para[0].obj);
}
