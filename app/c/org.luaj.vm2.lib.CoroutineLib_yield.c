// CLASS: org/luaj/vm2/lib/CoroutineLib$yield extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_CoroutineLib_00024yield_static {};



__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_lib_CoroutineLib_00024yield[] = {
    func_org_luaj_vm2_lib_CoroutineLib_00024yield_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024yield_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024yield_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024yield_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield[] = {
    {196, 1, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_lib_CoroutineLib_00024yield}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024yield_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_CoroutineLib_00024yield__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_CoroutineLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 979, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 116 , L1027319653 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 116;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/CoroutineLib$yield this$0 Lorg/luaj/vm2/lib/CoroutineLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_CoroutineLib_00024yield*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024yield__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_CoroutineLib_00024yield__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_CoroutineLib_00024yield_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 980, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 118 , L1561745898 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 118;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/CoroutineLib$yield this$0 Lorg/luaj/vm2/lib/CoroutineLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_CoroutineLib_00024yield*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    sp += 0;
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/Globals.yield(Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_Varargs* (*__func_p) (JThreadRuntime *,struct org_luaj_vm2_Varargs*) = find_method(__ins->vm_table, 195, 11);
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024yield_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_CoroutineLib_00024yield_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
