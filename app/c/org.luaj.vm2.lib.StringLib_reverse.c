// CLASS: org/luaj/vm2/lib/StringLib$reverse extends org/luaj/vm2/lib/OneArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_StringLib_00024reverse_static {};



__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_lib_StringLib_00024reverse[] = {
    func_org_luaj_vm2_lib_StringLib_00024reverse_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_lib_OneArgFunction[] = {
    func_org_luaj_vm2_lib_StringLib_00024reverse_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024reverse_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_StringLib_00024reverse_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_StringLib_00024reverse[] = {
    {336, 1, arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_lib_StringLib_00024reverse}, //0
    {99, 5, arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_lib_OneArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024reverse_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_StringLib_00024reverse__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2242, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 693 , L856432481 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_StringLib_00024reverse__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_StringLib_00024reverse__init____V(runtime, ins);
}
...
// stack: 4
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_StringLib_00024reverse_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2243, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 695 , L368040556 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 695;
    ...
    ; 
    //  line no 696 , L1616257837 , bytecode index = 
    ...
    ; 
    //  line no 697 , L871554897 , bytecode index = 
    ...
    ; 
    //  line no 698 , L276561074 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    ...
    stack[sp++].i = local[3].i;
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L262093096;
    ; 
    //  line no 699 , L1078905349 , bytecode index = 
    ...
    // arrstore s8  ,  L1078905349 bc index = 
    {
        ;
        s8 value = stack[--sp].i;
        s32 idx = stack[--sp].i;
    ...
    ; 
    //  line no 698 , L1488526679 , bytecode index = 
    // iinc slot 5 value 1
    local[5].i += 1;
    // iinc slot 6 value -1
    local[6].i += -1;
    ...
    goto L716333944;
    L262093096:
    //  line no 700 , L262093096 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
...
void bridge_org_luaj_vm2_lib_StringLib_00024reverse_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_StringLib_00024reverse_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
