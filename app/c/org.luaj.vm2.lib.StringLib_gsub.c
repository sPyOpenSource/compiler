// CLASS: org/luaj/vm2/lib/StringLib$gsub extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_StringLib_00024gsub_static {};



__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_lib_StringLib_00024gsub[] = {
    func_org_luaj_vm2_lib_StringLib_00024gsub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024gsub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024gsub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_StringLib_00024gsub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_StringLib_00024gsub[] = {
    {316, 1, arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_lib_StringLib_00024gsub}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024gsub_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_StringLib_00024gsub__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1967, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 597 , L951000054 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_StringLib_00024gsub__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_StringLib_00024gsub__init____V(runtime, ins);
}
...
// stack: 5
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_StringLib_00024gsub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1968, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 599 , L129924629 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 599;
    ...
    ; 
    //  line no 600 , L985655365 , bytecode index = 
    ...
    ; 
    //  line no 601 , L2047812687 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    // invokevirtual org/luaj/vm2/Varargs.checkstring(I)Lorg/luaj/vm2/LuaString;
    ...
    ; 
    //  line no 602 , L913450862 , bytecode index = 
    // iconst_-1
    stack[sp++].i = -1;
    local[5].i = stack[--sp].i;
    ; 
    //  line no 603 , L1112062307 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_3
    stack[sp++].i = 3;
    ...
    ; 
    //  line no 604 , L133205167 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_4
    stack[sp++].i = 4;
    ...
    ; 
    //  line no 605 , L81722690 , bytecode index = 
    ...
    if(stack[--sp].i  <= 0) goto L590406624;
    rstack[sp++].obj = rlocal[4].obj;
    // iconst_0
    stack[sp++].i = 0;
    // invokevirtual org/luaj/vm2/LuaString.charAt(I)I
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        s32 (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 31, 88);
    ...
    stack[sp++].i = 94;
    sp -= 2;
    if(stack[sp + 0].i  != stack[sp + 1].i) goto L590406624;
    // iconst_1
    stack[sp++].i = 1;
    goto L615830852;
    L590406624:
    ...
    ; 
    //  line no 607 , L664969353 , bytecode index = 
    ...
    ; 
    //  line no 608 , L1415937490 , bytecode index = 
    ...
    ; 
    //  line no 610 , L1886301021 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    local[11].i = stack[--sp].i;
    ; 
    //  line no 611 , L1920098017 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    local[12].i = stack[--sp].i;
    L1088818894:
    //  line no 612 , L1088818894 , bytecode index = 
    stack[sp++].i = local[12].i;
    stack[sp++].i = local[7].i;
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L1066561773;
    ; 
    //  line no 613 , L975372289 , bytecode index = 
    ...
    ; 
    //  line no 614 , L1522975986 , bytecode index = 
    rstack[sp++].obj = rlocal[10].obj;
    stack[sp++].i = local[11].i;
    stack[sp++].i = local[8].i;
    if(stack[--sp].i  == 0) goto L715534618;
    // iconst_1
    stack[sp++].i = 1;
    goto L102709691;
    L715534618:
    ...
    ; 
    //  line no 615 , L614335089 , bytecode index = 
    stack[sp++].i = local[13].i;
    // iconst_-1
    stack[sp++].i = -1;
    sp -= 2;
    if(stack[sp + 0].i  == stack[sp + 1].i) goto L1217639236;
    stack[sp++].i = local[13].i;
    stack[sp++].i = local[5].i;
    sp -= 2;
    if(stack[sp + 0].i  == stack[sp + 1].i) goto L1217639236;
    ; 
    //  line no 616 , L1403413933 , bytecode index = 
    // iinc slot 12 value 1
    local[12].i += 1;
    ; 
    //  line no 617 , L738937987 , bytecode index = 
    rstack[sp++].obj = rlocal[10].obj;
    rstack[sp++].obj = rlocal[9].obj;
    stack[sp++].i = local[11].i;
    stack[sp++].i = local[13].i;
    rstack[sp++].obj = rlocal[6].obj;
    // invokevirtual org/luaj/vm2/lib/StringLib$MatchState.add_value(Lorg/luaj/vm2/Buffer;IILorg/luaj/vm2/LuaValue;)V
    {
        sp -= 4;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        void (*__func_p) (JThreadRuntime *,struct org_luaj_vm2_Buffer*,s32,s32,struct org_luaj_vm2_LuaValue*) = find_method(__ins->vm_table, 149, 1);
        __func_p(runtime, rstack[sp + 0].obj, stack[sp + 1].i, stack[sp + 2].i, rstack[sp + 3].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 618 , L2018664185 , bytecode index = 
    stack[sp++].i = local[13].i;
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ...
    goto L755944228;
    L1217639236:
    //  line no 620 , L1217639236 , bytecode index = 
    stack[sp++].i = local[11].i;
    stack[sp++].i = local[3].i;
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L1066561773;
    ; 
    //  line no 621 , L1298483237 , bytecode index = 
    rstack[sp++].obj = rlocal[9].obj;
    rstack[sp++].obj = rlocal[2].obj;
    stack[sp++].i = local[11].i;
    ...
    --sp; //pop
    L755944228:
    //  line no 623 , L755944228 , bytecode index = 
    stack[sp++].i = local[8].i;
    if(stack[--sp].i  == 0) goto L1006398046;
    goto L1066561773;
    L1006398046:
    //  line no 624 , L1006398046 , bytecode index = 
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L1088818894;
    L1066561773:
    //  line no 625 , L1066561773 , bytecode index = 
    rstack[sp++].obj = rlocal[9].obj;
    rstack[sp++].obj = rlocal[2].obj;
    stack[sp++].i = local[11].i;
    stack[sp++].i = local[3].i;
    ...
    --sp; //pop
    ; 
    //  line no 626 , L1370709582 , bytecode index = 
    rstack[sp++].obj = rlocal[9].obj;
    ...
    stack[sp++].i = local[12].i;
    // invokestatic org/luaj/vm2/lib/StringLib$gsub.valueOf(I)Lorg/luaj/vm2/LuaInteger;
    {
        sp -= 2;
    ...
    // invokestatic org/luaj/vm2/lib/StringLib$gsub.varargsOf(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 3;
...
void bridge_org_luaj_vm2_lib_StringLib_00024gsub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_StringLib_00024gsub_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
