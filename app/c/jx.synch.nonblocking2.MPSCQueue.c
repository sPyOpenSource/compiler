...
void func_jx_synch_nonblocking2_MPSCQueue__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 12 , L1683662486 , bytecode index = 
    ...
    ; 
    //  line no 10 , L1823409783 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 13 , L1094523823 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 14 , L384515747 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/synch/nonblocking2/MPSCQueue cpuManager Ljx/zero/CPUManager;
    rstack[sp - 1].obj = ((struct jx_synch_nonblocking2_MPSCQueue*)rstack[sp - 1].obj)->cpuManager_4;
    ...
    ; 
    //  line no 15 , L657736958 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_jx_synch_nonblocking2_MPSCQueue_enqueue__Ljava_lang_Object_2_V(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 19 , L443934570 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 19;
    ...
    ; 
    //  line no 20 , L1428475041 , bytecode index = 
    ...
    L1345483087:
    //  line no 24 , L1345483087 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 25 , L4766562 , bytecode index = 
    ...
    ; 
    //  line no 26 , L892555958 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/synch/nonblocking2/MPSCQueue tail Ljx/synch/nonblocking2/SPSCQueue$Node;
    rstack[sp - 1].obj = ((struct jx_synch_nonblocking2_MPSCQueue*)rstack[sp - 1].obj)->tail_1;
    sp += 0;
    sp -= 2;
    if(rstack[sp + 0].obj  != rstack[sp + 1].obj) goto L1182908789;
    ; 
    //  line no 27 , L91912419 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    if(rstack[--sp].obj  != NULL) goto L1076641925;
    ; 
    //  line no 28 , L1873091796 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    if(stack[--sp].i  == 0) goto L1182908789;
    ; 
    //  line no 29 , L661119548 , bytecode index = 
    goto L1896622931;
    L1076641925:
    //  line no 32 , L1076641925 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    --sp; //pop
    L1182908789:
    //  line no 35 , L1182908789 , bytecode index = 
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L1345483087;
    L1896622931:
    //  line no 36 , L1896622931 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/synch/nonblocking2/MPSCQueue cas_tail Ljx/zero/CAS;
    rstack[sp - 1].obj = ((struct jx_synch_nonblocking2_MPSCQueue*)rstack[sp - 1].obj)->cas_1tail_3;
    sp += 0;
    ...
    --sp; //pop
    ; 
    //  line no 37 , L1401316767 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
