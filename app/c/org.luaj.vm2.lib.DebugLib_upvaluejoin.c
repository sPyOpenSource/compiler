// CLASS: org/luaj/vm2/lib/DebugLib$upvaluejoin extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024upvaluejoin_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_lib_DebugLib_00024upvaluejoin[] = {
    func_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin[] = {
    {359, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_lib_DebugLib_00024upvaluejoin}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_DebugLib_00024upvaluejoin__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3290, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 388 , L1751972013 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_DebugLib_00024upvaluejoin__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024upvaluejoin__init____V(runtime, ins);
}
...
// stack: 5
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3291, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 390 , L1726169577 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 390;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    // invokevirtual org/luaj/vm2/Varargs.checkclosure(I)Lorg/luaj/vm2/LuaClosure;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaClosure* (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 2, 30);
    ...
    ; 
    //  line no 391 , L1531506932 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    ; 
    //  line no 392 , L1416549024 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_3
    stack[sp++].i = 3;
    // invokevirtual org/luaj/vm2/Varargs.checkclosure(I)Lorg/luaj/vm2/LuaClosure;
    ...
    ; 
    //  line no 393 , L1543272907 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_4
    stack[sp++].i = 4;
    // invokevirtual org/luaj/vm2/Varargs.checkint(I)I
    ...
    ; 
    //  line no 394 , L669812564 , bytecode index = 
    stack[sp++].i = local[3].i;
    // iconst_1
    stack[sp++].i = 1;
    sp -= 2;
    if(stack[sp + 0].i  < stack[sp + 1].i) goto L1002380301;
    stack[sp++].i = local[3].i;
    ...
    sp -= 2;
    if(stack[sp + 0].i  <= stack[sp + 1].i) goto L426123784;
    L1002380301:
    //  line no 395 , L1002380301 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1762);
    // invokevirtual org/luaj/vm2/lib/DebugLib$upvaluejoin.argerror(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
    ...
    --sp; //pop
    L426123784:
    //  line no 396 , L426123784 , bytecode index = 
    stack[sp++].i = local[5].i;
    // iconst_1
    stack[sp++].i = 1;
    sp -= 2;
    if(stack[sp + 0].i  < stack[sp + 1].i) goto L560734926;
    stack[sp++].i = local[5].i;
    rstack[sp++].obj = rlocal[4].obj;
    // getfield org/luaj/vm2/LuaClosure upValues [Lorg/luaj/vm2/UpValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaClosure*)rstack[sp - 1].obj)->upValues_47;
    sp += 0;
    // arraylength  label  L426123784
    if (!rstack[sp - 1].obj) {
        rstack[sp++].obj = construct_and_throw_exception(runtime, 0, 
        goto __ExceptionHandler;
    }
    stack[sp - 1].i = rstack[sp - 1].ins->prop.arr_length; 
    sp -= 2;
    if(stack[sp + 0].i  <= stack[sp + 1].i) goto L1660536720;
    L560734926:
    //  line no 397 , L560734926 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1762);
    // invokevirtual org/luaj/vm2/lib/DebugLib$upvaluejoin.argerror(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    ...
    --sp; //pop
    L1660536720:
    //  line no 398 , L1660536720 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // getfield org/luaj/vm2/LuaClosure upValues [Lorg/luaj/vm2/UpValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaClosure*)rstack[sp - 1].obj)->upValues_47;
    sp += 0;
    ...
    stack[sp - 2].i = stack[sp - 2].i - stack[sp - 1].i; 
    --sp;
    // arrload __refer  ,  L1660536720 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    // arrstore __refer  ,  L1660536720 bc index = 
    {
        ;
    ...
    ; 
    //  line no 399 , L568717494 , bytecode index = 
    // getstatic org/luaj/vm2/lib/DebugLib$upvaluejoin NONE Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024upvaluejoin_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
