// CLASS: org/luaj/vm2/lib/BaseLib$rawlen extends org/luaj/vm2/lib/LibFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024rawlen_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_lib_BaseLib_00024rawlen[] = {
    func_org_luaj_vm2_lib_BaseLib_00024rawlen_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024rawlen_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024rawlen_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen[] = {
    {372, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_lib_BaseLib_00024rawlen}, //0
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_lib_LibFunction}, //1
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_LuaFunction}, //2
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_LuaValue}, //3
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_org_luaj_vm2_Varargs}, //4
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024rawlen_from_java_lang_Object}, //5
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_BaseLib_00024rawlen__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3056, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 285 , L664144670 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_BaseLib_00024rawlen__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024rawlen__init____V(runtime, ins);
}
...
// stack: 1
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_BaseLib_00024rawlen_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3057, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 287 , L1027217667 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 287;
    ...
    // invokestatic org/luaj/vm2/lib/BaseLib$rawlen.valueOf(I)Lorg/luaj/vm2/LuaInteger;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024rawlen_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024rawlen_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
