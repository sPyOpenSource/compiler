// CLASS: org/luaj/vm2/lib/StringLib$_byte extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_StringLib_00024_1byte_static {};



__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_lib_StringLib_00024_1byte[] = {
    func_org_luaj_vm2_lib_StringLib_00024_1byte_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024_1byte_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024_1byte_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_StringLib_00024_1byte_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_StringLib_00024_1byte[] = {
    {57, 1, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_lib_StringLib_00024_1byte}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024_1byte_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_StringLib_00024_1byte__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 120 , L827084938 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_StringLib_00024_1byte__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_StringLib_00024_1byte__init____V(runtime, ins);
}
...
// stack: 5
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_StringLib_00024_1byte_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 122 , L112619572 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 122;
    ...
    ; 
    //  line no 123 , L371619938 , bytecode index = 
    ...
    ; 
    //  line no 124 , L1161667116 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    // iconst_1
    ...
    // invokestatic org/luaj/vm2/lib/StringLib.posrelat(II)I
    {
        sp -= 3;
        stack[sp].i = func_org_luaj_vm2_lib_StringLib_posrelat__II_I(runtime, rstack[sp + 0].obj, stack[sp + 1].i, stack[sp + 2].i);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 125 , L1898220577 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_3
    stack[sp++].i = 3;
    ...
    ; 
    //  line no 127 , L1143371233 , bytecode index = 
    stack[sp++].i = local[4].i;
    if(stack[--sp].i  > 0) goto L1634132079;
    // iconst_1
    stack[sp++].i = 1;
    local[4].i = stack[--sp].i;
    L1634132079:
    //  line no 128 , L1634132079 , bytecode index = 
    ...
    local[5].i = stack[--sp].i;
    L1239548589:
    //  line no 129 , L1239548589 , bytecode index = 
    stack[sp++].i = local[4].i;
    stack[sp++].i = local[5].i;
    sp -= 2;
    if(stack[sp + 0].i  <= stack[sp + 1].i) goto L477289012;
    // getstatic org/luaj/vm2/lib/StringLib$_byte NONE Lorg/luaj/vm2/LuaValue;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.NONE_16;
    sp += 1;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L477289012:
    //  line no 130 , L477289012 , bytecode index = 
    stack[sp++].i = local[5].i;
    stack[sp++].i = local[4].i;
    ...
    ; 
    //  line no 131 , L1795960102 , bytecode index = 
    stack[sp++].i = local[4].i;
    ...
    stack[sp++].i = local[5].i;
    sp -= 2;
    if(stack[sp + 0].i  > stack[sp + 1].i) goto L1027591600;
    ; 
    //  line no 132 , L1678854096 , bytecode index = 
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 674);
    // invokestatic org/luaj/vm2/lib/StringLib$_byte.error(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
    ...
    --sp; //pop
    L1027591600:
    //  line no 133 , L1027591600 , bytecode index = 
    stack[sp++].i = local[6].i;
    ...
    ; 
    //  line no 134 , L1849201180 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    ...
    stack[sp++].i = local[6].i;
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L667346055;
    ; 
    //  line no 135 , L1225197672 , bytecode index = 
    ...
    // invokestatic org/luaj/vm2/lib/StringLib$_byte.valueOf(I)Lorg/luaj/vm2/LuaInteger;
    {
        sp -= 2;
    ...
    // arrstore __refer  ,  L1225197672 bc index = 
    {
        ;
    ...
    ; 
    //  line no 134 , L1669712678 , bytecode index = 
    // iinc slot 7 value 1
    local[7].i += 1;
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L1691875296;
    L667346055:
    //  line no 136 , L667346055 , bytecode index = 
    rstack[sp++].obj = rlocal[8].obj;
    // invokestatic org/luaj/vm2/lib/StringLib$_byte.varargsOf([Lorg/luaj/vm2/LuaValue;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_StringLib_00024_1byte_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_StringLib_00024_1byte_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
