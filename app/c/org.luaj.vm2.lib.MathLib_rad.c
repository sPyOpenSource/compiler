// CLASS: org/luaj/vm2/lib/MathLib$rad extends org/luaj/vm2/lib/MathLib$UnaryOp
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_MathLib_00024rad_static {};



__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_lib_MathLib_00024rad[] = {
    func_org_luaj_vm2_lib_MathLib_00024rad_call__D_D  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_lib_MathLib_00024UnaryOp[] = {
    func_org_luaj_vm2_lib_MathLib_00024UnaryOp_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
    func_org_luaj_vm2_lib_MathLib_00024rad_call__D_D  //1
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_lib_OneArgFunction[] = {
    func_org_luaj_vm2_lib_MathLib_00024UnaryOp_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_lib_LibFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_MathLib_00024rad[] = {
    {231, 1, arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_lib_MathLib_00024rad}, //0
    {144, 2, arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_lib_MathLib_00024UnaryOp}, //1
    {99, 5, arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_lib_OneArgFunction}, //2
    {18, 9, arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_lib_LibFunction}, //3
    {19, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_LuaFunction}, //4
    {1, 210, arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_LuaValue}, //5
    {2, 63, arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_org_luaj_vm2_Varargs}, //6
    {5, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024rad_from_java_lang_Object}, //7
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_MathLib_00024rad__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2924, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 151 , L504538534 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_MathLib_00024rad__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_MathLib_00024rad__init____V(runtime, ins);
}
...
// stack: 2
// args: 1
f64 func_org_luaj_vm2_lib_MathLib_00024rad_call__D_D(JThreadRuntime *runtime, f64 p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2925, &rstack[0], &rlocal[0], &sp);
    local[0].d = p0;
    ; 
    //  line no 151 , L1202178366 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 151;
    ...
    {
        sp -= 3;
        stack[sp].d = func_java_lang_Math_toRadians__D_D(runtime, rstack[sp + 0].obj, stack[sp + 1].d);
        sp += 2;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
...
void bridge_org_luaj_vm2_lib_MathLib_00024rad_call__D_D(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->d = func_org_luaj_vm2_lib_MathLib_00024rad_call__D_D(runtime, ins);
}
