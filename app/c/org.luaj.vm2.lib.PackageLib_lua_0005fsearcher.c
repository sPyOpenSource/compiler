// CLASS: org/luaj/vm2/lib/PackageLib$lua_searcher extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_PackageLib_00024lua_1searcher_static {};



__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_lib_PackageLib_00024lua_1searcher[] = {
    func_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher[] = {
    {351, 1, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_lib_PackageLib_00024lua_1searcher}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_PackageLib_00024lua_1searcher__init___Lorg_luaj_vm2_lib_PackageLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_PackageLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2466, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 256 , L1879000767 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 256;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/PackageLib$lua_searcher this$0 Lorg/luaj/vm2/lib/PackageLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_PackageLib_00024lua_1searcher*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_PackageLib_00024lua_1searcher__init___Lorg_luaj_vm2_lib_PackageLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_PackageLib_00024lua_1searcher__init___Lorg_luaj_vm2_lib_PackageLib_2_V(runtime, ins);
}
...
// stack: 4
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2467, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 258 , L984235065 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 258;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    ...
    ; 
    //  line no 261 , L1705634364 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/PackageLib$lua_searcher this$0 Lorg/luaj/vm2/lib/PackageLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_PackageLib_00024lua_1searcher*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    ; 
    //  line no 262 , L1895203464 , bytecode index = 
    ...
    if(stack[--sp].i  != 0) goto L1183912264;
    ; 
    //  line no 263 , L766621271 , bytecode index = 
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 4334);
    // invokestatic org/luaj/vm2/lib/PackageLib$lua_searcher.valueOf(Ljava/lang/String;)Lorg/luaj/vm2/LuaString;
    {
        sp -= 2;
    ...
    L1183912264:
    //  line no 266 , L1183912264 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/PackageLib$lua_searcher this$0 Lorg/luaj/vm2/lib/PackageLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_PackageLib_00024lua_1searcher*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    rstack[sp++].obj = rlocal[3].obj;
    // invokestatic org/luaj/vm2/lib/PackageLib$lua_searcher.varargsOf(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 3;
    ...
    ; 
    //  line no 269 , L132338135 , bytecode index = 
    ...
    if(stack[--sp].i  != 0) goto L1137013089;
    ; 
    //  line no 270 , L227549952 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    // invokevirtual org/luaj/vm2/LuaValue.tostring()Lorg/luaj/vm2/LuaValue;
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 1, 28);
    ...
    return rstack[sp - 1].obj;
    L1137013089:
    //  line no 271 , L1137013089 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    ...
    ; 
    //  line no 274 , L766722027 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/PackageLib$lua_searcher this$0 Lorg/luaj/vm2/lib/PackageLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_PackageLib_00024lua_1searcher*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    // invokevirtual org/luaj/vm2/Globals.loadfile(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *,struct java_lang_String*) = find_method(__ins->vm_table, 195, 1);
        rstack[sp].obj = __func_p(runtime, rstack[sp + 0].obj);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    rlocal[4].obj = rstack[--sp].obj;
    ; 
    //  line no 275 , L818130531 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    // invokevirtual org/luaj/vm2/Varargs.arg1()Lorg/luaj/vm2/LuaValue;
    {
        sp -= 0;
    ...
    if(stack[--sp].i  == 0) goto L1483050851;
    ; 
    //  line no 276 , L1424043852 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    // invokevirtual org/luaj/vm2/Varargs.arg1()Lorg/luaj/vm2/LuaValue;
    {
        sp -= 0;
    ...
    return rstack[sp - 1].obj;
    L1483050851:
    //  line no 279 , L1483050851 , bytecode index = 
    // getstatic org/luaj/vm2/lib/PackageLib$lua_searcher NIL Lorg/luaj/vm2/LuaValue;
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 4335);
    // invokevirtual java/lang/StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
...
void bridge_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_PackageLib_00024lua_1searcher_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
