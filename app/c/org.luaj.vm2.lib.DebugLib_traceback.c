// CLASS: org/luaj/vm2/lib/DebugLib$traceback extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024traceback_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_lib_DebugLib_00024traceback[] = {
    func_org_luaj_vm2_lib_DebugLib_00024traceback_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024traceback_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024traceback_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024traceback_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024traceback[] = {
    {106, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_lib_DebugLib_00024traceback}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024traceback_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_DebugLib_00024traceback__init___Lorg_luaj_vm2_lib_DebugLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_DebugLib* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 361 , L550402284 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 361;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/DebugLib$traceback this$0 Lorg/luaj/vm2/lib/DebugLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_DebugLib_00024traceback*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024traceback__init___Lorg_luaj_vm2_lib_DebugLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024traceback__init___Lorg_luaj_vm2_lib_DebugLib_2_V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_DebugLib_00024traceback_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 559, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 363 , L1449263511 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 363;
    // iconst_1
    stack[sp++].i = 1;
    ...
    ; 
    //  line no 364 , L116237769 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  == 0) goto L1438098656;
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    L1438098656:
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/DebugLib$traceback this$0 Lorg/luaj/vm2/lib/DebugLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_DebugLib_00024traceback*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    ; 
    //  line no 365 , L422396878 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    ; 
    //  line no 366 , L1912962767 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    ; 
    //  line no 367 , L452805835 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/DebugLib$traceback this$0 Lorg/luaj/vm2/lib/DebugLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_DebugLib_00024traceback*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    ; 
    //  line no 368 , L1769190683 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    if(rstack[--sp].obj  == NULL) goto L447981768;
    ...
    rstack[sp++].obj = rlocal[6].obj;
    L1125736023:
    // invokestatic org/luaj/vm2/lib/DebugLib$traceback.valueOf(Ljava/lang/String;)Lorg/luaj/vm2/LuaString;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024traceback_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024traceback_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
