...
void func_jx_rpc_AuthUnix__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 13 , L1296674576 , bytecode index = 
    ...
    ; 
    //  line no 4 , L664457955 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // iconst_1
    stack[sp++].i = 1;
    ...
    ; 
    //  line no 14 , L1477657879 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_jx_rpc_AuthUnix__init___Ljava_lang_String_2II_3I_V(JThreadRuntime *runtime, struct java_lang_String* p0, s32 p1, s32 p2, JArray * p3){
    ...
    rlocal[3].obj = p3;
    ; 
    //  line no 15 , L1147258851 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 15;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial jx/rpc/Auth.<init>()V
    ...
    ((struct jx_rpc_AuthUnix*)rstack[sp + 0].obj)->id_3 = stack[sp + 1].i;
    ; 
    //  line no 16 , L2011482127 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 17 , L905735620 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 18 , L2145970759 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 19 , L577405636 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 20 , L1931444790 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 21 , L626742236 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
