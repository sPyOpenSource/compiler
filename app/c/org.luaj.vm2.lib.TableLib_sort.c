// CLASS: org/luaj/vm2/lib/TableLib$sort extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_TableLib_00024sort_static {};



__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_lib_TableLib_00024sort[] = {
    func_org_luaj_vm2_lib_TableLib_00024sort_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_TableLib_00024sort_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_TableLib_00024sort_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_TableLib_00024sort_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_TableLib_00024sort[] = {
    {115, 1, arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_lib_TableLib_00024sort}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_TableLib_00024sort_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_TableLib_00024sort__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 140 , L1199673596 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_TableLib_00024sort__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_TableLib_00024sort__init____V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_TableLib_00024sort_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 142 , L982757413 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 142;
    ...
    ; 
    //  line no 143 , L902478634 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    if(stack[--sp].i  == 0) goto L2114444063;
    // getstatic org/luaj/vm2/lib/TableLib$sort NIL Lorg/luaj/vm2/LuaValue;
    ...
    L294247762:
    //  line no 142 , L294247762 , bytecode index = 
    // invokevirtual org/luaj/vm2/LuaTable.sort(Lorg/luaj/vm2/LuaValue;)V
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        void (*__func_p) (JThreadRuntime *,struct org_luaj_vm2_LuaValue*) = find_method(__ins->vm_table, 33, 30);
    ...
    ; 
    //  line no 144 , L918312414 , bytecode index = 
    // getstatic org/luaj/vm2/lib/TableLib$sort NONE Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_TableLib_00024sort_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_TableLib_00024sort_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
