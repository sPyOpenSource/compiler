...
void func_java_util_TreeSet__init___Ljava_util_NavigableMap_2_V(JThreadRuntime *runtime, struct java_util_NavigableMap* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 106 , L884860061 , bytecode index = 
    ...
    ; 
    //  line no 107 , L454884231 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 108 , L136393487 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_TreeSet__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 124 , L1572256205 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 124;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 125 , L554348863 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_TreeSet__init___Ljava_util_Comparator_2_V(JThreadRuntime *runtime, struct java_util_Comparator* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 141 , L126189538 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 141;
    rstack[sp++].obj = rlocal[0].obj;
    // new java/util/TreeMap
    ...
    ; 
    //  line no 142 , L1863702030 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_TreeSet__init___Ljava_util_Collection_2_V(JThreadRuntime *runtime, struct java_util_Collection* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 159 , L702025003 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 159;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 160 , L93199773 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    --sp; //pop
    ; 
    //  line no 161 , L1147805316 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_TreeSet__init___Ljava_util_SortedSet_2_V(JThreadRuntime *runtime, struct java_util_SortedSet* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 171 , L643290333 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 171;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 172 , L1396721535 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual java/util/TreeSet.addAll(Ljava/util/Collection;)Z
    {
    ...
    --sp; //pop
    ; 
    //  line no 173 , L1204481453 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
struct java_util_Iterator* func_java_util_TreeSet_iterator___Ljava_util_Iterator_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 181 , L1766869737 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 181;
    rstack[sp++].obj = rlocal[0].obj;
...
struct java_util_Iterator* func_java_util_TreeSet_descendingIterator___Ljava_util_Iterator_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 191 , L684566052 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 191;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
struct java_util_NavigableSet* func_java_util_TreeSet_descendingSet___Ljava_util_NavigableSet_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 198 , L2129442232 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 198;
...
s32 func_java_util_TreeSet_size___I(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 207 , L1473981203 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 207;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
s8 func_java_util_TreeSet_isEmpty___Z(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 216 , L1552326679 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 216;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
s8 func_java_util_TreeSet_contains__Ljava_lang_Object_2_Z(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 234 , L1383519982 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 234;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
s8 func_java_util_TreeSet_add__Ljava_lang_Object_2_Z(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 255 , L403174823 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 255;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    ...
    if(rstack[--sp].obj  != NULL) goto L462526099;
    // iconst_1
    stack[sp++].i = 1;
    goto L2142565033;
    L462526099:
...
s8 func_java_util_TreeSet_remove__Ljava_lang_Object_2_Z(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 276 , L1783568981 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 276;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    ...
    sp += 1;
    sp -= 2;
    if(rstack[sp + 0].obj  != rstack[sp + 1].obj) goto L2113748097;
    // iconst_1
    stack[sp++].i = 1;
    goto L629454893;
    L2113748097:
...
void func_java_util_TreeSet_clear___V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 284 , L1764996806 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 284;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    ...
    ; 
    //  line no 285 , L2101249621 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
s8 func_java_util_TreeSet_addAll__Ljava_util_Collection_2_Z(JThreadRuntime *runtime, struct java_util_Collection* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 300 , L1651162064 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 300;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    ...
    if(stack[--sp].i  != 0) goto L379303133;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  == 0) goto L379303133;
    ; 
    //  line no 303 , L530486389 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 304 , L983595261 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    rstack[sp - 1].obj = ((struct java_util_TreeSet*)rstack[sp - 1].obj)->m_1;
    sp += 0;
    ...
    ; 
    //  line no 305 , L220454978 , bytecode index = 
    ...
    ; 
    //  line no 306 , L1188401255 , bytecode index = 
    ...
    ; 
    //  line no 307 , L755210740 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    rstack[sp++].obj = rlocal[5].obj;
    sp -= 2;
    if(rstack[sp + 0].obj  == rstack[sp + 1].obj) goto L350059321;
    rstack[sp++].obj = rlocal[4].obj;
    if(rstack[--sp].obj  == NULL) goto L379303133;
    rstack[sp++].obj = rlocal[4].obj;
    rstack[sp++].obj = rlocal[5].obj;
    ...
    if(stack[--sp].i  == 0) goto L379303133;
    L350059321:
    //  line no 309 , L350059321 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    method_exit(runtime);
    return stack[sp - 1].i;
    L379303133:
    //  line no 312 , L379303133 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
...
struct java_util_NavigableSet* func_java_util_TreeSet_subSet__Ljava_lang_Object_2ZLjava_lang_Object_2Z_Ljava_util_NavigableSet_2(JThreadRuntime *runtime, struct java_lang_Object* p0, s8 p1, struct java_lang_Object* p2, s8 p3){
    ...
    local[3].i = p3;
    ; 
    //  line no 325 , L1825719826 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 325;
    // new java/util/TreeSet
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 121);
...
struct java_util_NavigableSet* func_java_util_TreeSet_headSet__Ljava_lang_Object_2Z_Ljava_util_NavigableSet_2(JThreadRuntime *runtime, struct java_lang_Object* p0, s8 p1){
    ...
    local[1].i = p1;
    ; 
    //  line no 338 , L575935098 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 338;
    // new java/util/TreeSet
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 121);
...
struct java_util_NavigableSet* func_java_util_TreeSet_tailSet__Ljava_lang_Object_2Z_Ljava_util_NavigableSet_2(JThreadRuntime *runtime, struct java_lang_Object* p0, s8 p1){
    ...
    local[1].i = p1;
    ; 
    //  line no 350 , L798310141 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 350;
    // new java/util/TreeSet
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 121);
...
struct java_util_SortedSet* func_java_util_TreeSet_subSet__Ljava_lang_Object_2Ljava_lang_Object_2_Ljava_util_SortedSet_2(JThreadRuntime *runtime, struct java_lang_Object* p0, struct java_lang_Object* p1){
    ...
    rlocal[1].obj = p1;
    ; 
    //  line no 361 , L221111433 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 361;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
...
struct java_util_SortedSet* func_java_util_TreeSet_headSet__Ljava_lang_Object_2_Ljava_util_SortedSet_2(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 372 , L307829448 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 372;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
...
struct java_util_SortedSet* func_java_util_TreeSet_tailSet__Ljava_lang_Object_2_Ljava_util_SortedSet_2(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 383 , L940857381 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 383;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
...
struct java_util_Comparator* func_java_util_TreeSet_comparator___Ljava_util_Comparator_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 387 , L459718907 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 387;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
struct java_lang_Object* func_java_util_TreeSet_first___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 394 , L616674002 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 394;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
struct java_lang_Object* func_java_util_TreeSet_last___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 401 , L1351478315 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 401;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
struct java_lang_Object* func_java_util_TreeSet_lower__Ljava_lang_Object_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 414 , L925973605 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 414;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
struct java_lang_Object* func_java_util_TreeSet_floor__Ljava_lang_Object_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 425 , L2038522556 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 425;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
struct java_lang_Object* func_java_util_TreeSet_ceiling__Ljava_lang_Object_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 436 , L596910004 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 436;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
struct java_lang_Object* func_java_util_TreeSet_higher__Ljava_lang_Object_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 447 , L106999035 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 447;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
...
struct java_lang_Object* func_java_util_TreeSet_pollFirst___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 454 , L1593458942 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 454;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    ...
    ; 
    //  line no 455 , L530539368 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    if(rstack[--sp].obj  != NULL) goto L479920916;
    // aconst null
    rstack[sp++].obj = NULL;
    goto L1161322357;
    L479920916:
...
struct java_lang_Object* func_java_util_TreeSet_pollLast___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 462 , L757708014 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 462;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    ...
    rlocal[1].obj = rstack[--sp].obj;
    ; 
    //  line no 463 , L1777238524 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
...
struct java_lang_Object* func_java_util_TreeSet_clone___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    // try catch :L304354378 L704106237 L1880078449 (
    L304354378:
    __frame->bytecodeIndex = 
    //  line no 476 , L304354378 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 476;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    L704106237:
    __frame->bytecodeIndex = 
    //  line no 479 , L704106237 , bytecode index = 
    goto L993370665;
    L1880078449:
    //  line no 477 , L1880078449 , bytecode index = 
    rlocal[2].obj = rstack[--sp].obj;
    ; 
    //  line no 478 , L159475521 , bytecode index = 
    ...
    // athrow
    //     L159475521 in labeltable is :L159475521
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 478;
    ...
    L993370665:
    //  line no 481 , L993370665 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // new java/util/TreeMap
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 120);
    // dup
    ...
    ((struct java_util_TreeSet*)rstack[sp + 0].obj)->m_1 = rstack[sp + 1].obj;
    ; 
    //  line no 482 , L504807594 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    ; 
...
void func_java_util_TreeSet_writeObject__Ljava_io_ObjectOutputStream_2_V(JThreadRuntime *runtime, struct java_io_ObjectOutputStream* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 500 , L90567568 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 500;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 503 , L131872530 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    rstack[sp - 1].obj = ((struct java_util_TreeSet*)rstack[sp - 1].obj)->m_1;
    ...
    ; 
    //  line no 506 , L795321555 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    rstack[sp - 1].obj = ((struct java_util_TreeSet*)rstack[sp - 1].obj)->m_1;
    ...
    ; 
    //  line no 509 , L98826337 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/util/TreeSet m Ljava/util/NavigableMap;
    rstack[sp - 1].obj = ((struct java_util_TreeSet*)rstack[sp - 1].obj)->m_1;
    sp += 0;
    ...
    if(stack[--sp].i  == 0) goto L1236444285;
    rstack[sp++].obj = rlocal[2].obj;
    ...
    rlocal[3].obj = rstack[--sp].obj;
    ; 
    //  line no 510 , L1541525668 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[3].obj;
    // invokevirtual java/io/ObjectOutputStream.writeObject(Ljava/lang/Object;)V
    {
    ...
    goto L800088638;
    L1236444285:
    //  line no 511 , L1236444285 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_util_TreeSet_readObject__Ljava_io_ObjectInputStream_2_V(JThreadRuntime *runtime, struct java_io_ObjectInputStream* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 520 , L823914581 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 520;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 524 , L1680503330 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    rlocal[2].obj = rstack[--sp].obj;
    ; 
    //  line no 527 , L2100440237 , bytecode index = 
    // new java/util/TreeMap
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 120);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    ...
    rlocal[3].obj = rstack[--sp].obj;
    ; 
    //  line no 528 , L566113173 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[3].obj;
    // putfield java/util/TreeSet m Ljava/util/NavigableMap;
    sp -= 2;
    ((struct java_util_TreeSet*)rstack[sp + 0].obj)->m_1 = rstack[sp + 1].obj;
    ; 
    //  line no 531 , L1330247343 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 534 , L2017797638 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
struct java_util_Spliterator* func_java_util_TreeSet_spliterator___Ljava_util_Spliterator_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 557 , L1150058854 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 557;
    // new java/lang/Error
    ...
    // athrow
    //     L1150058854 in labeltable is :L1150058854
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 557;
        throw_exception(runtime, rstack[sp - 1].obj);
...
JArray * func_java_util_TreeSet_toArray___3Ljava_lang_Object_2__3Ljava_lang_Object_2(JThreadRuntime *runtime, JArray * p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 564 , L366252104 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 564;
    ...
    // athrow
    //     L366252104 in labeltable is :L366252104
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 564;
        throw_exception(runtime, rstack[sp - 1].obj);
...
void func_java_util_TreeSet__clinit____V(JThreadRuntime *runtime, struct java_util_TreeSet* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 101 , L1346343363 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 101;
