// CLASS: org/luaj/vm2/lib/MathLib$random extends org/luaj/vm2/lib/LibFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_MathLib_00024random_static {};



__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_lib_MathLib_00024random[] = {
    func_org_luaj_vm2_lib_MathLib_00024random_call___Lorg_luaj_vm2_LuaValue_2,  //0
    func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //1
    func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //2
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024random_call___Lorg_luaj_vm2_LuaValue_2,  //3
    func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
    func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //5
    func_org_luaj_vm2_lib_LibFunction_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //6
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_MathLib_00024random_call___Lorg_luaj_vm2_LuaValue_2,  //101
    func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
    func_org_luaj_vm2_LuaValue_call__Ljava_lang_String_2_Lorg_luaj_vm2_LuaValue_2,  //103
    func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //104
    func_org_luaj_vm2_lib_LibFunction_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //105
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_MathLib_00024random[] = {
    {229, 3, arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_lib_MathLib_00024random}, //0
    {18, 9, arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_lib_LibFunction}, //1
    {19, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_LuaFunction}, //2
    {1, 210, arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_LuaValue}, //3
    {2, 63, arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_org_luaj_vm2_Varargs}, //4
    {5, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024random_from_java_lang_Object}, //5
};
...
// stack: 3
// args: 0
void func_org_luaj_vm2_lib_MathLib_00024random__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1362, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 233 , L913746983 , bytecode index = 
    ...
    ; 
    //  line no 234 , L1660451908 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // new java/util/Random
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 240);
    // dup
    ...
    // invokespecial java/util/Random.<init>()V
    {
        ...
        func_java_util_Random__init____V(runtime);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    // putfield org/luaj/vm2/lib/MathLib$random random Ljava/util/Random;
    sp -= 2;
    ((struct org_luaj_vm2_lib_MathLib_00024random*)rstack[sp + 0].obj)->random_47 = rstack[sp + 1].obj;
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_lib_MathLib_00024random__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_MathLib_00024random__init____V(runtime, ins);
}
...
// stack: 2
// args: 0
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_MathLib_00024random_call___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1363, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 236 , L1381857776 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 236;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/MathLib$random random Ljava/util/Random;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_MathLib_00024random*)rstack[sp - 1].obj)->random_47;
    sp += 0;
    // invokevirtual java/util/Random.nextDouble()D
    {
        ...
        f64 (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 240, 6);
    ...
    // invokestatic org/luaj/vm2/lib/MathLib$random.valueOf(D)Lorg/luaj/vm2/LuaNumber;
    {
        sp -= 3;
...
void bridge_org_luaj_vm2_lib_MathLib_00024random_call___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_MathLib_00024random_call___Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1364, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 239 , L1886567481 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 239;
    ...
    ; 
    //  line no 240 , L361571676 , bytecode index = 
    stack[sp++].i = local[2].i;
    // iconst_1
    stack[sp++].i = 1;
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L749100260;
    // iconst_1
    stack[sp++].i = 1;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 2474);
    // invokestatic org/luaj/vm2/lib/MathLib$random.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
    ...
    --sp; //pop
    L749100260:
    //  line no 241 , L749100260 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/MathLib$random random Ljava/util/Random;
    ...
    // invokevirtual java/util/Random.nextInt(I)I
    {
        ...
        s32 (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 240, 3);
    ...
    --sp;
    // invokestatic org/luaj/vm2/lib/MathLib$random.valueOf(I)Lorg/luaj/vm2/LuaInteger;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 4
// args: 2
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1365, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 244 , L1460126155 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 244;
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaValue.checkint()I
    ...
    ; 
    //  line no 245 , L727497138 , bytecode index = 
    ...
    ; 
    //  line no 246 , L889422145 , bytecode index = 
    stack[sp++].i = local[4].i;
    stack[sp++].i = local[3].i;
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L248483913;
    // iconst_2
    stack[sp++].i = 2;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 2474);
    ...
    --sp; //pop
    L248483913:
    //  line no 247 , L248483913 , bytecode index = 
    stack[sp++].i = local[3].i;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/MathLib$random random Ljava/util/Random;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_MathLib_00024random*)rstack[sp - 1].obj)->random_47;
...
void bridge_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_MathLib_00024random_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins, para[0].obj);
}
