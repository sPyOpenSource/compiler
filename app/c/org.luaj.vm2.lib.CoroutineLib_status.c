// CLASS: org/luaj/vm2/lib/CoroutineLib$status extends org/luaj/vm2/lib/LibFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_CoroutineLib_00024status_static {};



__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_lib_CoroutineLib_00024status[] = {
    func_org_luaj_vm2_lib_CoroutineLib_00024status_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024status_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024status_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_CoroutineLib_00024status[] = {
    {25, 1, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_lib_CoroutineLib_00024status}, //0
    {18, 9, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_lib_LibFunction}, //1
    {19, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_LuaFunction}, //2
    {1, 210, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_LuaValue}, //3
    {2, 63, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_org_luaj_vm2_Varargs}, //4
    {5, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024status_from_java_lang_Object}, //5
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_CoroutineLib_00024status__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 109 , L167185492 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024status__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_CoroutineLib_00024status__init____V(runtime, ins);
}
...
// stack: 1
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_CoroutineLib_00024status_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 111 , L1937348256 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 111;
    ...
    ; 
    //  line no 112 , L1641808846 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // invokevirtual org/luaj/vm2/LuaThread.getStatus()Ljava/lang/String;
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct java_lang_String* (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 24, 6);
        rstack[sp].obj = __func_p(runtime);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    // invokestatic org/luaj/vm2/lib/CoroutineLib$status.valueOf(Ljava/lang/String;)Lorg/luaj/vm2/LuaString;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024status_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_CoroutineLib_00024status_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
