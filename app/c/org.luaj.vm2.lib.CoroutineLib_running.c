// CLASS: org/luaj/vm2/lib/CoroutineLib$running extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_CoroutineLib_00024running_static {};



__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_lib_CoroutineLib_00024running[] = {
    func_org_luaj_vm2_lib_CoroutineLib_00024running_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024running_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024running_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_CoroutineLib_00024running_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_CoroutineLib_00024running[] = {
    {323, 1, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_lib_CoroutineLib_00024running}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_00024running_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_CoroutineLib_00024running__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_CoroutineLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2801, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 102 , L598569407 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 102;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/CoroutineLib$running this$0 Lorg/luaj/vm2/lib/CoroutineLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_CoroutineLib_00024running*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024running__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_CoroutineLib_00024running__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_CoroutineLib_00024running_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2802, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 104 , L1654300454 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 104;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/CoroutineLib$running this$0 Lorg/luaj/vm2/lib/CoroutineLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_CoroutineLib_00024running*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    // getfield org/luaj/vm2/lib/CoroutineLib globals Lorg/luaj/vm2/Globals;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_CoroutineLib*)rstack[sp - 1].obj)->globals_48;
    sp += 0;
    ...
    ; 
    //  line no 105 , L192486017 , bytecode index = 
    ...
    // invokestatic org/luaj/vm2/lib/CoroutineLib$running.valueOf(Z)Lorg/luaj/vm2/LuaBoolean;
    {
        sp -= 2;
    ...
    // invokestatic org/luaj/vm2/lib/CoroutineLib$running.varargsOf(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 3;
...
void bridge_org_luaj_vm2_lib_CoroutineLib_00024running_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_CoroutineLib_00024running_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
