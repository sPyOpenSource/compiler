// CLASS: org/luaj/vm2/LuaUserdata extends org/luaj/vm2/LuaValue
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_LuaUserdata_static {};



__refer arr_vmtable_org_luaj_vm2_LuaUserdata_from_org_luaj_vm2_LuaUserdata[] = {
    func_org_luaj_vm2_LuaUserdata_tojstring___Ljava_lang_String_2,  //0
    func_org_luaj_vm2_LuaUserdata_type___I,  //1
    func_org_luaj_vm2_LuaUserdata_typename___Ljava_lang_String_2,  //2
    func_org_luaj_vm2_LuaUserdata_hashCode___I,  //3
    func_org_luaj_vm2_LuaUserdata_userdata___Ljava_lang_Object_2,  //4
    func_org_luaj_vm2_LuaUserdata_isuserdata___Z,  //5
    func_org_luaj_vm2_LuaUserdata_isuserdata__Ljava_lang_Class_2_Z,  //6
    func_org_luaj_vm2_LuaUserdata_touserdata___Ljava_lang_Object_2,  //7
    func_org_luaj_vm2_LuaUserdata_touserdata__Ljava_lang_Class_2_Ljava_lang_Object_2,  //8
    func_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Object_2_Ljava_lang_Object_2,  //9
    func_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Class_2Ljava_lang_Object_2_Ljava_lang_Object_2,  //10
    func_org_luaj_vm2_LuaUserdata_getmetatable___Lorg_luaj_vm2_LuaValue_2,  //11
    func_org_luaj_vm2_LuaUserdata_setmetatable__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //12
    func_org_luaj_vm2_LuaUserdata_checkuserdata___Ljava_lang_Object_2,  //13
    func_org_luaj_vm2_LuaUserdata_checkuserdata__Ljava_lang_Class_2_Ljava_lang_Object_2,  //14
    func_org_luaj_vm2_LuaUserdata_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //15
    func_org_luaj_vm2_LuaUserdata_set__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_V,  //16
    func_org_luaj_vm2_LuaUserdata_equals__Ljava_lang_Object_2_Z,  //17
    func_org_luaj_vm2_LuaUserdata_eq__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //18
    func_org_luaj_vm2_LuaUserdata_eq_1b__Lorg_luaj_vm2_LuaValue_2_Z,  //19
    func_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaValue_2_Z,  //20
    func_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaUserdata_2_Z,  //21
    func_org_luaj_vm2_LuaUserdata_eqmt__Lorg_luaj_vm2_LuaValue_2_Z  //22
};
__refer arr_vmtable_org_luaj_vm2_LuaUserdata_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaUserdata_type___I,  //0
    func_org_luaj_vm2_LuaUserdata_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_LuaUserdata_isuserdata___Z,  //13
    func_org_luaj_vm2_LuaUserdata_isuserdata__Ljava_lang_Class_2_Z,  //14
    ...
    func_org_luaj_vm2_LuaUserdata_tojstring___Ljava_lang_String_2,  //23
    func_org_luaj_vm2_LuaUserdata_touserdata___Ljava_lang_Object_2,  //24
    func_org_luaj_vm2_LuaUserdata_touserdata__Ljava_lang_Class_2_Ljava_lang_Object_2,  //25
    ...
    func_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Object_2_Ljava_lang_Object_2,  //41
    func_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Class_2Ljava_lang_Object_2_Ljava_lang_Object_2,  //42
    ...
    func_org_luaj_vm2_LuaUserdata_checkuserdata___Ljava_lang_Object_2,  //58
    func_org_luaj_vm2_LuaUserdata_checkuserdata__Ljava_lang_Class_2_Ljava_lang_Object_2,  //59
    ...
    func_org_luaj_vm2_LuaUserdata_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //71
    ...
    func_org_luaj_vm2_LuaUserdata_set__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_V,  //74
    ...
    func_org_luaj_vm2_LuaUserdata_getmetatable___Lorg_luaj_vm2_LuaValue_2,  //99
    func_org_luaj_vm2_LuaUserdata_setmetatable__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //100
    ...
    func_org_luaj_vm2_LuaUserdata_equals__Ljava_lang_Object_2_Z,  //130
    func_org_luaj_vm2_LuaUserdata_eq__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //131
    func_org_luaj_vm2_LuaUserdata_eq_1b__Lorg_luaj_vm2_LuaValue_2_Z,  //132
    ...
    func_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaValue_2_Z,  //135
    func_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaUserdata_2_Z,  //136
...
__refer arr_vmtable_org_luaj_vm2_LuaUserdata_from_org_luaj_vm2_Varargs[] = {
    ...
    func_org_luaj_vm2_LuaUserdata_tojstring___Ljava_lang_String_2,  //58
...
__refer arr_vmtable_org_luaj_vm2_LuaUserdata_from_java_lang_Object[] = {
    func_org_luaj_vm2_LuaValue_toString___Ljava_lang_String_2,  //0
    func_java_lang_Object_wait___V,  //1
    func_java_lang_Object_finalize___V,  //2
    func_org_luaj_vm2_LuaUserdata_equals__Ljava_lang_Object_2_Z,  //3
    func_java_lang_Object_clone___Ljava_lang_Object_2,  //4
    func_java_lang_Object_getClass___Ljava_lang_Class_2,  //5
    func_java_lang_Object_wait__J_V,  //6
    func_java_lang_Object_notify___V,  //7
    func_java_lang_Object_notifyAll___V,  //8
    func_org_luaj_vm2_LuaUserdata_hashCode___I  //9
};
VMTable vmtable_org_luaj_vm2_LuaUserdata[] = {
    {49, 23, arr_vmtable_org_luaj_vm2_LuaUserdata_from_org_luaj_vm2_LuaUserdata}, //0
    {1, 210, arr_vmtable_org_luaj_vm2_LuaUserdata_from_org_luaj_vm2_LuaValue}, //1
    {2, 63, arr_vmtable_org_luaj_vm2_LuaUserdata_from_org_luaj_vm2_Varargs}, //2
    {5, 10, arr_vmtable_org_luaj_vm2_LuaUserdata_from_java_lang_Object}, //3
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_LuaUserdata__init___Ljava_lang_Object_2_V(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1630, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 30 , L841483227 , bytecode index = 
    ...
    ; 
    //  line no 31 , L1455064947 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    sp -= 2;
    ((struct org_luaj_vm2_LuaUserdata*)rstack[sp + 0].obj)->m_1instance_44 = rstack[sp + 1].obj;
    ; 
    //  line no 32 , L1827371870 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_LuaUserdata__init___Ljava_lang_Object_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_LuaUserdata__init___Ljava_lang_Object_2_V(runtime, ins);
}
...
// stack: 2
// args: 2
void func_org_luaj_vm2_LuaUserdata__init___Ljava_lang_Object_2Lorg_luaj_vm2_LuaValue_2_V(JThreadRuntime *runtime, struct java_lang_Object* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1631, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 34 , L253027775 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 34;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial org/luaj/vm2/LuaValue.<init>()V
    ...
    ; 
    //  line no 35 , L219638321 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    sp -= 2;
    ((struct org_luaj_vm2_LuaUserdata*)rstack[sp + 0].obj)->m_1instance_44 = rstack[sp + 1].obj;
    ; 
    //  line no 36 , L982634822 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[2].obj;
    // putfield org/luaj/vm2/LuaUserdata m_metatable Lorg/luaj/vm2/LuaValue;
    sp -= 2;
    ((struct org_luaj_vm2_LuaUserdata*)rstack[sp + 0].obj)->m_1metatable_45 = rstack[sp + 1].obj;
    ; 
    //  line no 37 , L1199833406 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_LuaUserdata__init___Ljava_lang_Object_2Lorg_luaj_vm2_LuaValue_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_LuaUserdata__init___Ljava_lang_Object_2Lorg_luaj_vm2_LuaValue_2_V(runtime, ins, para[0].obj);
}
...
// stack: 1
// args: 0
struct java_lang_String* func_org_luaj_vm2_LuaUserdata_tojstring___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1632, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 40 , L1499825229 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 40;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
...
void bridge_org_luaj_vm2_LuaUserdata_tojstring___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_tojstring___Ljava_lang_String_2(runtime, ins);
}
...
// stack: 1
// args: 0
s32 func_org_luaj_vm2_LuaUserdata_type___I(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1633, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 44 , L178259104 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 44;
    //  bipush 7
    stack[sp++].i = 7;
...
void bridge_org_luaj_vm2_LuaUserdata_type___I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaUserdata_type___I(runtime, ins);
}
...
// stack: 1
// args: 0
struct java_lang_String* func_org_luaj_vm2_LuaUserdata_typename___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1634, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 48 , L959055079 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 48;
    //  ldc 
...
void bridge_org_luaj_vm2_LuaUserdata_typename___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_typename___Ljava_lang_String_2(runtime, ins);
}
...
// stack: 1
// args: 0
s32 func_org_luaj_vm2_LuaUserdata_hashCode___I(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1635, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 52 , L234857227 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 52;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
...
void bridge_org_luaj_vm2_LuaUserdata_hashCode___I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaUserdata_hashCode___I(runtime, ins);
}
...
// stack: 1
// args: 0
struct java_lang_Object* func_org_luaj_vm2_LuaUserdata_userdata___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 56 , L1832657711 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
...
void bridge_org_luaj_vm2_LuaUserdata_userdata___Ljava_lang_Object_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_userdata___Ljava_lang_Object_2(runtime, ins);
}
...
// stack: 1
// args: 0
s8 func_org_luaj_vm2_LuaUserdata_isuserdata___Z(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1637, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 59 , L466577384 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 59;
    // iconst_1
    stack[sp++].i = 1;
...
void bridge_org_luaj_vm2_LuaUserdata_isuserdata___Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaUserdata_isuserdata___Z(runtime, ins);
}
...
// stack: 2
// args: 1
s8 func_org_luaj_vm2_LuaUserdata_isuserdata__Ljava_lang_Class_2_Z(JThreadRuntime *runtime, struct java_lang_Class* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1638, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 60 , L1399398408 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 60;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_LuaUserdata_isuserdata__Ljava_lang_Class_2_Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaUserdata_isuserdata__Ljava_lang_Class_2_Z(runtime, ins);
}
...
// stack: 1
// args: 0
struct java_lang_Object* func_org_luaj_vm2_LuaUserdata_touserdata___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 61 , L465233746 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
...
void bridge_org_luaj_vm2_LuaUserdata_touserdata___Ljava_lang_Object_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_touserdata___Ljava_lang_Object_2(runtime, ins);
}
...
// stack: 2
// args: 1
struct java_lang_Object* func_org_luaj_vm2_LuaUserdata_touserdata__Ljava_lang_Class_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_Class* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1640, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 62 , L1559788797 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 62;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    if(stack[--sp].i  == 0) goto L1980194149;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
...
void bridge_org_luaj_vm2_LuaUserdata_touserdata__Ljava_lang_Class_2_Ljava_lang_Object_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_touserdata__Ljava_lang_Class_2_Ljava_lang_Object_2(runtime, ins);
}
...
// stack: 1
// args: 1
struct java_lang_Object* func_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Object_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 63 , L943165647 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
...
void bridge_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Object_2_Ljava_lang_Object_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Object_2_Ljava_lang_Object_2(runtime, ins);
}
...
// stack: 2
// args: 2
struct java_lang_Object* func_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Class_2Ljava_lang_Object_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_Class* p0, struct java_lang_Object* p1){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1642, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 65 , L320850799 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 65;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    if(stack[--sp].i  != 0) goto L214768579;
    ; 
    //  line no 66 , L142103421 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    // invokevirtual org/luaj/vm2/LuaUserdata.typerror(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
    ...
    --sp; //pop
    L214768579:
    //  line no 67 , L214768579 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
...
void bridge_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Class_2Ljava_lang_Object_2_Ljava_lang_Object_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_optuserdata__Ljava_lang_Class_2Ljava_lang_Object_2_Ljava_lang_Object_2(runtime, ins, para[0].obj);
}
...
// stack: 1
// args: 0
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_LuaUserdata_getmetatable___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 71 , L704387627 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_metatable Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1metatable_45;
    sp += 0;
    return rstack[sp - 1].obj;
    ; 
}

void bridge_org_luaj_vm2_LuaUserdata_getmetatable___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_getmetatable___Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_LuaUserdata_setmetatable__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1644, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 75 , L128077491 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 75;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ((struct org_luaj_vm2_LuaUserdata*)rstack[sp + 0].obj)->m_1metatable_45 = rstack[sp + 1].obj;
    ; 
    //  line no 76 , L1815592231 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    ; 
...
void bridge_org_luaj_vm2_LuaUserdata_setmetatable__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_setmetatable__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 1
// args: 0
struct java_lang_Object* func_org_luaj_vm2_LuaUserdata_checkuserdata___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 80 , L808653065 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
...
void bridge_org_luaj_vm2_LuaUserdata_checkuserdata___Ljava_lang_Object_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_checkuserdata___Ljava_lang_Object_2(runtime, ins);
}
...
// stack: 2
// args: 1
struct java_lang_Object* func_org_luaj_vm2_LuaUserdata_checkuserdata__Ljava_lang_Class_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_Class* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1646, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 84 , L1962826086 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 84;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    if(stack[--sp].i  == 0) goto L1340634558;
    ; 
    //  line no 85 , L1736150547 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
    ...
    return rstack[sp - 1].obj;
    L1340634558:
    //  line no 86 , L1340634558 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual java/lang/Class.getName()Ljava/lang/String;
    {
...
void bridge_org_luaj_vm2_LuaUserdata_checkuserdata__Ljava_lang_Class_2_Ljava_lang_Object_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_checkuserdata__Ljava_lang_Class_2_Ljava_lang_Object_2(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_LuaUserdata_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1647, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 90 , L1277678493 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 90;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_metatable Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1metatable_45;
    sp += 0;
    if(rstack[--sp].obj  == NULL) goto L1089341986;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // invokestatic org/luaj/vm2/LuaUserdata.gettable(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/LuaValue;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
    ...
    goto L2078154554;
    L1089341986:
    // getstatic org/luaj/vm2/LuaUserdata NIL Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_LuaUserdata_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 3
// args: 2
void func_org_luaj_vm2_LuaUserdata_set__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1648, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 94 , L1742448147 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 94;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_metatable Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1metatable_45;
    sp += 0;
    if(rstack[--sp].obj  == NULL) goto L1465126864;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[2].obj;
    // invokestatic org/luaj/vm2/LuaUserdata.settable(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/LuaValue;)Z
    {
        sp -= 4;
    ...
    if(stack[--sp].i  != 0) goto L1559817679;
    L1465126864:
    //  line no 95 , L1465126864 , bytecode index = 
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 2955);
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 2956);
    // invokevirtual java/lang/StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
    ...
    // invokestatic org/luaj/vm2/LuaUserdata.error(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
    ...
    --sp; //pop
    L1559817679:
    //  line no 96 , L1559817679 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_LuaUserdata_set__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_LuaUserdata_set__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_V(runtime, ins, para[0].obj);
}
...
// stack: 2
// args: 1
s8 func_org_luaj_vm2_LuaUserdata_equals__Ljava_lang_Object_2_Z(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1649, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 99 , L1654589039 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 99;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    sp -= 2;
    if(rstack[sp + 0].obj  != rstack[sp + 1].obj) goto L356691811;
    ; 
    //  line no 100 , L248495761 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    method_exit(runtime);
    return stack[sp - 1].i;
    L356691811:
    //  line no 101 , L356691811 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // instanceof org/luaj/vm2/LuaUserdata
    stack[sp - 1].i = instance_of_classname_index(rstack[sp - 1].obj, 564);
    if(stack[--sp].i  != 0) goto L552416003;
    ; 
    //  line no 102 , L987489551 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    method_exit(runtime);
    return stack[sp - 1].i;
    L552416003:
    //  line no 103 , L552416003 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // checkcast org/luaj/vm2/LuaUserdata
    {
        s32 cast_r = checkcast(rstack[sp - 1].obj, 564);
        if(!cast_r){
    ...
    ; 
    //  line no 104 , L979532928 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
...
void bridge_org_luaj_vm2_LuaUserdata_equals__Ljava_lang_Object_2_Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaUserdata_equals__Ljava_lang_Object_2_Z(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_LuaUserdata_eq__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1650, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 108 , L9843062 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 108;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaUserdata.eq_b(Lorg/luaj/vm2/LuaValue;)Z
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        s8 (*__func_p) (JThreadRuntime *,struct org_luaj_vm2_LuaValue*) = find_method(__ins->vm_table, 49, 19);
        stack[sp].i = __func_p(runtime, rstack[sp + 0].obj);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    if(stack[--sp].i  == 0) goto L1694519286;
    // getstatic org/luaj/vm2/LuaUserdata TRUE Lorg/luaj/vm2/LuaBoolean;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.TRUE_14;
    sp += 1;
    goto L1286580650;
    L1694519286:
    // getstatic org/luaj/vm2/LuaUserdata FALSE Lorg/luaj/vm2/LuaBoolean;
...
void bridge_org_luaj_vm2_LuaUserdata_eq__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaUserdata_eq__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 4
// args: 1
s8 func_org_luaj_vm2_LuaUserdata_eq_1b__Lorg_luaj_vm2_LuaValue_2_Z(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1651, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 110 , L1728057672 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 110;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // invokevirtual org/luaj/vm2/LuaValue.raweq(Lorg/luaj/vm2/LuaUserdata;)Z
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        s8 (*__func_p) (JThreadRuntime *,struct org_luaj_vm2_LuaUserdata*) = find_method(__ins->vm_table, 1, 136);
        stack[sp].i = __func_p(runtime, rstack[sp + 0].obj);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    if(stack[--sp].i  == 0) goto L10001825;
    // iconst_1
    stack[sp++].i = 1;
    method_exit(runtime);
    return stack[sp - 1].i;
    L10001825:
    //  line no 111 , L10001825 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_metatable Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1metatable_45;
    sp += 0;
    if(rstack[--sp].obj  == NULL) goto L835426017;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  != 0) goto L65982709;
    L835426017:
    // iconst_0
    stack[sp++].i = 0;
    method_exit(runtime);
    return stack[sp - 1].i;
    L65982709:
    //  line no 112 , L65982709 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    rlocal[2].obj = rstack[--sp].obj;
    ; 
    //  line no 113 , L1677921169 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    if(rstack[--sp].obj  == NULL) goto L540206885;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_metatable Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1metatable_45;
    ...
    if(stack[--sp].i  == 0) goto L540206885;
    // iconst_1
    stack[sp++].i = 1;
    goto L1294139740;
    L540206885:
...
void bridge_org_luaj_vm2_LuaUserdata_eq_1b__Lorg_luaj_vm2_LuaValue_2_Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaUserdata_eq_1b__Lorg_luaj_vm2_LuaValue_2_Z(runtime, ins);
}
...
// stack: 2
// args: 1
s8 func_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaValue_2_Z(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1652, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 117 , L1142735456 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 117;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaValue_2_Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaValue_2_Z(runtime, ins);
}
...
// stack: 2
// args: 1
s8 func_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaUserdata_2_Z(JThreadRuntime *runtime, struct org_luaj_vm2_LuaUserdata* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1653, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 119 , L652007616 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 119;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    sp -= 2;
    if(rstack[sp + 0].obj  == rstack[sp + 1].obj) goto L1726515679;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_metatable Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1metatable_45;
    sp += 0;
    ...
    sp += 0;
    sp -= 2;
    if(rstack[sp + 0].obj  != rstack[sp + 1].obj) goto L1145391264;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_instance Ljava/lang/Object;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1instance_44;
    sp += 0;
    ...
    if(stack[--sp].i  == 0) goto L1145391264;
    L1726515679:
    // iconst_1
    stack[sp++].i = 1;
    goto L929482343;
...
void bridge_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaUserdata_2_Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaUserdata_raweq__Lorg_luaj_vm2_LuaUserdata_2_Z(runtime, ins);
}
...
// stack: 4
// args: 1
s8 func_org_luaj_vm2_LuaUserdata_eqmt__Lorg_luaj_vm2_LuaValue_2_Z(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1654, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 124 , L1438178266 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 124;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_metatable Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1metatable_45;
    sp += 0;
    if(rstack[--sp].obj  == NULL) goto L995531141;
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaValue.isuserdata()Z
    {
        sp -= 0;
    ...
    if(stack[--sp].i  == 0) goto L995531141;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/LuaUserdata m_metatable Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaUserdata*)rstack[sp - 1].obj)->m_1metatable_45;
...
void bridge_org_luaj_vm2_LuaUserdata_eqmt__Lorg_luaj_vm2_LuaValue_2_Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaUserdata_eqmt__Lorg_luaj_vm2_LuaValue_2_Z(runtime, ins);
}
