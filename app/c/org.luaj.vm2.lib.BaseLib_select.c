// CLASS: org/luaj/vm2/lib/BaseLib$select extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024select_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_lib_BaseLib_00024select[] = {
    func_org_luaj_vm2_lib_BaseLib_00024select_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024select_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024select_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024select_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024select[] = {
    {160, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_lib_BaseLib_00024select}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024select_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_BaseLib_00024select__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 832, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 308 , L1076984738 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_BaseLib_00024select__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024select__init____V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_BaseLib_00024select_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 833, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 310 , L1171434979 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 310;
    ...
    ; 
    //  line no 311 , L1920907467 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1761);
    // invokestatic org/luaj/vm2/lib/BaseLib$select.valueOf(Ljava/lang/String;)Lorg/luaj/vm2/LuaString;
    {
        sp -= 2;
    ...
    if(stack[--sp].i  == 0) goto L970535245;
    ; 
    //  line no 312 , L194481424 , bytecode index = 
    stack[sp++].i = local[2].i;
    // invokestatic org/luaj/vm2/lib/BaseLib$select.valueOf(I)Lorg/luaj/vm2/LuaInteger;
    {
        sp -= 2;
    ...
    L970535245:
    //  line no 313 , L970535245 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    ...
    ; 
    //  line no 314 , L1534755892 , bytecode index = 
    stack[sp++].i = local[3].i;
    if(stack[--sp].i  == 0) goto L1548081008;
    stack[sp++].i = local[3].i;
    stack[sp++].i = local[2].i;
    stack[sp - 1].i = -stack[sp - 1].i; 
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L753321708;
    L1548081008:
    //  line no 315 , L1548081008 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1762);
    // invokestatic org/luaj/vm2/lib/BaseLib$select.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
    ...
    --sp; //pop
    L753321708:
    //  line no 316 , L753321708 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[3].i;
    if(stack[--sp].i  >= 0) goto L464400749;
    stack[sp++].i = local[2].i;
    stack[sp++].i = local[3].i;
    stack[sp - 2].i = stack[sp - 2].i + stack[sp - 1].i; 
    --sp;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024select_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024select_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
