...
// generation
// globals
//struct org_luaj_vm2_WeakTable_00024WeakValue_static {};



__refer arr_vmtable_org_luaj_vm2_WeakTable_00024WeakValue_from_org_luaj_vm2_WeakTable_00024WeakValue[] = {
    ...
    func_org_luaj_vm2_WeakTable_00024WeakValue_strongvalue___Lorg_luaj_vm2_LuaValue_2,  //3
    func_org_luaj_vm2_WeakTable_00024WeakValue_raweq__Lorg_luaj_vm2_LuaValue_2_Z  //4
};
__refer arr_vmtable_org_luaj_vm2_WeakTable_00024WeakValue_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_WeakTable_00024WeakValue_type___I,  //0
    func_org_luaj_vm2_WeakTable_00024WeakValue_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_WeakTable_00024WeakValue_strongvalue___Lorg_luaj_vm2_LuaValue_2,  //204
...
__refer arr_vmtable_org_luaj_vm2_WeakTable_00024WeakValue_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_WeakTable_00024WeakValue_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_WeakTable_00024WeakValue[] = {
    {36, 5, arr_vmtable_org_luaj_vm2_WeakTable_00024WeakValue_from_org_luaj_vm2_WeakTable_00024WeakValue}, //0
    {1, 210, arr_vmtable_org_luaj_vm2_WeakTable_00024WeakValue_from_org_luaj_vm2_LuaValue}, //1
    {2, 63, arr_vmtable_org_luaj_vm2_WeakTable_00024WeakValue_from_org_luaj_vm2_Varargs}, //2
    {5, 10, arr_vmtable_org_luaj_vm2_WeakTable_00024WeakValue_from_java_lang_Object}, //3
};
...
// stack: 4
// args: 1
void func_org_luaj_vm2_WeakTable_00024WeakValue__init___Lorg_luaj_vm2_LuaValue_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2186, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 342 , L803149788 , bytecode index = 
    ...
    ; 
    //  line no 343 , L1852655488 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    // putfield org/luaj/vm2/WeakTable$WeakValue ref Ljava/lang/ref/WeakReference;
    sp -= 2;
    ((struct org_luaj_vm2_WeakTable_00024WeakValue*)rstack[sp + 0].obj)->ref_44 = rstack[sp + 1].obj;
    ; 
    //  line no 344 , L1695213452 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_WeakTable_00024WeakValue__init___Lorg_luaj_vm2_LuaValue_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_WeakTable_00024WeakValue__init___Lorg_luaj_vm2_LuaValue_2_V(runtime, ins);
}
...
// stack: 3
// args: 0
s32 func_org_luaj_vm2_WeakTable_00024WeakValue_type___I(JThreadRuntime *runtime){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2187, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 347 , L2042971662 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 347;
    rstack[sp++].obj = rlocal[0].obj;
    //  ldc 
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3879);
    // invokevirtual org/luaj/vm2/WeakTable$WeakValue.illegal(Ljava/lang/String;Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *,struct java_lang_String*,struct java_lang_String*) = find_method(__ins->vm_table, 1, 65);
    ...
    --sp; //pop
    ; 
    //  line no 348 , L2106609649 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    method_exit(runtime);
    return stack[sp - 1].i;
...
void bridge_org_luaj_vm2_WeakTable_00024WeakValue_type___I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_WeakTable_00024WeakValue_type___I(runtime, ins);
}
...
// stack: 3
// args: 0
struct java_lang_String* func_org_luaj_vm2_WeakTable_00024WeakValue_typename___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2188, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 352 , L2147002844 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 352;
    rstack[sp++].obj = rlocal[0].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 321);
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3879);
    // invokevirtual org/luaj/vm2/WeakTable$WeakValue.illegal(Ljava/lang/String;Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
    ...
    --sp; //pop
    ; 
    //  line no 353 , L752772379 , bytecode index = 
    // aconst null
    rstack[sp++].obj = NULL;
    method_exit(runtime);
...
void bridge_org_luaj_vm2_WeakTable_00024WeakValue_typename___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_WeakTable_00024WeakValue_typename___Ljava_lang_String_2(runtime, ins);
}
...
// stack: 2
// args: 0
struct java_lang_String* func_org_luaj_vm2_WeakTable_00024WeakValue_toString___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2189, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 357 , L1001946422 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 357;
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3880);
    ...
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/WeakTable$WeakValue ref Ljava/lang/ref/WeakReference;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_WeakTable_00024WeakValue*)rstack[sp - 1].obj)->ref_44;
    sp += 0;
...
void bridge_org_luaj_vm2_WeakTable_00024WeakValue_toString___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_WeakTable_00024WeakValue_toString___Ljava_lang_String_2(runtime, ins);
}
...
// stack: 1
// args: 0
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_WeakTable_00024WeakValue_strongvalue___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2190, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 361 , L1579015748 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 361;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/WeakTable$WeakValue ref Ljava/lang/ref/WeakReference;
    ...
    ; 
    //  line no 362 , L2134357721 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
...
void bridge_org_luaj_vm2_WeakTable_00024WeakValue_strongvalue___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_WeakTable_00024WeakValue_strongvalue___Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 2
// args: 1
s8 func_org_luaj_vm2_WeakTable_00024WeakValue_raweq__Lorg_luaj_vm2_LuaValue_2_Z(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2191, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 366 , L580979398 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 366;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/WeakTable$WeakValue ref Ljava/lang/ref/WeakReference;
    ...
    ; 
    //  line no 367 , L318644008 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    if(rstack[--sp].obj  == NULL) goto L1346237136;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[2].obj;
    // checkcast org/luaj/vm2/LuaValue
    {
    ...
    // invokevirtual org/luaj/vm2/LuaValue.raweq(Lorg/luaj/vm2/LuaValue;)Z
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        s8 (*__func_p) (JThreadRuntime *,struct org_luaj_vm2_LuaValue*) = find_method(__ins->vm_table, 1, 135);
    ...
    if(stack[--sp].i  == 0) goto L1346237136;
    // iconst_1
    stack[sp++].i = 1;
    goto L654003462;
    L1346237136:
...
void bridge_org_luaj_vm2_WeakTable_00024WeakValue_raweq__Lorg_luaj_vm2_LuaValue_2_Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_WeakTable_00024WeakValue_raweq__Lorg_luaj_vm2_LuaValue_2_Z(runtime, ins);
}
