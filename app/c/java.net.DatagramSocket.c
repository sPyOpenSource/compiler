...
void func_java_net_DatagramSocket_finalize___V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 29 , L722951168 , bytecode index = 
...
void func_java_net_DatagramSocket_close___V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 33 , L451460284 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 33;
    method_exit(runtime);
    return;
...
void func_java_net_DatagramSocket_receive__Ljava_net_DatagramPacket_2_V(JThreadRuntime *runtime, struct java_net_DatagramPacket* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 36 , L2101153819 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 36;
    ...
    ; 
    //  line no 37 , L51152513 , bytecode index = 
    ...
    ; 
    //  line no 38 , L1558103808 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    sp -= 2;
    if(stack[sp + 0].i  == stack[sp + 1].i) goto L1828873985;
    ; 
    //  line no 39 , L2024415090 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 40 , L527804008 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    if(rstack[--sp].obj  != NULL) goto L892965953;
    ; 
    //  line no 41 , L1266534280 , bytecode index = 
    ...
    // athrow
    //     L1266534280 in labeltable is :L1266534280
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 41;
    ...
    L892965953:
    //  line no 43 , L892965953 , bytecode index = 
    goto L1661210650;
    L1828873985:
    //  line no 44 , L1828873985 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/net/DatagramSocket receiver Ljx/net/UDPReceiver;
    rstack[sp - 1].obj = ((struct java_net_DatagramSocket*)rstack[sp - 1].obj)->receiver_3;
    sp += 0;
    ...
    rlocal[4].obj = rstack[--sp].obj;
    L1661210650:
    //  line no 46 , L1661210650 , bytecode index = 
    ...
    rlocal[4].obj = rstack[--sp].obj;
    ; 
    //  line no 47 , L1366342900 , bytecode index = 
    ...
    ; 
    //  line no 48 , L672313607 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 67 , L234250762 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_net_DatagramSocket_send__Ljava_net_DatagramPacket_2_V(JThreadRuntime *runtime, struct java_net_DatagramPacket* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 71 , L443721024 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 71;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 72 , L668312960 , bytecode index = 
    // getstatic jx/zero/Debug out Ljx/zero/debug/DebugPrintStream;
    rstack[sp].obj =static_var_jx_zero_Debug.out_2;
    sp += 1;
    //  ldc 
    ...
    ; 
    //  line no 76 , L428696898 , bytecode index = 
    // invokestatic jx/net/protocol/udp/UDPFormat.requiresSpace()I
    {
        sp -= 1;
        stack[sp].i = func_jx_net_protocol_udp_UDPFormat_requiresSpace___I(runtime, rstack[sp + 0].obj);
    ...
    local[2].i = stack[--sp].i;
    ; 
    //  line no 77 , L1581267786 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/net/DatagramSocket net Ljx/net/NetInit;
    rstack[sp - 1].obj = ((struct java_net_DatagramSocket*)rstack[sp - 1].obj)->net_2;
    sp += 0;
    ...
    rlocal[3].obj = rstack[--sp].obj;
    ; 
    //  line no 79 , L1360518503 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // getfield java/net/DatagramPacket buff [B
    rstack[sp - 1].obj = ((struct java_net_DatagramPacket*)rstack[sp - 1].obj)->buff_0;
    ...
    ; 
    //  line no 80 , L1541708640 , bytecode index = 
    // getstatic jx/zero/Debug out Ljx/zero/debug/DebugPrintStream;
    rstack[sp].obj =static_var_jx_zero_Debug.out_2;
    sp += 1;
    //  ldc 
    ...
    ; 
    //  line no 81 , L691098155 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    rlocal[3].obj = rstack[--sp].obj;
    ; 
    //  line no 82 , L1987360300 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
s32 func_java_net_DatagramSocket_getLocalPort___I(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 85 , L1713833639 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/net/DatagramSocket port I
    stack[sp - 1].i = ((struct java_net_DatagramSocket*)rstack[sp - 1].obj)->port_0;
    sp += 0;
...
void func_java_net_DatagramSocket__init___I_V(JThreadRuntime *runtime, s32 p0){
    ...
    local[0].i = p0;
    ; 
    //  line no 88 , L380812044 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 88;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    // it's a empty method
    ; 
    //  line no 19 , L846918683 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // iconst_0
    stack[sp++].i = 0;
    ...
    ; 
    //  line no 23 , L1823923917 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    //  ldc 
    ...
    ; 
    //  line no 89 , L208684473 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ((struct java_net_DatagramSocket*)rstack[sp + 0].obj)->port_0 = stack[sp + 1].i;
    ; 
    //  line no 90 , L261748192 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 92 , L1789268516 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield java/net/DatagramSocket net Ljx/net/NetInit;
    rstack[sp - 1].obj = ((struct java_net_DatagramSocket*)rstack[sp - 1].obj)->net_2;
    ...
    stack[sp++].i = 0;
    ; 
    //  line no 93 , L817686795 , bytecode index = 
    // invokeinterface jx/net/NetInit.getUDPBuffer(I)Ljx/zero/Memory;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
    ...
    // arrstore __refer  ,  L817686795 bc index = 
    {
        ;
    ...
    ; 
    //  line no 92 , L1047478056 , bytecode index = 
    ...
    ; 
    //  line no 95 , L2115628016 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_net_DatagramSocket__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 98 , L1935122449 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 98;
    rstack[sp++].obj = rlocal[0].obj;
    // iconst_0
    ...
    ; 
    //  line no 99 , L872826668 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_java_net_DatagramSocket_setSoTimeout__I_V(JThreadRuntime *runtime, s32 p0){
    ...
    local[0].i = p0;
    ; 
    //  line no 104 , L110053477 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    stack[sp++].i = local[1].i;
    // putfield java/net/DatagramSocket timeout I
    sp -= 2;
    ((struct java_net_DatagramSocket*)rstack[sp + 0].obj)->timeout_4 = stack[sp + 1].i;
    ; 
    //  line no 105 , L1209411469 , bytecode index = 
    return;
    ; 
}
