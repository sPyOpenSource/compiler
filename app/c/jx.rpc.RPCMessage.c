...
void func_jx_rpc_RPCMessage__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 12 , L2044482328 , bytecode index = 
...
void func_jx_rpc_RPCMessage__init___II_V(JThreadRuntime *runtime, s32 p0, s32 p1){
    ...
    local[1].i = p1;
    ; 
    //  line no 13 , L937744315 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 13;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial java/lang/Object.<init>()V
    ...
    // it's a empty method
    ; 
    //  line no 14 , L1870209957 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 15 , L1957099969 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 16 , L1424698224 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
s32 func_jx_rpc_RPCMessage_getID___I(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 18 , L1667305539 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
