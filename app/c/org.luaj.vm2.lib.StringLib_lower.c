// CLASS: org/luaj/vm2/lib/StringLib$lower extends org/luaj/vm2/lib/OneArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_StringLib_00024lower_static {};



__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_lib_StringLib_00024lower[] = {
    func_org_luaj_vm2_lib_StringLib_00024lower_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_lib_OneArgFunction[] = {
    func_org_luaj_vm2_lib_StringLib_00024lower_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_StringLib_00024lower_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_StringLib_00024lower_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_StringLib_00024lower[] = {
    {377, 1, arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_lib_StringLib_00024lower}, //0
    {99, 5, arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_lib_OneArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_StringLib_00024lower_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_StringLib_00024lower__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3311, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 649 , L697818620 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_StringLib_00024lower__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_StringLib_00024lower__init____V(runtime, ins);
}
...
// stack: 1
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_StringLib_00024lower_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3312, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 651 , L2027371291 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 651;
    ...
    // invokevirtual java/lang/String.toLowerCase()Ljava/lang/String;
    {
        ...
        struct java_lang_String* (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 50, 33);
        rstack[sp].obj = __func_p(runtime);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    // invokestatic org/luaj/vm2/lib/StringLib$lower.valueOf(Ljava/lang/String;)Lorg/luaj/vm2/LuaString;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_StringLib_00024lower_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_StringLib_00024lower_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
