// CLASS: org/luaj/vm2/lib/MathLib$modf extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_MathLib_00024modf_static {};



__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_lib_MathLib_00024modf[] = {
    func_org_luaj_vm2_lib_MathLib_00024modf_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024modf_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024modf_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_MathLib_00024modf_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_MathLib_00024modf[] = {
    {26, 1, arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_lib_MathLib_00024modf}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024modf_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_MathLib_00024modf__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 219 , L750044075 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_MathLib_00024modf__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_MathLib_00024modf__init____V(runtime, ins);
}
...
// stack: 4
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_MathLib_00024modf_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 221 , L310656974 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 221;
    ...
    ; 
    //  line no 223 , L64830413 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // invokevirtual org/luaj/vm2/LuaValue.islong()Z
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        s8 (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 1, 7);
    ...
    if(stack[--sp].i  == 0) goto L159259014;
    rstack[sp++].obj = rlocal[2].obj;
    //  dconst 0
    stack[sp].d = 0;
    sp += 2;
    // invokestatic org/luaj/vm2/lib/MathLib$modf.valueOf(D)Lorg/luaj/vm2/LuaNumber;
    {
        sp -= 3;
    ...
    // invokestatic org/luaj/vm2/lib/MathLib$modf.varargsOf(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 3;
    ...
    L159259014:
    //  line no 224 , L159259014 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    ...
    ; 
    //  line no 226 , L653687670 , bytecode index = 
    ...
    if(stack[--sp].i  <= 0) goto L356473385;
    stack[sp].d = local[3].d;
    sp += 2;
    ...
    {
        sp -= 3;
        stack[sp].d = func_java_lang_Math_ceil__D_D(runtime, rstack[sp + 0].obj, stack[sp + 1].d);
        sp += 2;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 228 , L110992469 , bytecode index = 
    stack[sp].d = local[3].d;
    sp += 2;
    ...
    if(stack[--sp].i  != 0) goto L329611835;
    //  dconst 0
    stack[sp].d = 0;
    sp += 2;
    goto L2091156596;
    ...
    ; 
    //  line no 229 , L863831416 , bytecode index = 
    stack[sp].d = local[5].d;
    sp += 2;
    // invokestatic org/luaj/vm2/lib/MathLib$modf.valueOf(D)Lorg/luaj/vm2/LuaNumber;
    {
...
void bridge_org_luaj_vm2_lib_MathLib_00024modf_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_MathLib_00024modf_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
