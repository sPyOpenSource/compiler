...
void func_java_text_Format__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 65 , L193388045 , bytecode index = 
    ...
    // it's a empty method
    ; 
    //  line no 67 , L136157810 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
struct java_lang_String* func_java_text_Format_format__Ljava_lang_Object_2_Ljava_lang_String_2(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 87 , L292138977 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 87;
    ...
    ; 
    //  line no 88 , L748842359 , bytecode index = 
    ...
    ; 
    //  line no 90 , L1208532123 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    --sp; //pop
    ; 
    //  line no 91 , L1893960929 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
...
struct java_lang_Object* func_java_text_Format_parseObject__Ljava_lang_String_2_Ljava_lang_Object_2(JThreadRuntime *runtime, struct java_lang_String* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 127 , L333392524 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 127;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
...
struct java_lang_Object* func_java_text_Format_clone___Ljava_lang_Object_2(JThreadRuntime *runtime){
    ...
    // try catch :L1926673338 L394785440 L2112233878 (
    L1926673338:
    __frame->bytecodeIndex = 
    //  line no 158 , L1926673338 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 158;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    return rstack[sp - 1].obj;
    L2112233878:
    //  line no 160 , L2112233878 , bytecode index = 
    rlocal[1].obj = rstack[--sp].obj;
    ; 
    //  line no 162 , L372469954 , bytecode index = 
    // aconst null
    rstack[sp++].obj = NULL;
    method_exit(runtime);
    return rstack[sp - 1].obj;
