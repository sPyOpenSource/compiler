// CLASS: org/luaj/vm2/lib/IoLib$File extends org/luaj/vm2/LuaValue
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_IoLib_00024File_static {};



__refer arr_vmtable_org_luaj_vm2_lib_IoLib_00024File_from_org_luaj_vm2_lib_IoLib_00024File[] = {
    func_org_luaj_vm2_lib_IoLib_00024File_write__Lorg_luaj_vm2_LuaString_2_V,  //0
    func_org_luaj_vm2_lib_IoLib_00024File_flush___V,  //1
    func_org_luaj_vm2_lib_IoLib_00024File_isstdfile___Z,  //2
    func_org_luaj_vm2_lib_IoLib_00024File_close___V,  //3
    func_org_luaj_vm2_lib_IoLib_00024File_isclosed___Z,  //4
    func_org_luaj_vm2_lib_IoLib_00024File_seek__Ljava_lang_String_2I_I,  //5
    func_org_luaj_vm2_lib_IoLib_00024File_setvbuf__Ljava_lang_String_2I_V,  //6
    func_org_luaj_vm2_lib_IoLib_00024File_remaining___I,  //7
    func_org_luaj_vm2_lib_IoLib_00024File_peek___I,  //8
    func_org_luaj_vm2_lib_IoLib_00024File_read___I,  //9
    func_org_luaj_vm2_lib_IoLib_00024File_read___3BII_I,  //10
    func_org_luaj_vm2_lib_IoLib_00024File_eof___Z,  //11
    func_org_luaj_vm2_lib_IoLib_00024File_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //12
    func_org_luaj_vm2_lib_IoLib_00024File_type___I,  //13
    func_org_luaj_vm2_lib_IoLib_00024File_typename___Ljava_lang_String_2,  //14
    func_org_luaj_vm2_lib_IoLib_00024File_tojstring___Ljava_lang_String_2,  //15
    func_org_luaj_vm2_lib_IoLib_00024File_finalize___V  //16
};
__refer arr_vmtable_org_luaj_vm2_lib_IoLib_00024File_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_lib_IoLib_00024File_type___I,  //0
    func_org_luaj_vm2_lib_IoLib_00024File_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_IoLib_00024File_tojstring___Ljava_lang_String_2,  //23
    ...
    func_org_luaj_vm2_lib_IoLib_00024File_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //71
...
__refer arr_vmtable_org_luaj_vm2_lib_IoLib_00024File_from_org_luaj_vm2_Varargs[] = {
    ...
    func_org_luaj_vm2_lib_IoLib_00024File_tojstring___Ljava_lang_String_2,  //58
...
__refer arr_vmtable_org_luaj_vm2_lib_IoLib_00024File_from_java_lang_Object[] = {
    func_org_luaj_vm2_LuaValue_toString___Ljava_lang_String_2,  //0
    func_java_lang_Object_wait___V,  //1
    func_org_luaj_vm2_lib_IoLib_00024File_finalize___V,  //2
...
VMTable vmtable_org_luaj_vm2_lib_IoLib_00024File[] = {
    {258, 17, arr_vmtable_org_luaj_vm2_lib_IoLib_00024File_from_org_luaj_vm2_lib_IoLib_00024File}, //0
    {1, 210, arr_vmtable_org_luaj_vm2_lib_IoLib_00024File_from_org_luaj_vm2_LuaValue}, //1
    {2, 63, arr_vmtable_org_luaj_vm2_lib_IoLib_00024File_from_org_luaj_vm2_Varargs}, //2
    {5, 10, arr_vmtable_org_luaj_vm2_lib_IoLib_00024File_from_java_lang_Object}, //3
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_IoLib_00024File__init___Lorg_luaj_vm2_lib_IoLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_IoLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2309, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 80 , L370843722 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 80;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/IoLib$File this$0 Lorg/luaj/vm2/lib/IoLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_IoLib_00024File*)rstack[sp + 0].obj)->this_000240_44 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_IoLib_00024File__init___Lorg_luaj_vm2_lib_IoLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_IoLib_00024File__init___Lorg_luaj_vm2_lib_IoLib_2_V(runtime, ins);
}
...
// stack: 0
// args: 1
void func_org_luaj_vm2_lib_IoLib_00024File_write__Lorg_luaj_vm2_LuaString_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_LuaString* p0){
    ...
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2310, &rstack[0], &rlocal[0], &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_write__Lorg_luaj_vm2_LuaString_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_IoLib_00024File_write__Lorg_luaj_vm2_LuaString_2_V(runtime, ins);
}
...
// stack: 0
// args: 0
void func_org_luaj_vm2_lib_IoLib_00024File_flush___V(JThreadRuntime *runtime){
    
    StackItem stack[1];
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2311, &rstack[0], NULL, &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_flush___V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_IoLib_00024File_flush___V(runtime, ins);
}
...
// stack: 0
// args: 0
s8 func_org_luaj_vm2_lib_IoLib_00024File_isstdfile___Z(JThreadRuntime *runtime){
    
    StackItem stack[1];
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2312, &rstack[0], NULL, &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_isstdfile___Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_lib_IoLib_00024File_isstdfile___Z(runtime, ins);
}
...
// stack: 0
// args: 0
void func_org_luaj_vm2_lib_IoLib_00024File_close___V(JThreadRuntime *runtime){
    
    StackItem stack[1];
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2313, &rstack[0], NULL, &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_close___V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_IoLib_00024File_close___V(runtime, ins);
}
...
// stack: 0
// args: 0
s8 func_org_luaj_vm2_lib_IoLib_00024File_isclosed___Z(JThreadRuntime *runtime){
    
    StackItem stack[1];
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2314, &rstack[0], NULL, &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_isclosed___Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_lib_IoLib_00024File_isclosed___Z(runtime, ins);
}
...
// stack: 0
// args: 2
s32 func_org_luaj_vm2_lib_IoLib_00024File_seek__Ljava_lang_String_2I_I(JThreadRuntime *runtime, struct java_lang_String* p0, s32 p1){
    ...
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2315, &rstack[0], &rlocal[0], &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_seek__Ljava_lang_String_2I_I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_lib_IoLib_00024File_seek__Ljava_lang_String_2I_I(runtime, ins, para[0].i);
}
...
// stack: 0
// args: 2
void func_org_luaj_vm2_lib_IoLib_00024File_setvbuf__Ljava_lang_String_2I_V(JThreadRuntime *runtime, struct java_lang_String* p0, s32 p1){
    ...
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2316, &rstack[0], &rlocal[0], &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_setvbuf__Ljava_lang_String_2I_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_IoLib_00024File_setvbuf__Ljava_lang_String_2I_V(runtime, ins, para[0].i);
}
...
// stack: 0
// args: 0
s32 func_org_luaj_vm2_lib_IoLib_00024File_remaining___I(JThreadRuntime *runtime){
    
    StackItem stack[1];
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2317, &rstack[0], NULL, &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_remaining___I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_lib_IoLib_00024File_remaining___I(runtime, ins);
}
...
// stack: 0
// args: 0
s32 func_org_luaj_vm2_lib_IoLib_00024File_peek___I(JThreadRuntime *runtime){
    
    StackItem stack[1];
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2318, &rstack[0], NULL, &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_peek___I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_lib_IoLib_00024File_peek___I(runtime, ins);
}
...
// stack: 0
// args: 0
s32 func_org_luaj_vm2_lib_IoLib_00024File_read___I(JThreadRuntime *runtime){
    
    StackItem stack[1];
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2319, &rstack[0], NULL, &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_read___I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_lib_IoLib_00024File_read___I(runtime, ins);
}
...
// stack: 0
// args: 3
s32 func_org_luaj_vm2_lib_IoLib_00024File_read___3BII_I(JThreadRuntime *runtime, JArray * p0, s32 p1, s32 p2){
    ...
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2320, &rstack[0], &rlocal[0], &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_read___3BII_I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_lib_IoLib_00024File_read___3BII_I(runtime, ins, para[0].i, para[1].i);
}

ExceptionItem arr_extable_func_org_luaj_vm2_lib_IoLib_00024File_eof___Z[] = {
    { , , 1883}
};
ExceptionTable extable_func_org_luaj_vm2_lib_IoLib_00024File_eof___Z = {1, arr_extable_func_org_luaj_vm2_lib_IoLib_00024File_eof___Z};

// locals: 2
// stack: 1
// args: 0
s8 func_org_luaj_vm2_lib_IoLib_00024File_eof___Z(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2321, &rstack[0], &rlocal[0], &sp);
    // try catch :L1749590097 L345703799 L1463877470 (
    L1749590097:
    __frame->bytecodeIndex = 
    //  line no 100 , L1749590097 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 100;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    if(stack[--sp].i  >= 0) goto L1250956357;
    // iconst_1
    stack[sp++].i = 1;
    goto L345703799;
    L1250956357:
    ...
    return stack[sp - 1].i;
    L1463877470:
    //  line no 101 , L1463877470 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_eof___Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_lib_IoLib_00024File_eof___Z(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_IoLib_00024File_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2322, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 106 , L2078396010 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 106;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/IoLib$File this$0 Lorg/luaj/vm2/lib/IoLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_IoLib_00024File*)rstack[sp - 1].obj)->this_000240_44;
    sp += 0;
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_IoLib_00024File_get__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 1
// args: 0
s32 func_org_luaj_vm2_lib_IoLib_00024File_type___I(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2323, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 111 , L1841945133 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 111;
    //  bipush 7
    stack[sp++].i = 7;
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_type___I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_lib_IoLib_00024File_type___I(runtime, ins);
}
...
// stack: 1
// args: 0
struct java_lang_String* func_org_luaj_vm2_lib_IoLib_00024File_typename___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2324, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 114 , L1755811644 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 114;
    //  ldc 
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_typename___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_IoLib_00024File_typename___Ljava_lang_String_2(runtime, ins);
}
...
// stack: 2
// args: 0
struct java_lang_String* func_org_luaj_vm2_lib_IoLib_00024File_tojstring___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2325, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 119 , L880934808 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 119;
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 4057);
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_tojstring___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_IoLib_00024File_tojstring___Ljava_lang_String_2(runtime, ins);
}

ExceptionItem arr_extable_func_org_luaj_vm2_lib_IoLib_00024File_finalize___V[] = {
    { , , 1457}
};
ExceptionTable extable_func_org_luaj_vm2_lib_IoLib_00024File_finalize___V = {1, arr_extable_func_org_luaj_vm2_lib_IoLib_00024File_finalize___V};

// locals: 2
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_IoLib_00024File_finalize___V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2326, &rstack[0], &rlocal[0], &sp);
    // try catch :L2035387904 L1016156941 L131532344 (
    ; 
    //  line no 123 , L1932484688 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 123;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    if(stack[--sp].i  != 0) goto L117162427;
    L2035387904:
    __frame->bytecodeIndex = 
    //  line no 125 , L2035387904 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    L1016156941:
    __frame->bytecodeIndex = 
    //  line no 126 , L1016156941 , bytecode index = 
    goto L117162427;
    L131532344:
    rlocal[1].obj = rstack[--sp].obj;
    L117162427:
    //  line no 128 , L117162427 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        case 0 : goto L131532344;
        default: goto __ExceptionHandlerNotFound;
    }
    __ExceptionHandlerNotFound:
    method_exit(runtime);
...
void bridge_org_luaj_vm2_lib_IoLib_00024File_finalize___V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_IoLib_00024File_finalize___V(runtime, ins);
}
