// CLASS: org/luaj/vm2/lib/DebugLib$debug extends org/luaj/vm2/lib/ZeroArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024debug_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_lib_DebugLib_00024debug[] = {
    func_org_luaj_vm2_lib_DebugLib_00024debug_call___Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_lib_ZeroArgFunction[] = {
    func_org_luaj_vm2_lib_DebugLib_00024debug_call___Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024debug_call___Lorg_luaj_vm2_LuaValue_2,  //3
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024debug_call___Lorg_luaj_vm2_LuaValue_2,  //101
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024debug[] = {
    {355, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_lib_DebugLib_00024debug}, //0
    {176, 5, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_lib_ZeroArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024debug_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_DebugLib_00024debug__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2644, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 143 , L998015174 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_DebugLib_00024debug__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024debug__init____V(runtime, ins);
}
...
// stack: 1
// args: 0
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_DebugLib_00024debug_call___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2645, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 145 , L1956244167 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 145;
    // getstatic org/luaj/vm2/lib/DebugLib$debug NONE Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024debug_call___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024debug_call___Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
