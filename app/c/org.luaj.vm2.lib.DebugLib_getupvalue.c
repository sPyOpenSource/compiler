// CLASS: org/luaj/vm2/lib/DebugLib$getupvalue extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024getupvalue_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_lib_DebugLib_00024getupvalue[] = {
    func_org_luaj_vm2_lib_DebugLib_00024getupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024getupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024getupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024getupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue[] = {
    {202, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_lib_DebugLib_00024getupvalue}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024getupvalue_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_DebugLib_00024getupvalue__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1017, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 252 , L1927963027 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_DebugLib_00024getupvalue__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024getupvalue__init____V(runtime, ins);
}
...
// stack: 4
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_DebugLib_00024getupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1018, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 254 , L1167088639 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 254;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    // invokevirtual org/luaj/vm2/Varargs.checkfunction(I)Lorg/luaj/vm2/LuaFunction;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaFunction* (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 2, 32);
    ...
    ; 
    //  line no 255 , L707531688 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    ; 
    //  line no 256 , L191568263 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // instanceof org/luaj/vm2/LuaClosure
    stack[sp - 1].i = instance_of_classname_index(rstack[sp - 1].obj, 1783);
    if(stack[--sp].i  == 0) goto L1799635803;
    ; 
    //  line no 257 , L751608431 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // checkcast org/luaj/vm2/LuaClosure
    {
        s32 cast_r = checkcast(rstack[sp - 1].obj, 1783);
        if(!cast_r){
    ...
    ; 
    //  line no 258 , L1723290893 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    stack[sp++].i = local[3].i;
    // invokestatic org/luaj/vm2/lib/DebugLib.findupvalue(Lorg/luaj/vm2/LuaClosure;I)Lorg/luaj/vm2/LuaString;
    {
        sp -= 3;
        rstack[sp].obj = func_org_luaj_vm2_lib_DebugLib_findupvalue__Lorg_luaj_vm2_LuaClosure_2I_Lorg_luaj_vm2_LuaString_2(runtime, rstack[sp + 0].obj, rstack[sp + 1].obj, stack[sp + 2].i);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 259 , L893640573 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    if(rstack[--sp].obj  == NULL) goto L1799635803;
    ; 
    //  line no 260 , L2085886997 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    rstack[sp++].obj = rlocal[4].obj;
    ...
    --sp;
    // arrload __refer  ,  L2085886997 bc index = 
    {
        s32 idx = stack[--sp].i;
    ...
    // invokestatic org/luaj/vm2/lib/DebugLib$getupvalue.varargsOf(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 3;
    ...
    L1799635803:
    //  line no 263 , L1799635803 , bytecode index = 
    // getstatic org/luaj/vm2/lib/DebugLib$getupvalue NIL Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024getupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024getupvalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
