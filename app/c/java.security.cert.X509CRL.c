...
void func_java_security_cert_X509CRL__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 96 , L1229202732 , bytecode index = 
    ...
    ; 
    //  line no 97 , L1149377174 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
s8 func_java_security_cert_X509CRL_equals__Ljava_lang_Object_2_Z(JThreadRuntime *runtime, struct java_lang_Object* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 110 , L464064894 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 110;
    rstack[sp++].obj = rlocal[1].obj;
    // instanceof java/security/cert/X509CRL
    stack[sp - 1].i = instance_of_classname_index(rstack[sp - 1].obj, 413);
    if(stack[--sp].i  == 0) goto L1932274274;
    ; 
    //  line no 126 , L657381435 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    method_exit(runtime);
    return stack[sp - 1].i;
    L1932274274:
    //  line no 128 , L1932274274 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    method_exit(runtime);
    return stack[sp - 1].i;
...
s32 func_java_security_cert_X509CRL_hashCode___I(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 139 , L302977067 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 139;
    rstack[sp++].obj = rlocal[0].obj;
...
s8 func_java_security_cert_X509CRL_hasUnsupportedCriticalExtension___Z(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 370 , L1373419525 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 370;
    // iconst_0
    stack[sp++].i = 0;
...
struct java_util_Set* func_java_security_cert_X509CRL_getCriticalExtensionOIDs___Ljava_util_Set_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 372 , L212683148 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 372;
    // aconst null
    rstack[sp++].obj = NULL;
...
struct java_util_Set* func_java_security_cert_X509CRL_getNonCriticalExtensionOIDs___Ljava_util_Set_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 374 , L718068661 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 374;
    // aconst null
    rstack[sp++].obj = NULL;
...
JArray * func_java_security_cert_X509CRL_getExtensionValue__Ljava_lang_String_2__3B(JThreadRuntime *runtime, struct java_lang_String* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 376 , L1714550218 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 376;
    // aconst null
    rstack[sp++].obj = NULL;
