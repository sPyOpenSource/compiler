...
void func_metaxa_os_devices_net_CompatabilityWord__init___BB_V(JThreadRuntime *runtime, s8 p0, s8 p1){
    ...
    local[1].i = p1;
    ; 
    //  line no 7 , L1099717276 , bytecode index = 
    ...
    // it's a empty method
    ; 
    //  line no 8 , L417557780 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 9 , L1350751778 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 10 , L332699949 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
s8 func_metaxa_os_devices_net_CompatabilityWord_get_1warninglevel___B(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 13 , L858204589 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
...
s8 func_metaxa_os_devices_net_CompatabilityWord_get_1failurelevel___B(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 16 , L1115170891 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
