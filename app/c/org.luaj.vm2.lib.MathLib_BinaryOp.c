// CLASS: org/luaj/vm2/lib/MathLib$BinaryOp extends org/luaj/vm2/lib/TwoArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_MathLib_00024BinaryOp_static {};



__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_lib_MathLib_00024BinaryOp[] = {
    func_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
    func_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__DD_D  //1
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_lib_TwoArgFunction[] = {
    func_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //5
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //104
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp[] = {
    {72, 2, arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_lib_MathLib_00024BinaryOp}, //0
    {73, 5, arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_lib_TwoArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024BinaryOp_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_MathLib_00024BinaryOp__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2449, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 139 , L1487884406 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_MathLib_00024BinaryOp__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_MathLib_00024BinaryOp__init____V(runtime, ins);
}
...
// stack: 5
// args: 2
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2450, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 141 , L1301763240 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 141;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    // invokevirtual org/luaj/vm2/lib/MathLib$BinaryOp.call(DD)D
    {
        sp -= 4;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        f64 (*__func_p) (JThreadRuntime *,f64,f64) = find_method(__ins->vm_table, 72, 1);
    ...
    // invokestatic org/luaj/vm2/lib/MathLib$BinaryOp.valueOf(D)Lorg/luaj/vm2/LuaNumber;
    {
        sp -= 3;
...
void bridge_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins, para[0].obj);
}
...
// stack: 0
// args: 2
f64 func_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__DD_D(JThreadRuntime *runtime, f64 p0, f64 p2){
    ...
    RStackItem rstack[1];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2451, &rstack[0], &rlocal[0], &sp);
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
        default: goto __ExceptionHandlerNotFound;
    }
...
void bridge_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__DD_D(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->d = func_org_luaj_vm2_lib_MathLib_00024BinaryOp_call__DD_D(runtime, ins, para[0].d);
}
