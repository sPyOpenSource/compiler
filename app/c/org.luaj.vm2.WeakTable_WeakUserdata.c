// CLASS: org/luaj/vm2/WeakTable$WeakUserdata extends org/luaj/vm2/WeakTable$WeakValue
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_WeakTable_00024WeakUserdata_static {};



__refer arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_org_luaj_vm2_WeakTable_00024WeakUserdata[] = {
    func_org_luaj_vm2_WeakTable_00024WeakUserdata_strongvalue___Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_org_luaj_vm2_WeakTable_00024WeakValue[] = {
    func_org_luaj_vm2_WeakTable_00024WeakValue_type___I,  //0
    func_org_luaj_vm2_WeakTable_00024WeakValue_typename___Ljava_lang_String_2,  //1
    func_org_luaj_vm2_WeakTable_00024WeakValue_toString___Ljava_lang_String_2,  //2
    func_org_luaj_vm2_WeakTable_00024WeakUserdata_strongvalue___Lorg_luaj_vm2_LuaValue_2,  //3
    func_org_luaj_vm2_WeakTable_00024WeakValue_raweq__Lorg_luaj_vm2_LuaValue_2_Z  //4
};
__refer arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_WeakTable_00024WeakValue_type___I,  //0
    func_org_luaj_vm2_WeakTable_00024WeakValue_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_WeakTable_00024WeakValue_toString___Ljava_lang_String_2,  //26
    ...
    func_org_luaj_vm2_WeakTable_00024WeakValue_raweq__Lorg_luaj_vm2_LuaValue_2_Z,  //135
    ...
    func_org_luaj_vm2_WeakTable_00024WeakUserdata_strongvalue___Lorg_luaj_vm2_LuaValue_2,  //204
...
__refer arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_org_luaj_vm2_Varargs[] = {
    ...
    func_org_luaj_vm2_WeakTable_00024WeakValue_toString___Ljava_lang_String_2,  //59
...
__refer arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_java_lang_Object[] = {
    func_org_luaj_vm2_WeakTable_00024WeakValue_toString___Ljava_lang_String_2,  //0
...
VMTable vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata[] = {
    {37, 1, arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_org_luaj_vm2_WeakTable_00024WeakUserdata}, //0
    {36, 5, arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_org_luaj_vm2_WeakTable_00024WeakValue}, //1
    {1, 210, arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_org_luaj_vm2_LuaValue}, //2
    {2, 63, arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_org_luaj_vm2_Varargs}, //3
    {5, 10, arr_vmtable_org_luaj_vm2_WeakTable_00024WeakUserdata_from_java_lang_Object}, //4
};
...
// stack: 4
// args: 1
void func_org_luaj_vm2_WeakTable_00024WeakUserdata__init___Lorg_luaj_vm2_LuaValue_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1460, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 379 , L917935693 , bytecode index = 
    ...
    ; 
    //  line no 380 , L823758059 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    // putfield org/luaj/vm2/WeakTable$WeakUserdata ob Ljava/lang/ref/WeakReference;
    sp -= 2;
    ((struct org_luaj_vm2_WeakTable_00024WeakUserdata*)rstack[sp + 0].obj)->ob_45 = rstack[sp + 1].obj;
    ; 
    //  line no 381 , L153448497 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    // putfield org/luaj/vm2/WeakTable$WeakUserdata mt Lorg/luaj/vm2/LuaValue;
    sp -= 2;
    ((struct org_luaj_vm2_WeakTable_00024WeakUserdata*)rstack[sp + 0].obj)->mt_46 = rstack[sp + 1].obj;
    ; 
    //  line no 382 , L1965036946 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_WeakTable_00024WeakUserdata__init___Lorg_luaj_vm2_LuaValue_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_WeakTable_00024WeakUserdata__init___Lorg_luaj_vm2_LuaValue_2_V(runtime, ins);
}
...
// stack: 4
// args: 0
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_WeakTable_00024WeakUserdata_strongvalue___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1461, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 385 , L178603358 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 385;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/WeakTable$WeakUserdata ref Ljava/lang/ref/WeakReference;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_WeakTable_00024WeakUserdata*)rstack[sp - 1].obj)->ref_44;
    sp += 0;
    ...
    ; 
    //  line no 386 , L673384643 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    if(rstack[--sp].obj  == NULL) goto L1574573264;
    ; 
    //  line no 387 , L498134055 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    L1574573264:
    //  line no 388 , L1574573264 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/WeakTable$WeakUserdata ob Ljava/lang/ref/WeakReference;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_WeakTable_00024WeakUserdata*)rstack[sp - 1].obj)->ob_45;
    sp += 0;
    // invokevirtual java/lang/ref/WeakReference.get()Ljava/lang/Object;
    {
        sp -= 0;
    ...
    ; 
    //  line no 389 , L1033880954 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    if(rstack[--sp].obj  == NULL) goto L223000346;
    ; 
    //  line no 390 , L3886839 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/WeakTable$WeakUserdata mt Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_WeakTable_00024WeakUserdata*)rstack[sp - 1].obj)->mt_46;
    sp += 0;
    // invokestatic org/luaj/vm2/LuaValue.userdataOf(Ljava/lang/Object;Lorg/luaj/vm2/LuaValue;)Lorg/luaj/vm2/LuaUserdata;
    {
        sp -= 3;
        rstack[sp].obj = func_org_luaj_vm2_LuaValue_userdataOf__Ljava_lang_Object_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaUserdata_2(runtime, rstack[sp + 0].obj, rstack[sp + 1].obj, rstack[sp + 2].obj);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 391 , L451959555 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // new java/lang/ref/WeakReference
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 211);
    // dup
    ...
    // putfield org/luaj/vm2/WeakTable$WeakUserdata ref Ljava/lang/ref/WeakReference;
    sp -= 2;
    ((struct org_luaj_vm2_WeakTable_00024WeakUserdata*)rstack[sp + 0].obj)->ref_44 = rstack[sp + 1].obj;
    ; 
    //  line no 392 , L1502079282 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L223000346:
    //  line no 394 , L223000346 , bytecode index = 
    // aconst null
    rstack[sp++].obj = NULL;
    method_exit(runtime);
    return rstack[sp - 1].obj;
...
void bridge_org_luaj_vm2_WeakTable_00024WeakUserdata_strongvalue___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_WeakTable_00024WeakUserdata_strongvalue___Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 2
// args: 2
void func_org_luaj_vm2_WeakTable_00024WeakUserdata__init___Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_WeakTable_000241_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_WeakTable_000241* p1){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1462, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 374 , L1539038539 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 374;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // invokespecial org/luaj/vm2/WeakTable$WeakUserdata.<init>(Lorg/luaj/vm2/LuaValue;)V
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_WeakTable_00024WeakUserdata__init___Lorg_luaj_vm2_LuaValue_2_V(runtime, rstack[sp + 0].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
...
void bridge_org_luaj_vm2_WeakTable_00024WeakUserdata__init___Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_WeakTable_000241_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_WeakTable_00024WeakUserdata__init___Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_WeakTable_000241_2_V(runtime, ins, para[0].obj);
}
