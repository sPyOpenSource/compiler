// CLASS: org/luaj/vm2/lib/BaseLib$ipairs extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024ipairs_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_lib_BaseLib_00024ipairs[] = {
    func_org_luaj_vm2_lib_BaseLib_00024ipairs_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024ipairs_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024ipairs_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024ipairs_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs[] = {
    {337, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_lib_BaseLib_00024ipairs}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024ipairs_from_java_lang_Object}, //6
};
...
// stack: 3
// args: 0
void func_org_luaj_vm2_lib_BaseLib_00024ipairs__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2244, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 407 , L386478079 , bytecode index = 
    ...
    ; 
    //  line no 408 , L555864569 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // new org/luaj/vm2/lib/BaseLib$inext
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 282);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ++sp;
    // invokespecial org/luaj/vm2/lib/BaseLib$inext.<init>()V
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_lib_BaseLib_00024inext__init____V(runtime);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    // putfield org/luaj/vm2/lib/BaseLib$ipairs inext Lorg/luaj/vm2/lib/BaseLib$inext;
    sp -= 2;
    ((struct org_luaj_vm2_lib_BaseLib_00024ipairs*)rstack[sp + 0].obj)->inext_47 = rstack[sp + 1].obj;
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_lib_BaseLib_00024ipairs__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024ipairs__init____V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_BaseLib_00024ipairs_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2245, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 410 , L403094604 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 410;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/BaseLib$ipairs inext Lorg/luaj/vm2/lib/BaseLib$inext;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib_00024ipairs*)rstack[sp - 1].obj)->inext_47;
    sp += 0;
    ...
    // getstatic org/luaj/vm2/lib/BaseLib$ipairs ZERO Lorg/luaj/vm2/LuaNumber;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.ZERO_17;
    sp += 1;
    // invokestatic org/luaj/vm2/lib/BaseLib$ipairs.varargsOf(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 4;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024ipairs_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024ipairs_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
