// CLASS: org/luaj/vm2/lib/BaseLib$collectgarbage extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024collectgarbage_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_lib_BaseLib_00024collectgarbage[] = {
    func_org_luaj_vm2_lib_BaseLib_00024collectgarbage_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024collectgarbage_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024collectgarbage_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024collectgarbage_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage[] = {
    {281, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_lib_BaseLib_00024collectgarbage}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024collectgarbage_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_BaseLib_00024collectgarbage__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1710, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 141 , L32206364 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_BaseLib_00024collectgarbage__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024collectgarbage__init____V(runtime, ins);
}
...
// stack: 5
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_BaseLib_00024collectgarbage_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1711, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 143 , L730583371 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 143;
    ...
    stack[sp++].i = 1;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3006);
    ...
    ; 
    //  line no 144 , L99695585 , bytecode index = 
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3006);
    ...
    if(stack[--sp].i  == 0) goto L1596997325;
    ; 
    //  line no 145 , L1356054329 , bytecode index = 
    // invokestatic java/lang/System.gc()V
    {
        sp -= 1;
        func_java_lang_System_gc___V(runtime, rstack[sp + 0].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 146 , L631717345 , bytecode index = 
    // getstatic org/luaj/vm2/lib/BaseLib$collectgarbage ZERO Lorg/luaj/vm2/LuaNumber;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.ZERO_17;
    sp += 1;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L1596997325:
    //  line no 147 , L1596997325 , bytecode index = 
    //  ldc 
    ...
    if(stack[--sp].i  == 0) goto L696591495;
    ; 
    //  line no 148 , L1998434604 , bytecode index = 
    ...
    ; 
    //  line no 149 , L989520513 , bytecode index = 
    ...
    // invokevirtual java/lang/Runtime.totalMemory()J
    {
        ...
        s64 (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 254, 2);
    ...
    // invokevirtual java/lang/Runtime.freeMemory()J
    {
        ...
        s64 (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 254, 1);
        stack[sp].j = __func_p(runtime);
        sp += 2;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    ; 
    //  line no 150 , L648972298 , bytecode index = 
    ...
    sp -= 2;
    // invokestatic org/luaj/vm2/lib/BaseLib$collectgarbage.valueOf(D)Lorg/luaj/vm2/LuaNumber;
    {
        sp -= 3;
    ...
    // invokestatic org/luaj/vm2/lib/BaseLib$collectgarbage.varargsOf(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 3;
    ...
    return rstack[sp - 1].obj;
    L696591495:
    //  line no 151 , L696591495 , bytecode index = 
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3007);
    rstack[sp++].obj = rlocal[2].obj;
    // invokevirtual java/lang/String.equals(Ljava/lang/Object;)Z
    {
        sp -= 1;
    ...
    if(stack[--sp].i  == 0) goto L638525764;
    ; 
    //  line no 152 , L1006727288 , bytecode index = 
    // invokestatic java/lang/System.gc()V
    {
        sp -= 1;
        func_java_lang_System_gc___V(runtime, rstack[sp + 0].obj);
    ...
    ; 
    //  line no 153 , L1367503763 , bytecode index = 
    ...
    return rstack[sp - 1].obj;
    L638525764:
    //  line no 155 , L638525764 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3008);
    ...
    // invokestatic org/luaj/vm2/lib/BaseLib$collectgarbage.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
    ...
    --sp; //pop
    ; 
    //  line no 157 , L62803825 , bytecode index = 
    // getstatic org/luaj/vm2/lib/BaseLib$collectgarbage NIL Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024collectgarbage_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024collectgarbage_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
