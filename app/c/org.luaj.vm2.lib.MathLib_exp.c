// CLASS: org/luaj/vm2/lib/MathLib$exp extends org/luaj/vm2/lib/MathLib$UnaryOp
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_MathLib_00024exp_static {};



__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_lib_MathLib_00024exp[] = {
    func_org_luaj_vm2_lib_MathLib_00024exp_call__D_D  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_lib_MathLib_00024UnaryOp[] = {
    func_org_luaj_vm2_lib_MathLib_00024UnaryOp_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
    func_org_luaj_vm2_lib_MathLib_00024exp_call__D_D  //1
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_lib_OneArgFunction[] = {
    func_org_luaj_vm2_lib_MathLib_00024UnaryOp_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_lib_LibFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_MathLib_00024exp[] = {
    {226, 1, arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_lib_MathLib_00024exp}, //0
    {144, 2, arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_lib_MathLib_00024UnaryOp}, //1
    {99, 5, arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_lib_OneArgFunction}, //2
    {18, 9, arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_lib_LibFunction}, //3
    {19, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_LuaFunction}, //4
    {1, 210, arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_LuaValue}, //5
    {2, 63, arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_org_luaj_vm2_Varargs}, //6
    {5, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024exp_from_java_lang_Object}, //7
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_MathLib_00024exp__init___Lorg_luaj_vm2_lib_MathLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_MathLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1965, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 158 , L862486751 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 158;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial org/luaj/vm2/lib/MathLib$UnaryOp.<init>()V
    {
        sp -= 0;
        ...
        func_org_luaj_vm2_lib_MathLib_00024UnaryOp__init____V(runtime);
        sp += 0;
    ...
    ; 
    //  line no 159 , L407263135 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/MathLib$exp mathlib Lorg/luaj/vm2/lib/MathLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_MathLib_00024exp*)rstack[sp + 0].obj)->mathlib_47 = rstack[sp + 1].obj;
    ; 
    //  line no 160 , L1825662648 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_lib_MathLib_00024exp__init___Lorg_luaj_vm2_lib_MathLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_MathLib_00024exp__init___Lorg_luaj_vm2_lib_MathLib_2_V(runtime, ins);
}
...
// stack: 5
// args: 1
f64 func_org_luaj_vm2_lib_MathLib_00024exp_call__D_D(JThreadRuntime *runtime, f64 p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1966, &rstack[0], &rlocal[0], &sp);
    local[0].d = p0;
    ; 
    //  line no 162 , L1979455890 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 162;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/MathLib$exp mathlib Lorg/luaj/vm2/lib/MathLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_MathLib_00024exp*)rstack[sp - 1].obj)->mathlib_47;
    sp += 0;
    //  ldc 
    stack[sp].d = 2.718281828459045;
    sp += 2;
...
void bridge_org_luaj_vm2_lib_MathLib_00024exp_call__D_D(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->d = func_org_luaj_vm2_lib_MathLib_00024exp_call__D_D(runtime, ins);
}
