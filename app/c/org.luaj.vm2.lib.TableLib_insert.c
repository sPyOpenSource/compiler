// CLASS: org/luaj/vm2/lib/TableLib$insert extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_TableLib_00024insert_static {};



__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_lib_TableLib_00024insert[] = {
    func_org_luaj_vm2_lib_TableLib_00024insert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_TableLib_00024insert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_TableLib_00024insert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_TableLib_00024insert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_TableLib_00024insert[] = {
    {135, 1, arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_lib_TableLib_00024insert}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_TableLib_00024insert_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_TableLib_00024insert__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1900, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 94 , L1765865093 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_TableLib_00024insert__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_TableLib_00024insert__init____V(runtime, ins);
}
...
// stack: 4
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_TableLib_00024insert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1901, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 96 , L956337311 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 96;
    ...
    L2016482777:
    //  line no 98 , L2016482777 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    // invokevirtual org/luaj/vm2/Varargs.checktable(I)Lorg/luaj/vm2/LuaTable;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaTable* (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 2, 39);
    ...
    ; 
    //  line no 99 , L157004450 , bytecode index = 
    ...
    ; 
    //  line no 100 , L1188390859 , bytecode index = 
    // getstatic org/luaj/vm2/lib/TableLib$insert NONE Lorg/luaj/vm2/LuaValue;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.NONE_16;
    sp += 1;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L872592585:
    //  line no 103 , L872592585 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    // invokevirtual org/luaj/vm2/Varargs.checktable(I)Lorg/luaj/vm2/LuaTable;
    ...
    rlocal[2].obj = rstack[--sp].obj;
    ; 
    //  line no 104 , L909786389 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    ; 
    //  line no 105 , L390034407 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    // invokevirtual org/luaj/vm2/LuaTable.length()I
    {
        sp -= 0;
    ...
    ; 
    //  line no 106 , L1134894336 , bytecode index = 
    stack[sp++].i = local[3].i;
    // iconst_1
    stack[sp++].i = 1;
    sp -= 2;
    if(stack[sp + 0].i  < stack[sp + 1].i) goto L774095232;
    stack[sp++].i = local[3].i;
    stack[sp++].i = local[4].i;
    sp -= 2;
    if(stack[sp + 0].i  <= stack[sp + 1].i) goto L1234600900;
    L774095232:
    // iconst_2
    stack[sp++].i = 2;
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3231);
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3232);
    // invokevirtual java/lang/StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
    ...
    // invokestatic org/luaj/vm2/lib/TableLib$insert.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
    ...
    --sp; //pop
    L1234600900:
    //  line no 107 , L1234600900 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    stack[sp++].i = local[3].i;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_3
    ...
    ; 
    //  line no 108 , L635068762 , bytecode index = 
    // getstatic org/luaj/vm2/lib/TableLib$insert NONE Lorg/luaj/vm2/LuaValue;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.NONE_16;
    sp += 1;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    L371932487:
    //  line no 111 , L371932487 , bytecode index = 
    // new java/lang/StringBuilder
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 41);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3233);
    // invokevirtual java/lang/StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
    ...
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3234);
    // invokevirtual java/lang/StringBuilder.append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
    ...
    // invokestatic org/luaj/vm2/lib/TableLib$insert.error(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_lib_TableLib_00024insert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_TableLib_00024insert_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
