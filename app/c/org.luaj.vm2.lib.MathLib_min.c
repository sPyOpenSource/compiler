// CLASS: org/luaj/vm2/lib/MathLib$min extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_MathLib_00024min_static {};



__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_lib_MathLib_00024min[] = {
    func_org_luaj_vm2_lib_MathLib_00024min_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024min_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024min_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_MathLib_00024min_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_MathLib_00024min[] = {
    {142, 1, arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_lib_MathLib_00024min}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024min_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_MathLib_00024min__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 208 , L1572256205 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_MathLib_00024min__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_MathLib_00024min__init____V(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_MathLib_00024min_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 210 , L548554586 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 210;
    ...
    ; 
    //  line no 211 , L126189538 , bytecode index = 
    // iconst_2
    stack[sp++].i = 2;
    ...
    sp -= 2;
    if(stack[sp + 0].i  > stack[sp + 1].i) goto L702025003;
    ; 
    //  line no 212 , L93199773 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[3].i;
    // invokevirtual org/luaj/vm2/Varargs.checkvalue(I)Lorg/luaj/vm2/LuaValue;
    {
    ...
    ; 
    //  line no 213 , L1147805316 , bytecode index = 
    ...
    if(stack[--sp].i  == 0) goto L1326393666;
    rstack[sp++].obj = rlocal[5].obj;
    rlocal[2].obj = rstack[--sp].obj;
    L1326393666:
    //  line no 211 , L1326393666 , bytecode index = 
    // iinc slot 3 value 1
    local[3].i += 1;
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L467796378;
    L702025003:
    //  line no 215 , L702025003 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    method_exit(runtime);
...
void bridge_org_luaj_vm2_lib_MathLib_00024min_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_MathLib_00024min_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
