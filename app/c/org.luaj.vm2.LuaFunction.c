// CLASS: org/luaj/vm2/LuaFunction extends org/luaj/vm2/LuaValue
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_LuaFunction_static {struct org_luaj_vm2_LuaValue* s_1metatable_44;  };
struct org_luaj_vm2_LuaFunction_static static_var_org_luaj_vm2_LuaFunction = {NULL};


__refer arr_vmtable_org_luaj_vm2_LuaFunction_from_org_luaj_vm2_LuaFunction[] = {
    ...
    func_org_luaj_vm2_LuaFunction_tojstring___Ljava_lang_String_2,  //6
...
__refer arr_vmtable_org_luaj_vm2_LuaFunction_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_LuaFunction_tojstring___Ljava_lang_String_2,  //23
...
__refer arr_vmtable_org_luaj_vm2_LuaFunction_from_org_luaj_vm2_Varargs[] = {
    ...
    func_org_luaj_vm2_LuaFunction_tojstring___Ljava_lang_String_2,  //58
...
__refer arr_vmtable_org_luaj_vm2_LuaFunction_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_LuaFunction[] = {
    {19, 10, arr_vmtable_org_luaj_vm2_LuaFunction_from_org_luaj_vm2_LuaFunction}, //0
    {1, 210, arr_vmtable_org_luaj_vm2_LuaFunction_from_org_luaj_vm2_LuaValue}, //1
    {2, 63, arr_vmtable_org_luaj_vm2_LuaFunction_from_org_luaj_vm2_Varargs}, //2
    {5, 10, arr_vmtable_org_luaj_vm2_LuaFunction_from_java_lang_Object}, //3
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_LuaFunction__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 834, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 38 , L2092801316 , bytecode index = 
...
void bridge_org_luaj_vm2_LuaFunction__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_LuaFunction__init____V(runtime, ins);
}
...
// stack: 1
// args: 0
s32 func_org_luaj_vm2_LuaFunction_type___I(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 44 , L1344697180 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 44;
    //  bipush 6
    stack[sp++].i = 6;
...
void bridge_org_luaj_vm2_LuaFunction_type___I(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaFunction_type___I(runtime, ins);
}
...
// stack: 1
// args: 0
struct java_lang_String* func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 48 , L300983713 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 48;
    //  ldc 
...
void bridge_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2(runtime, ins);
}
...
// stack: 1
// args: 0
s8 func_org_luaj_vm2_LuaFunction_isfunction___Z(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 52 , L1940445711 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 52;
    // iconst_1
    stack[sp++].i = 1;
...
void bridge_org_luaj_vm2_LuaFunction_isfunction___Z(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->i = func_org_luaj_vm2_LuaFunction_isfunction___Z(runtime, ins);
}
...
// stack: 1
// args: 0
struct org_luaj_vm2_LuaFunction* func_org_luaj_vm2_LuaFunction_checkfunction___Lorg_luaj_vm2_LuaFunction_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 56 , L1142347343 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 56;
    rstack[sp++].obj = rlocal[0].obj;
    method_exit(runtime);
...
void bridge_org_luaj_vm2_LuaFunction_checkfunction___Lorg_luaj_vm2_LuaFunction_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaFunction_checkfunction___Lorg_luaj_vm2_LuaFunction_2(runtime, ins);
}
...
// stack: 1
// args: 1
struct org_luaj_vm2_LuaFunction* func_org_luaj_vm2_LuaFunction_optfunction__Lorg_luaj_vm2_LuaFunction_2_Lorg_luaj_vm2_LuaFunction_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaFunction* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 60 , L1581078471 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 60;
    rstack[sp++].obj = rlocal[0].obj;
    method_exit(runtime);
...
void bridge_org_luaj_vm2_LuaFunction_optfunction__Lorg_luaj_vm2_LuaFunction_2_Lorg_luaj_vm2_LuaFunction_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaFunction_optfunction__Lorg_luaj_vm2_LuaFunction_2_Lorg_luaj_vm2_LuaFunction_2(runtime, ins);
}
...
// stack: 1
// args: 0
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_LuaFunction_getmetatable___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 64 , L33233312 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 64;
    // getstatic org/luaj/vm2/LuaFunction s_metatable Lorg/luaj/vm2/LuaValue;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaFunction.s_1metatable_44;
    sp += 1;
    method_exit(runtime);
    return rstack[sp - 1].obj;
    ; 
...
void bridge_org_luaj_vm2_LuaFunction_getmetatable___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaFunction_getmetatable___Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 2
// args: 0
struct java_lang_String* func_org_luaj_vm2_LuaFunction_tojstring___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 68 , L1515403487 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 68;
...
void bridge_org_luaj_vm2_LuaFunction_tojstring___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaFunction_tojstring___Ljava_lang_String_2(runtime, ins);
}
...
// stack: 1
// args: 0
struct org_luaj_vm2_LuaString* func_org_luaj_vm2_LuaFunction_strvalue___Lorg_luaj_vm2_LuaString_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 72 , L417557780 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 72;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    // invokestatic org/luaj/vm2/LuaFunction.valueOf(Ljava/lang/String;)Lorg/luaj/vm2/LuaString;
    {
        sp -= 2;
...
void bridge_org_luaj_vm2_LuaFunction_strvalue___Lorg_luaj_vm2_LuaString_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaFunction_strvalue___Lorg_luaj_vm2_LuaString_2(runtime, ins);
}
...
// stack: 3
// args: 0
struct java_lang_String* func_org_luaj_vm2_LuaFunction_classnamestub___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 80 , L332699949 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 80;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 81 , L808417649 , bytecode index = 
    ...
    // invokevirtual java/lang/String.lastIndexOf(I)I
    {
        ...
        s32 (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 50, 4);
    ...
    ; 
    //  line no 82 , L858204589 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    stack[sp++].i = 95;
    sp -= 2;
    if(stack[sp + 0].i  != stack[sp + 1].i) goto L1976752685;
    // iinc slot 2 value 1
    local[2].i += 1;
    L1976752685:
    //  line no 83 , L1976752685 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
...
void bridge_org_luaj_vm2_LuaFunction_classnamestub___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaFunction_classnamestub___Ljava_lang_String_2(runtime, ins);
}
...
// stack: 1
// args: 0
struct java_lang_String* func_org_luaj_vm2_LuaFunction_name___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 90 , L156710276 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 90;
    rstack[sp++].obj = rlocal[0].obj;
    // invokevirtual org/luaj/vm2/LuaFunction.classnamestub()Ljava/lang/String;
...
void bridge_org_luaj_vm2_LuaFunction_name___Ljava_lang_String_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_LuaFunction_name___Ljava_lang_String_2(runtime, ins);
}
