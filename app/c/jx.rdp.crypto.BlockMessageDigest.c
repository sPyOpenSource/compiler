...
void func_jx_rdp_crypto_BlockMessageDigest__init___Ljava_lang_String_2_V(JThreadRuntime *runtime, struct java_lang_String* p0){
    ...
    rlocal[0].obj = p0;
    ; 
    //  line no 48 , L875917495 , bytecode index = 
    ...
    // it's a empty method
    ; 
    //  line no 49 , L360207322 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 50 , L119290689 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 51 , L594427726 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 52 , L1019298652 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
s32 func_jx_rdp_crypto_BlockMessageDigest_bitcount___I(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 58 , L231786897 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 58;
    rstack[sp++].obj = rlocal[0].obj;
...
void func_jx_rdp_crypto_BlockMessageDigest_engineReset___V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 67 , L1778081847 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 67;
    rstack[sp++].obj = rlocal[0].obj;
    // iconst_0
    ...
    ; 
    //  line no 68 , L57497692 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // iconst_0
    stack[sp++].i = 0;
    ...
    ; 
    //  line no 69 , L142247393 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_jx_rdp_crypto_BlockMessageDigest_engineUpdate__B_V(JThreadRuntime *runtime, s8 p0){
    ...
    local[0].i = p0;
    ; 
    //  line no 78 , L1431467659 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 78;
    // iconst_1
    stack[sp++].i = 1;
    ...
    // arrstore s8  ,  L1431467659 bc index = 
    {
        ;
        s8 value = stack[--sp].i;
        s32 idx = stack[--sp].i;
    ...
    ; 
    //  line no 79 , L1016363973 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    ...
    ; 
    //  line no 80 , L1620948027 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void func_jx_rdp_crypto_BlockMessageDigest_engineUpdate___3BII_V(JThreadRuntime *runtime, JArray * p0, s32 p1, s32 p2){
    ...
    local[2].i = p2;
    ; 
    //  line no 91 , L324457684 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 91;
    rstack[sp++].obj = rlocal[0].obj;
    // dup
    ...
    ((struct jx_rdp_crypto_BlockMessageDigest*)rstack[sp + 0].obj)->count_3 = stack[sp + 1].i;
    ; 
    //  line no 92 , L201576232 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/rdp/crypto/BlockMessageDigest count I
    stack[sp - 1].i = ((struct jx_rdp_crypto_BlockMessageDigest*)rstack[sp - 1].obj)->count_3;
    sp += 0;
    ...
    sp -= 2;
    if(stack[sp + 0].i  <= stack[sp + 1].i) goto L20094719;
    ; 
    //  line no 93 , L1687662712 , bytecode index = 
    ...
    // athrow
    //     L1687662712 in labeltable is :L1687662712
    {
        __frame->bytecodeIndex = 
        __frame->lineNo = 93;
    ...
    L20094719:
    //  line no 95 , L20094719 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/rdp/crypto/BlockMessageDigest data_length I
    stack[sp - 1].i = ((struct jx_rdp_crypto_BlockMessageDigest*)rstack[sp - 1].obj)->data_1length_5;
    sp += 0;
    ...
    L1103243338:
    //  line no 98 , L1103243338 , bytecode index = 
    stack[sp++].i = local[3].i;
    ...
    ; 
    //  line no 99 , L532087022 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 100 , L1332210474 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/rdp/crypto/BlockMessageDigest buffer [B
    rstack[sp - 1].obj = ((struct jx_rdp_crypto_BlockMessageDigest*)rstack[sp - 1].obj)->buffer_0;
    ...
    ; 
    //  line no 101 , L1248234350 , bytecode index = 
    stack[sp++].i = local[3].i;
    stack[sp++].i = local[5].i;
    stack[sp - 2].i = stack[sp - 2].i - stack[sp - 1].i; 
    --sp;
    ...
    ; 
    //  line no 102 , L1600667055 , bytecode index = 
    stack[sp++].i = local[2].i;
    stack[sp++].i = local[5].i;
    stack[sp - 2].i = stack[sp - 2].i + stack[sp - 1].i; 
    --sp;
    ...
    ; 
    //  line no 103 , L2030036700 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // iconst_0
    stack[sp++].i = 0;
    // putfield jx/rdp/crypto/BlockMessageDigest buffered I
    ...
    goto L1103243338;
    L1190820921:
    //  line no 106 , L1190820921 , bytecode index = 
    stack[sp++].i = local[3].i;
    if(stack[--sp].i  <= 0) goto L137460818;
    ; 
    //  line no 107 , L1995619265 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield jx/rdp/crypto/BlockMessageDigest buffer [B
    ...
    ; 
    //  line no 108 , L1760126453 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ...
    ((struct jx_rdp_crypto_BlockMessageDigest*)rstack[sp + 0].obj)->buffered_1 = stack[sp + 1].i;
    L137460818:
    //  line no 110 , L137460818 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
JArray * func_jx_rdp_crypto_BlockMessageDigest_engineDigest____3B(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 120 , L1819776360 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 120;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
struct java_lang_String* func_jx_rdp_crypto_BlockMessageDigest_getAlgorithm___Ljava_lang_String_2(JThreadRuntime *runtime){
    ...
    s32 sp = 0;
    ; 
    //  line no 153 , L752684363 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
