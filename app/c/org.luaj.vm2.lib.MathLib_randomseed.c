// CLASS: org/luaj/vm2/lib/MathLib$randomseed extends org/luaj/vm2/lib/OneArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_MathLib_00024randomseed_static {};



__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_lib_MathLib_00024randomseed[] = {
    func_org_luaj_vm2_lib_MathLib_00024randomseed_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_lib_OneArgFunction[] = {
    func_org_luaj_vm2_lib_MathLib_00024randomseed_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024randomseed_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_MathLib_00024randomseed_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_MathLib_00024randomseed[] = {
    {230, 1, arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_lib_MathLib_00024randomseed}, //0
    {99, 5, arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_lib_OneArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024randomseed_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_MathLib_00024randomseed__init___Lorg_luaj_vm2_lib_MathLib_00024random_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_MathLib_00024random* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1297, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 254 , L80499834 , bytecode index = 
    ...
    ; 
    //  line no 255 , L1968552224 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/MathLib$randomseed random Lorg/luaj/vm2/lib/MathLib$random;
    sp -= 2;
    ((struct org_luaj_vm2_lib_MathLib_00024randomseed*)rstack[sp + 0].obj)->random_47 = rstack[sp + 1].obj;
    ; 
    //  line no 256 , L1095947149 , bytecode index = 
    method_exit(runtime);
    return;
    ; 
    __ExceptionHandler:
...
void bridge_org_luaj_vm2_lib_MathLib_00024randomseed__init___Lorg_luaj_vm2_lib_MathLib_00024random_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_MathLib_00024randomseed__init___Lorg_luaj_vm2_lib_MathLib_00024random_2_V(runtime, ins);
}
...
// stack: 5
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_MathLib_00024randomseed_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1298, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 258 , L1402531280 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 258;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 259 , L190628410 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/MathLib$randomseed random Lorg/luaj/vm2/lib/MathLib$random;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_MathLib_00024randomseed*)rstack[sp - 1].obj)->random_47;
    sp += 0;
    ...
    ; 
    //  line no 260 , L1556461159 , bytecode index = 
    // getstatic org/luaj/vm2/lib/MathLib$randomseed NONE Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_MathLib_00024randomseed_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_MathLib_00024randomseed_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
