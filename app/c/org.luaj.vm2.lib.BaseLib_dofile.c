// CLASS: org/luaj/vm2/lib/BaseLib$dofile extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024dofile_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_lib_BaseLib_00024dofile[] = {
    func_org_luaj_vm2_lib_BaseLib_00024dofile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024dofile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024dofile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024dofile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024dofile[] = {
    {147, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_lib_BaseLib_00024dofile}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024dofile_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_BaseLib_00024dofile__init___Lorg_luaj_vm2_lib_BaseLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_BaseLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 773, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 162 , L947553027 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 162;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/BaseLib$dofile this$0 Lorg/luaj/vm2/lib/BaseLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_BaseLib_00024dofile*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024dofile__init___Lorg_luaj_vm2_lib_BaseLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024dofile__init___Lorg_luaj_vm2_lib_BaseLib_2_V(runtime, ins);
}
...
// stack: 5
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_BaseLib_00024dofile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 774, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 164 , L352367347 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 164;
    rstack[sp++].obj = rlocal[1].obj;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  != 0) goto L2129442232;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    ...
    if(stack[--sp].i  == 0) goto L308433917;
    L2129442232:
    // iconst_1
    stack[sp++].i = 1;
    goto L1473981203;
    ...
    stack[sp++].i = 1;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1644);
    // invokevirtual org/luaj/vm2/Varargs.argcheck(ZILjava/lang/String;)V
    {
        sp -= 3;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        void (*__func_p) (JThreadRuntime *,s8,s32,struct java_lang_String*) = find_method(__ins->vm_table, 2, 45);
    ...
    ; 
    //  line no 165 , L1197251633 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    // invokevirtual org/luaj/vm2/Varargs.isstring(I)Z
    ...
    if(stack[--sp].i  == 0) goto L1552326679;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    ...
    ; 
    //  line no 166 , L1383519982 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    if(rstack[--sp].obj  != NULL) goto L1902671237;
    ; 
    //  line no 167 , L403174823 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/BaseLib$dofile this$0 Lorg/luaj/vm2/lib/BaseLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib_00024dofile*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/BaseLib$dofile this$0 Lorg/luaj/vm2/lib/BaseLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib_00024dofile*)rstack[sp - 1].obj)->this_000240_47;
    ...
    sp += 0;
    // getfield org/luaj/vm2/Globals STDIN Ljava/io/InputStream;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_Globals*)rstack[sp - 1].obj)->STDIN_51;
    sp += 0;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1645);
    //  ldc 
    ...
    goto L462526099;
    L1902671237:
    //  line no 168 , L1902671237 , bytecode index = 
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/BaseLib$dofile this$0 Lorg/luaj/vm2/lib/BaseLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib_00024dofile*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_BaseLib*)rstack[sp - 1].obj)->globals_47;
    sp += 0;
    // invokevirtual org/luaj/vm2/lib/BaseLib.loadFile(Ljava/lang/String;Ljava/lang/String;Lorg/luaj/vm2/LuaValue;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 3;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_Varargs* (*__func_p) (JThreadRuntime *,struct java_lang_String*,struct java_lang_String*,struct org_luaj_vm2_LuaValue*) = find_method(__ins->vm_table, 146, 2);
    ...
    ; 
    //  line no 169 , L2142565033 , bytecode index = 
    ...
    if(stack[--sp].i  == 0) goto L1304589447;
    rstack[sp++].obj = rlocal[3].obj;
    // iconst_2
    stack[sp++].i = 2;
    // invokevirtual org/luaj/vm2/Varargs.tojstring(I)Ljava/lang/String;
    ...
    // invokestatic org/luaj/vm2/lib/BaseLib$dofile.error(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
    ...
    // invokevirtual org/luaj/vm2/LuaValue.invoke()Lorg/luaj/vm2/Varargs;
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_Varargs* (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 1, 112);
        rstack[sp].obj = __func_p(runtime);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024dofile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024dofile_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
