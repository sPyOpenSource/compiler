// CLASS: org/luaj/vm2/lib/DebugLib$sethook extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024sethook_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_lib_DebugLib_00024sethook[] = {
    func_org_luaj_vm2_lib_DebugLib_00024sethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024sethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024sethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024sethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024sethook[] = {
    {357, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_lib_DebugLib_00024sethook}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024sethook_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_DebugLib_00024sethook__init___Lorg_luaj_vm2_lib_DebugLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_DebugLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3154, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 276 , L1230507176 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 276;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/DebugLib$sethook this$0 Lorg/luaj/vm2/lib/DebugLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_DebugLib_00024sethook*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024sethook__init___Lorg_luaj_vm2_lib_DebugLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024sethook__init___Lorg_luaj_vm2_lib_DebugLib_2_V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_DebugLib_00024sethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3155, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 278 , L1123830468 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 278;
    // iconst_1
    stack[sp++].i = 1;
    ...
    ; 
    //  line no 279 , L547507935 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  == 0) goto L697707311;
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    L697707311:
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/DebugLib$sethook this$0 Lorg/luaj/vm2/lib/DebugLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_DebugLib_00024sethook*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    ; 
    //  line no 280 , L1763000764 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    // aconst null
    rstack[sp++].obj = NULL;
    // invokevirtual org/luaj/vm2/Varargs.optfunction(ILorg/luaj/vm2/LuaFunction;)Lorg/luaj/vm2/LuaFunction;
    {
        sp -= 2;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaFunction* (*__func_p) (JThreadRuntime *,s32,struct org_luaj_vm2_LuaFunction*) = find_method(__ins->vm_table, 2, 17);
    ...
    ; 
    //  line no 281 , L1534279415 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    ; 
    //  line no 282 , L1134864869 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    stack[sp++].i = local[2].i;
    // iinc slot 2 value 1
    local[2].i += 1;
    ...
    ; 
    //  line no 283 , L1984954272 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    ...
    ; 
    //  line no 284 , L299837481 , bytecode index = 
    // iconst_0
    stack[sp++].i = 0;
    ...
    sp -= 2;
    if(stack[sp + 0].i  >= stack[sp + 1].i) goto L254041053;
    ; 
    //  line no 285 , L1794509290 , bytecode index = 
    rstack[sp++].obj = rlocal[5].obj;
    stack[sp++].i = local[10].i;
    ...
    L971324399:
    //  line no 286 , L971324399 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    local[7].i = stack[--sp].i;
    goto L42007293;
    L347239869:
    //  line no 287 , L347239869 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    local[8].i = stack[--sp].i;
    goto L42007293;
    L1322354584:
    //  line no 288 , L1322354584 , bytecode index = 
    // iconst_1
    stack[sp++].i = 1;
    local[9].i = stack[--sp].i;
    L42007293:
    //  line no 284 , L42007293 , bytecode index = 
    // iinc slot 10 value 1
    local[10].i += 1;
    if(runtime->suspend_count)check_suspend_and_pause(runtime);
    goto L417621837;
    L254041053:
    //  line no 290 , L254041053 , bytecode index = 
    ...
    ; 
    //  line no 291 , L1258539949 , bytecode index = 
    rstack[sp++].obj = rlocal[10].obj;
    rstack[sp++].obj = rlocal[4].obj;
    // putfield org/luaj/vm2/LuaThread$State hookfunc Lorg/luaj/vm2/LuaValue;
    sp -= 2;
    ((struct org_luaj_vm2_LuaThread_00024State*)rstack[sp + 0].obj)->hookfunc_6 = rstack[sp + 1].obj;
    ; 
    //  line no 292 , L1529457505 , bytecode index = 
    rstack[sp++].obj = rlocal[10].obj;
    stack[sp++].i = local[7].i;
    // putfield org/luaj/vm2/LuaThread$State hookcall Z
    sp -= 2;
    ((struct org_luaj_vm2_LuaThread_00024State*)rstack[sp + 0].obj)->hookcall_8 = stack[sp + 1].i;
    ; 
    //  line no 293 , L1546727972 , bytecode index = 
    rstack[sp++].obj = rlocal[10].obj;
    stack[sp++].i = local[8].i;
    // putfield org/luaj/vm2/LuaThread$State hookline Z
    sp -= 2;
    ((struct org_luaj_vm2_LuaThread_00024State*)rstack[sp + 0].obj)->hookline_7 = stack[sp + 1].i;
    ; 
    //  line no 294 , L505316221 , bytecode index = 
    rstack[sp++].obj = rlocal[10].obj;
    stack[sp++].i = local[6].i;
    // putfield org/luaj/vm2/LuaThread$State hookcount I
    sp -= 2;
    ((struct org_luaj_vm2_LuaThread_00024State*)rstack[sp + 0].obj)->hookcount_10 = stack[sp + 1].i;
    ; 
    //  line no 295 , L1268088240 , bytecode index = 
    rstack[sp++].obj = rlocal[10].obj;
    stack[sp++].i = local[9].i;
    // putfield org/luaj/vm2/LuaThread$State hookrtrn Z
    sp -= 2;
    ((struct org_luaj_vm2_LuaThread_00024State*)rstack[sp + 0].obj)->hookrtrn_9 = stack[sp + 1].i;
    ; 
    //  line no 296 , L1567732992 , bytecode index = 
    // getstatic org/luaj/vm2/lib/DebugLib$sethook NONE Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024sethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024sethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
