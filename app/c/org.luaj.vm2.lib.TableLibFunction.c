// CLASS: org/luaj/vm2/lib/TableLibFunction extends org/luaj/vm2/lib/LibFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_TableLibFunction_static {};



__refer arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_lib_TableLibFunction[] = {
    func_org_luaj_vm2_lib_TableLibFunction_call___Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_LibFunction_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_LibFunction_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_TableLibFunction[] = {
    {103, 1, arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_lib_TableLibFunction}, //0
    {18, 9, arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_lib_LibFunction}, //1
    {19, 10, arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_LuaFunction}, //2
    {1, 210, arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_LuaValue}, //3
    {2, 63, arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_org_luaj_vm2_Varargs}, //4
    {5, 10, arr_vmtable_org_luaj_vm2_lib_TableLibFunction_from_java_lang_Object}, //5
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_TableLibFunction__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2897, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 5 , L911201454 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_TableLibFunction__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_TableLibFunction__init____V(runtime, ins);
}
...
// stack: 2
// args: 0
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_TableLibFunction_call___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2898, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 7 , L306279528 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 7;
    // iconst_1
    stack[sp++].i = 1;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 4904);
    // invokestatic org/luaj/vm2/lib/TableLibFunction.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
...
void bridge_org_luaj_vm2_lib_TableLibFunction_call___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_TableLibFunction_call___Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
