// CLASS: org/luaj/vm2/lib/MathLib$frexp extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_MathLib_00024frexp_static {};



__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_lib_MathLib_00024frexp[] = {
    func_org_luaj_vm2_lib_MathLib_00024frexp_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024frexp_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024frexp_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_MathLib_00024frexp_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_MathLib_00024frexp[] = {
    {228, 1, arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_lib_MathLib_00024frexp}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024frexp_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_MathLib_00024frexp__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1342, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 186 , L178401052 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_MathLib_00024frexp__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_MathLib_00024frexp__init____V(runtime, ins);
}
...
// stack: 6
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_MathLib_00024frexp_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[7];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1343, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 188 , L936219350 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 188;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    // invokevirtual org/luaj/vm2/Varargs.checkdouble(I)D
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        f64 (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 2, 31);
    ...
    ; 
    //  line no 189 , L1495445111 , bytecode index = 
    ...
    if(stack[--sp].i  != 0) goto L1113829504;
    // getstatic org/luaj/vm2/lib/MathLib$frexp ZERO Lorg/luaj/vm2/LuaNumber;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.ZERO_17;
    sp += 1;
    // getstatic org/luaj/vm2/lib/MathLib$frexp ZERO Lorg/luaj/vm2/LuaNumber;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.ZERO_17;
    sp += 1;
    // invokestatic org/luaj/vm2/lib/MathLib$frexp.varargsOf(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 3;
    ...
    L1113829504:
    //  line no 190 , L1113829504 , bytecode index = 
    stack[sp].d = local[2].d;
    sp += 2;
    ...
    ; 
    //  line no 191 , L720770771 , bytecode index = 
    ...
    if(stack[--sp].i  < 0) goto L1911978617;
    //  ldc 
    stack[sp].d = 1.1102230246251565E-16;
    sp += 2;
    goto L1038820134;
    L1911978617:
    //  ldc 
    ...
    sp -= 2;
    sp -= 2;
    local[6].d = stack[sp].d;
    ; 
    //  line no 192 , L1658020779 , bytecode index = 
    stack[sp].j = local[4].j;
    sp += 2;
    //  bipush 52
    stack[sp++].i = 52;
    ...
    ++sp;
    sp -= 2;
    local[8].d = stack[sp].d;
    ; 
    //  line no 193 , L2022285740 , bytecode index = 
    stack[sp].d = local[6].d;
    sp += 2;
    // invokestatic org/luaj/vm2/lib/MathLib$frexp.valueOf(D)Lorg/luaj/vm2/LuaNumber;
    {
        sp -= 3;
...
void bridge_org_luaj_vm2_lib_MathLib_00024frexp_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_MathLib_00024frexp_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
