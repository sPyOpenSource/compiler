// CLASS: org/luaj/vm2/lib/DebugLib$setuservalue extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024setuservalue_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_lib_DebugLib_00024setuservalue[] = {
    func_org_luaj_vm2_lib_DebugLib_00024setuservalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setuservalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setuservalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024setuservalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue[] = {
    {358, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_lib_DebugLib_00024setuservalue}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024setuservalue_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_DebugLib_00024setuservalue__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3239, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 349 , L1528574692 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_DebugLib_00024setuservalue__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024setuservalue__init____V(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_DebugLib_00024setuservalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3240, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 351 , L1220292558 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 351;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    // invokevirtual org/luaj/vm2/Varargs.checkuserdata(I)Ljava/lang/Object;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct java_lang_Object* (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 2, 41);
    ...
    ; 
    //  line no 352 , L516570791 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_2
    stack[sp++].i = 2;
    ...
    ; 
    //  line no 353 , L620471432 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    ; 
    //  line no 354 , L1940311161 , bytecode index = 
    ...
    ; 
    //  line no 355 , L1515016092 , bytecode index = 
    rstack[sp++].obj = rlocal[4].obj;
    rstack[sp++].obj = rlocal[3].obj;
    ...
    ; 
    //  line no 356 , L356347252 , bytecode index = 
    // getstatic org/luaj/vm2/lib/DebugLib$setuservalue NONE Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024setuservalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024setuservalue_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
