// CLASS: org/luaj/vm2/lib/BaseLib$getmetatable extends org/luaj/vm2/lib/LibFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024getmetatable_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_lib_BaseLib_00024getmetatable[] = {
    func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call___Lorg_luaj_vm2_LuaValue_2,  //0
    func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //1
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call___Lorg_luaj_vm2_LuaValue_2,  //3
    func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
    func_org_luaj_vm2_lib_LibFunction_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //5
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call___Lorg_luaj_vm2_LuaValue_2,  //101
    func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
    func_org_luaj_vm2_LuaValue_call__Ljava_lang_String_2_Lorg_luaj_vm2_LuaValue_2,  //103
    func_org_luaj_vm2_lib_LibFunction_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //104
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable[] = {
    {315, 2, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_lib_BaseLib_00024getmetatable}, //0
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_lib_LibFunction}, //1
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_LuaFunction}, //2
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_LuaValue}, //3
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_org_luaj_vm2_Varargs}, //4
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024getmetatable_from_java_lang_Object}, //5
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_BaseLib_00024getmetatable__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1962, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 183 , L345780740 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_BaseLib_00024getmetatable__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024getmetatable__init____V(runtime, ins);
}
...
// stack: 2
// args: 0
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1963, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 185 , L1232792716 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 185;
    // iconst_1
    stack[sp++].i = 1;
    ...
    // invokestatic org/luaj/vm2/lib/BaseLib$getmetatable.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024getmetatable_call___Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call___Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1964, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 188 , L1315908533 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 188;
    ...
    ; 
    //  line no 189 , L568462037 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    if(rstack[--sp].obj  == NULL) goto L1063423209;
    rstack[sp++].obj = rlocal[2].obj;
    // getstatic org/luaj/vm2/lib/BaseLib$getmetatable METATABLE Lorg/luaj/vm2/LuaString;
    ...
    rstack[sp++].obj = rlocal[2].obj;
    // invokevirtual org/luaj/vm2/LuaValue.optvalue(Lorg/luaj/vm2/LuaValue;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *,struct org_luaj_vm2_LuaValue*) = find_method(__ins->vm_table, 1, 43);
        rstack[sp].obj = __func_p(runtime, rstack[sp + 0].obj);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    goto L904409454;
    L1063423209:
    // getstatic org/luaj/vm2/lib/BaseLib$getmetatable NIL Lorg/luaj/vm2/LuaValue;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024getmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024getmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
