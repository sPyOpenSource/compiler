// CLASS: org/luaj/vm2/lib/MathLib$fmod extends org/luaj/vm2/lib/TwoArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_MathLib_00024fmod_static {};



__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_lib_MathLib_00024fmod[] = {
    func_org_luaj_vm2_lib_MathLib_00024fmod_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_lib_TwoArgFunction[] = {
    func_org_luaj_vm2_lib_MathLib_00024fmod_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_MathLib_00024fmod_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //5
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_MathLib_00024fmod_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //104
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_MathLib_00024fmod[] = {
    {215, 1, arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_lib_MathLib_00024fmod}, //0
    {73, 5, arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_lib_TwoArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_MathLib_00024fmod_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_MathLib_00024fmod__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1214, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 166 , L1690233783 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_MathLib_00024fmod__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_MathLib_00024fmod__init____V(runtime, ins);
}
...
// stack: 4
// args: 2
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_MathLib_00024fmod_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[5];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 1215, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 168 , L198098993 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 168;
    ...
    if(stack[--sp].i  == 0) goto L553672556;
    ...
    if(stack[--sp].i  == 0) goto L553672556;
    ; 
    //  line no 169 , L854653864 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    // invokestatic org/luaj/vm2/lib/MathLib$fmod.valueOf(D)Lorg/luaj/vm2/LuaNumber;
    {
        sp -= 3;
    ...
    L553672556:
    //  line no 171 , L553672556 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    stack[sp - 4].d = stack[sp - 4].d - ((s32)(stack[sp - 4].d / stack[sp - 2].d) * stack[sp - 2].d); 
    sp -= 2;
    // invokestatic org/luaj/vm2/lib/MathLib$fmod.valueOf(D)Lorg/luaj/vm2/LuaNumber;
    {
        sp -= 3;
...
void bridge_org_luaj_vm2_lib_MathLib_00024fmod_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_MathLib_00024fmod_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins, para[0].obj);
}
