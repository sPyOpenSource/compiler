// CLASS: org/luaj/vm2/lib/BaseLib$tonumber extends org/luaj/vm2/lib/LibFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024tonumber_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_lib_BaseLib_00024tonumber[] = {
    func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
    func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //1
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_LibFunction_call___Lorg_luaj_vm2_LuaValue_2,  //3
    func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
    func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //5
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_LibFunction_call___Lorg_luaj_vm2_LuaValue_2,  //101
    func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
    func_org_luaj_vm2_LuaValue_call__Ljava_lang_String_2_Lorg_luaj_vm2_LuaValue_2,  //103
    func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //104
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber[] = {
    {373, 2, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_lib_BaseLib_00024tonumber}, //0
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_lib_LibFunction}, //1
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_LuaFunction}, //2
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_LuaValue}, //3
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_org_luaj_vm2_Varargs}, //4
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024tonumber_from_java_lang_Object}, //5
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_BaseLib_00024tonumber__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3146, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 334 , L547305607 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_BaseLib_00024tonumber__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024tonumber__init____V(runtime, ins);
}
...
// stack: 1
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3147, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 336 , L62085016 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 336;
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaValue.tonumber()Lorg/luaj/vm2/LuaValue;
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 1, 27);
...
void bridge_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 2
// args: 2
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3148, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 339 , L1191372709 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 339;
    ...
    if(stack[--sp].i  == 0) goto L1781368445;
    ; 
    //  line no 340 , L1941639991 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    // invokevirtual org/luaj/vm2/LuaValue.tonumber()Lorg/luaj/vm2/LuaValue;
    {
        sp -= 0;
    ...
    return rstack[sp - 1].obj;
    L1781368445:
    //  line no 341 , L1781368445 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    ...
    ; 
    //  line no 342 , L1751080205 , bytecode index = 
    stack[sp++].i = local[3].i;
    // iconst_2
    stack[sp++].i = 2;
    sp -= 2;
    if(stack[sp + 0].i  < stack[sp + 1].i) goto L942714988;
    stack[sp++].i = local[3].i;
    //  bipush 36
    stack[sp++].i = 36;
    sp -= 2;
    if(stack[sp + 0].i  <= stack[sp + 1].i) goto L1042863993;
    L942714988:
    //  line no 343 , L942714988 , bytecode index = 
    // iconst_2
    stack[sp++].i = 2;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 5242);
    // invokestatic org/luaj/vm2/lib/BaseLib$tonumber.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
    ...
    --sp; //pop
    L1042863993:
    //  line no 344 , L1042863993 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    stack[sp++].i = local[3].i;
    // invokevirtual org/luaj/vm2/LuaString.tonumber(I)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *,s32) = find_method(__ins->vm_table, 31, 99);
...
void bridge_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024tonumber_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins, para[0].obj);
}
