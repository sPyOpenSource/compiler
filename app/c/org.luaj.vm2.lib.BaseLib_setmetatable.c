// CLASS: org/luaj/vm2/lib/BaseLib$setmetatable extends org/luaj/vm2/lib/TableLibFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_BaseLib_00024setmetatable_static {};



__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_lib_BaseLib_00024setmetatable[] = {
    func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
    func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //1
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_lib_TableLibFunction[] = {
    func_org_luaj_vm2_lib_TableLibFunction_call___Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //4
    func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //5
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //102
    func_org_luaj_vm2_LuaValue_call__Ljava_lang_String_2_Lorg_luaj_vm2_LuaValue_2,  //103
    func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //104
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable[] = {
    {184, 2, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_lib_BaseLib_00024setmetatable}, //0
    {103, 1, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_lib_TableLibFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_BaseLib_00024setmetatable_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_BaseLib_00024setmetatable__init____V(JThreadRuntime *runtime){
    ...
    ; 
    //  line no 321 , L494077446 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_BaseLib_00024setmetatable__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_BaseLib_00024setmetatable__init____V(runtime, ins);
}
...
// stack: 2
// args: 1
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 942, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 323 , L989889899 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 323;
    // iconst_2
    stack[sp++].i = 2;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1928);
    // invokestatic org/luaj/vm2/lib/BaseLib$setmetatable.argerror(ILjava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 3;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins);
}
...
// stack: 2
// args: 2
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 943, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 326 , L902860396 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 326;
    ...
    // invokevirtual org/luaj/vm2/LuaTable.getmetatable()Lorg/luaj/vm2/LuaValue;
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *) = find_method(__ins->vm_table, 33, 9);
        rstack[sp].obj = __func_p(runtime);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
    ...
    ; 
    //  line no 327 , L1406206626 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    if(rstack[--sp].obj  == NULL) goto L1816522350;
    rstack[sp++].obj = rlocal[3].obj;
    // getstatic org/luaj/vm2/lib/BaseLib$setmetatable METATABLE Lorg/luaj/vm2/LuaString;
    rstack[sp].obj =static_var_org_luaj_vm2_LuaValue.METATABLE_26;
    sp += 1;
    ...
    if(stack[--sp].i  != 0) goto L1816522350;
    ; 
    //  line no 328 , L1799230133 , bytecode index = 
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1929);
    // invokestatic org/luaj/vm2/lib/BaseLib$setmetatable.error(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 2;
    ...
    --sp; //pop
    L1816522350:
    //  line no 329 , L1816522350 , bytecode index = 
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  == 0) goto L1521238608;
    // aconst null
    rstack[sp++].obj = NULL;
    goto L20156341;
    L1521238608:
    ...
    L20156341:
    // invokevirtual org/luaj/vm2/LuaValue.setmetatable(Lorg/luaj/vm2/LuaValue;)Lorg/luaj/vm2/LuaValue;
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        struct org_luaj_vm2_LuaValue* (*__func_p) (JThreadRuntime *,struct org_luaj_vm2_LuaValue*) = find_method(__ins->vm_table, 1, 100);
        rstack[sp].obj = __func_p(runtime, rstack[sp + 0].obj);
        sp += 1;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
...
void bridge_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_BaseLib_00024setmetatable_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins, para[0].obj);
}
