// CLASS: org/luaj/vm2/lib/DebugLib$gethook extends org/luaj/vm2/lib/VarArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_DebugLib_00024gethook_static {};



__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_lib_DebugLib_00024gethook[] = {
    func_org_luaj_vm2_lib_DebugLib_00024gethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_lib_VarArgFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024gethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //4
    func_org_luaj_vm2_lib_VarArgFunction_onInvoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //5
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_DebugLib_00024gethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2  //8
};
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_DebugLib_00024gethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2,  //113
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_DebugLib_00024gethook[] = {
    {356, 1, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_lib_DebugLib_00024gethook}, //0
    {17, 6, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_lib_VarArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_DebugLib_00024gethook_from_java_lang_Object}, //6
};
...
// stack: 2
// args: 1
void func_org_luaj_vm2_lib_DebugLib_00024gethook__init___Lorg_luaj_vm2_lib_DebugLib_2_V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_DebugLib* p0){
    ...
    RStackItem rstack[3];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3139, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 150 , L687947506 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 150;
    rstack[sp++].obj = rlocal[0].obj;
    rstack[sp++].obj = rlocal[1].obj;
    // putfield org/luaj/vm2/lib/DebugLib$gethook this$0 Lorg/luaj/vm2/lib/DebugLib;
    sp -= 2;
    ((struct org_luaj_vm2_lib_DebugLib_00024gethook*)rstack[sp + 0].obj)->this_000240_47 = rstack[sp + 1].obj;
    rstack[sp++].obj = rlocal[0].obj;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024gethook__init___Lorg_luaj_vm2_lib_DebugLib_2_V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_DebugLib_00024gethook__init___Lorg_luaj_vm2_lib_DebugLib_2_V(runtime, ins);
}
...
// stack: 3
// args: 1
struct org_luaj_vm2_Varargs* func_org_luaj_vm2_lib_DebugLib_00024gethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, struct org_luaj_vm2_Varargs* p0){
    ...
    RStackItem rstack[4];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 3140, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 152 , L1529580934 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 152;
    rstack[sp++].obj = rlocal[1].obj;
    ...
    if(stack[--sp].i  <= 0) goto L2146372416;
    rstack[sp++].obj = rlocal[1].obj;
    // iconst_1
    stack[sp++].i = 1;
    ...
    L2146372416:
    rstack[sp++].obj = rlocal[0].obj;
    // getfield org/luaj/vm2/lib/DebugLib$gethook this$0 Lorg/luaj/vm2/lib/DebugLib;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_lib_DebugLib_00024gethook*)rstack[sp - 1].obj)->this_000240_47;
    sp += 0;
    ...
    ; 
    //  line no 153 , L435167872 , bytecode index = 
    ...
    ; 
    //  line no 155 , L506518405 , bytecode index = 
    ...
    sp += 0;
    if(rstack[--sp].obj  == NULL) goto L427980296;
    rstack[sp++].obj = rlocal[3].obj;
    // getfield org/luaj/vm2/LuaThread$State hookfunc Lorg/luaj/vm2/LuaValue;
    rstack[sp - 1].obj = ((struct org_luaj_vm2_LuaThread_00024State*)rstack[sp - 1].obj)->hookfunc_6;
    sp += 0;
    goto L214560653;
    L427980296:
    // getstatic org/luaj/vm2/lib/DebugLib$gethook NIL Lorg/luaj/vm2/LuaValue;
    ...
    ; 
    //  line no 156 , L347416758 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    ...
    sp += 0;
    if(stack[--sp].i  == 0) goto L205595990;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 4779);
    goto L116994272;
    L205595990:
    //  ldc 
    ...
    sp += 0;
    if(stack[--sp].i  == 0) goto L1158611509;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 5233);
    goto L2026005178;
    L1158611509:
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 617);
    ...
    sp += 0;
    if(stack[--sp].i  == 0) goto L2100073313;
    //  ldc 
    ...
    // invokestatic org/luaj/vm2/lib/DebugLib$gethook.valueOf(Ljava/lang/String;)Lorg/luaj/vm2/LuaString;
    {
        sp -= 2;
    ...
    sp += 0;
    ; 
    //  line no 157 , L264138968 , bytecode index = 
    // invokestatic org/luaj/vm2/lib/DebugLib$gethook.valueOf(I)Lorg/luaj/vm2/LuaInteger;
    {
        sp -= 2;
    ...
    ; 
    //  line no 154 , L1677857831 , bytecode index = 
    // invokestatic org/luaj/vm2/lib/DebugLib$gethook.varargsOf(Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Varargs;)Lorg/luaj/vm2/Varargs;
    {
        sp -= 4;
...
void bridge_org_luaj_vm2_lib_DebugLib_00024gethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_DebugLib_00024gethook_invoke__Lorg_luaj_vm2_Varargs_2_Lorg_luaj_vm2_Varargs_2(runtime, ins);
}
