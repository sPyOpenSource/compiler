// CLASS: org/luaj/vm2/lib/CoroutineLib extends org/luaj/vm2/lib/TwoArgFunction
#include "metadata.h"


// generation
// globals
//struct org_luaj_vm2_lib_CoroutineLib_static {s32 coroutine_1count_47;  };
struct org_luaj_vm2_lib_CoroutineLib_static static_var_org_luaj_vm2_lib_CoroutineLib = {0};


__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_lib_CoroutineLib[] = {
    func_org_luaj_vm2_lib_CoroutineLib_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2  //0
};
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_lib_TwoArgFunction[] = {
    func_org_luaj_vm2_lib_CoroutineLib_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //0
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_lib_LibFunction[] = {
    ...
    func_org_luaj_vm2_lib_CoroutineLib_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //5
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_LuaFunction[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_LuaValue[] = {
    func_org_luaj_vm2_LuaFunction_type___I,  //0
    func_org_luaj_vm2_LuaFunction_typename___Ljava_lang_String_2,  //1
    ...
    func_org_luaj_vm2_lib_CoroutineLib_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2,  //104
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_Varargs[] = {
...
__refer arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_java_lang_Object[] = {
...
VMTable vmtable_org_luaj_vm2_lib_CoroutineLib[] = {
    {325, 1, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_lib_CoroutineLib}, //0
    {73, 5, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_lib_TwoArgFunction}, //1
    {18, 9, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_lib_LibFunction}, //2
    {19, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_LuaFunction}, //3
    {1, 210, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_LuaValue}, //4
    {2, 63, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_org_luaj_vm2_Varargs}, //5
    {5, 10, arr_vmtable_org_luaj_vm2_lib_CoroutineLib_from_java_lang_Object}, //6
};
...
// stack: 1
// args: 0
void func_org_luaj_vm2_lib_CoroutineLib__init____V(JThreadRuntime *runtime){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2147, &rstack[0], &rlocal[0], &sp);
    ; 
    //  line no 63 , L1547965072 , bytecode index = 
...
void bridge_org_luaj_vm2_lib_CoroutineLib__init____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_CoroutineLib__init____V(runtime, ins);
}
...
// stack: 5
// args: 2
struct org_luaj_vm2_LuaValue* func_org_luaj_vm2_lib_CoroutineLib_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, struct org_luaj_vm2_LuaValue* p0, struct org_luaj_vm2_LuaValue* p1){
    ...
    RStackItem rstack[6];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2148, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    rlocal[1].obj = p1;
    ; 
    //  line no 76 , L2132736278 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 76;
    rstack[sp++].obj = rlocal[0].obj;
    ...
    // putfield org/luaj/vm2/lib/CoroutineLib globals Lorg/luaj/vm2/Globals;
    sp -= 2;
    ((struct org_luaj_vm2_lib_CoroutineLib*)rstack[sp + 0].obj)->globals_48 = rstack[sp + 1].obj;
    ; 
    //  line no 77 , L411474203 , bytecode index = 
    ...
    ; 
    //  line no 78 , L1688918025 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3812);
    // new org/luaj/vm2/lib/CoroutineLib$create
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 321);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ++sp;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial org/luaj/vm2/lib/CoroutineLib$create.<init>(Lorg/luaj/vm2/lib/CoroutineLib;)V
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_lib_CoroutineLib_00024create__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(runtime, rstack[sp + 0].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 79 , L520354720 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3813);
    // new org/luaj/vm2/lib/CoroutineLib$resume
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 322);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ++sp;
    // invokespecial org/luaj/vm2/lib/CoroutineLib$resume.<init>()V
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_lib_CoroutineLib_00024resume__init____V(runtime);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 80 , L400385823 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3121);
    // new org/luaj/vm2/lib/CoroutineLib$running
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 323);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ++sp;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial org/luaj/vm2/lib/CoroutineLib$running.<init>(Lorg/luaj/vm2/lib/CoroutineLib;)V
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_lib_CoroutineLib_00024running__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(runtime, rstack[sp + 0].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 81 , L1002400446 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 2936);
    // new org/luaj/vm2/lib/CoroutineLib$status
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 25);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ++sp;
    // invokespecial org/luaj/vm2/lib/CoroutineLib$status.<init>()V
    {
        sp -= 0;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_lib_CoroutineLib_00024status__init____V(runtime);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 82 , L157783888 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3117);
    // new org/luaj/vm2/lib/CoroutineLib$yield
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 196);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ++sp;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial org/luaj/vm2/lib/CoroutineLib$yield.<init>(Lorg/luaj/vm2/lib/CoroutineLib;)V
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_lib_CoroutineLib_00024yield__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(runtime, rstack[sp + 0].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 83 , L163160871 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 266);
    // new org/luaj/vm2/lib/CoroutineLib$wrap
    rstack[sp++].obj = new_instance_with_classraw_index(runtime, 324);
    // dup
    stack[sp].j = stack[sp - 1].j; 
    rstack[sp].obj = rstack[sp - 1].obj; 
    ++sp;
    rstack[sp++].obj = rlocal[0].obj;
    // invokespecial org/luaj/vm2/lib/CoroutineLib$wrap.<init>(Lorg/luaj/vm2/lib/CoroutineLib;)V
    {
        sp -= 1;
        JObject *__ins = rstack[sp + 0].ins;
        if (!__ins) {
        ...
        func_org_luaj_vm2_lib_CoroutineLib_00024wrap__init___Lorg_luaj_vm2_lib_CoroutineLib_2_V(runtime, rstack[sp + 0].obj);
        sp += 0;
        if (runtime->exception) {
            rstack[sp++].obj = runtime->exception;
            goto __ExceptionHandler;
    ...
    ; 
    //  line no 84 , L1973471376 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 3814);
    rstack[sp++].obj = rlocal[3].obj;
    ...
    ; 
    //  line no 85 , L898283008 , bytecode index = 
    rstack[sp++].obj = rlocal[2].obj;
    //  ldc 
    ...
    if(stack[--sp].i  != 0) goto L14838518;
    rstack[sp++].obj = rlocal[2].obj;
    //  ldc 
    rstack[sp++].obj = construct_string_with_utfraw_index(runtime, 1588);
    // invokevirtual org/luaj/vm2/LuaValue.get(Ljava/lang/String;)Lorg/luaj/vm2/LuaValue;
    ...
    L14838518:
    //  line no 86 , L14838518 , bytecode index = 
    rstack[sp++].obj = rlocal[3].obj;
    method_exit(runtime);
...
void bridge_org_luaj_vm2_lib_CoroutineLib_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    ret->obj = func_org_luaj_vm2_lib_CoroutineLib_call__Lorg_luaj_vm2_LuaValue_2Lorg_luaj_vm2_LuaValue_2_Lorg_luaj_vm2_LuaValue_2(runtime, ins, para[0].obj);
}
...
// stack: 1
// args: 1
void func_org_luaj_vm2_lib_CoroutineLib__clinit____V(JThreadRuntime *runtime, struct org_luaj_vm2_lib_CoroutineLib* p0){
    ...
    RStackItem rstack[2];
    s32 sp = 0;
    StackFrame *__frame = method_enter(runtime, 2149, &rstack[0], &rlocal[0], &sp);
    rlocal[0].obj = p0;
    ; 
    //  line no 65 , L932312334 , bytecode index = 
    __frame->bytecodeIndex = 
    __frame->lineNo = 65;
    // iconst_0
    stack[sp++].i = 0;
    // putstatic org/luaj/vm2/lib/CoroutineLib coroutine_count I
    sp -= 1;
    static_var_org_luaj_vm2_lib_CoroutineLib.coroutine_1count_47 = stack[sp].i;
    method_exit(runtime);
    return;
    __ExceptionHandler:
    switch (find_exception_handler_index(runtime)) {
...
void bridge_org_luaj_vm2_lib_CoroutineLib__clinit____V(JThreadRuntime *runtime, __refer ins, ParaItem *para, ParaItem *ret) {
    func_org_luaj_vm2_lib_CoroutineLib__clinit____V(runtime, para[0].obj);
}
