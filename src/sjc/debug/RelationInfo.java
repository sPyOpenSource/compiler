...
public class RelationInfo extends DebugWriter {
  ...
  public void globalStringInfo(int stringCount, int stringChars,
      int stringMemBytes) {}
    ...
    while (units!=null) {
      ...
      while (outer!=null) {
        ...
        while (inner!=null) {
          ...
          out.print(';');
          outer.unit.printNameWithOuter(out); out.print(';');
          if (outer.mthd!=null) outer.mthd.printSig(out);
          out.print(';');
          if (outer.var!=null) out.print(outer.var.name);
          out.print(';');
          if (inner.unit.pack!=null) inner.unit.pack.packDest.printFullName(out);
          out.print(';');
          inner.unit.printNameWithOuter(out); out.print(';');
          if (inner.mthd!=null) inner.mthd.printSig(out);
          out.println();
          inner=inner.next;
        }
        outer=outer.next;
