...
public class ExObjInit extends ExConstInitObj {
  ...
  public boolean resolve(Unit unitContext, Mthd mthdContext,
    ...
    dest.minSize=-1;
    dest.type=type;
    if (!type.resolveType(unitContext, ctx)) return false;
    ...
    while (var!=null) {
      ...
      if (!var.init.resolve(unitContext, mthdContext, resolveFlags, var.destVar.type, ctx)) return false;
    ...
    while (var!=null) {
      ...
      switch (var.destVar.location) {
        case Vrbl.L_INSTREL:
          ...
          ctx.arch.putRef(obj, var.destVar.relOff, initObj.outputLocation,
              initObj.getOutputLocationOffset(ctx));
          break;
        case Vrbl.L_INSTIDS:
          ids=true;
        ...
        case Vrbl.L_INSTSCL:
          ...
          break;
        case Vrbl.L_INLARR:
          if (!arr.putElements(obj, typeUnit.instScalarTableSize, false, ctx)) return false;
