...
public class StEndLoop extends Stmt {
	...
	public StEndLoop(StBreakable io, String it, int fid, int il, int ic) {
		super(fid, il, ic);
		outer=io;
		labelToEnd=it;
	}
    ...
    o=outer;
	  if (labelToEnd==null) { //no label given
	    while (o!=null && !o.isBreakContDest(false, contNotBreak)) o=o.outer;
	    if (o==null) {
