...
public class StForEnh extends StLoop {
  ...
  public StForEnh(StBreakable io, StringList ila, int fid, int il, int ic) {
  ...
  protected int innerResolve(int flowCode, Unit unitContext, Mthd mthdContext, Context ctx) {
    ...
    if ((var.resolve(0, unitContext, mthdContext, ctx)&FA_ERROR)!=0) return FA_ERROR; //var-decl may not change flow
    ...
    if (((flowCode=loStmt.resolve(flowCode, unitContext, mthdContext, ctx))&FA_ERROR)!=0) return FA_ERROR;
