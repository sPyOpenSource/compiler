...
public class StRetMissing extends Stmt {
    ...
    if ((flowCode&FA_NEXT_IS_UNREACHABLE)==0) flowWarn(ctx, "reached end of method without return");
    return flowCode;
	}
	
	protected int innerResolve(int flowCode, Unit unitContext, Mthd mthdContext, Context ctx) { //should never be called as resolve is overwritten
