...
public class SymbolFactory {
  ...
  public static SymbolInformer getSymbolGenerator(String name) {
    if (name.equals("raw")) return new RawSymbols();
    if (name.equals("rte")) return new RTESymbols();
    if (name.equals("mthd")) return new MthdSymbols();
    if (name.equals("refl")) return preparedReflectionSymbols;
    return null;
  }
}
