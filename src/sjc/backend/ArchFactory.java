...
public class ArchFactory {
  ...
  public static Architecture getArchitecture(String name, Architecture currentArchitecture,
      TextPrinter v) {
    ...
    if (name.equals("ssa2amd64")) return new SSAopt(new SSAopt2amd(), 8);
    if (name.equals("ssa32")) return new SSA(4);
    if (name.equals("ssa64")) return new SSA(8);
