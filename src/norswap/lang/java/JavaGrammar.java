...
import norswap.lang.java.ast.expr.BinaryExpression;
...
import norswap.lang.java.ast.expr.InstanceOf;
import norswap.lang.java.ast.expr.Lambda;
...
public final class JavaGrammar extends Grammar
{
    ...
    public rule annotation_element_list =
        ...
        .push($ -> new AnnotationElementList($.$list()));
    ...
    public rule single_element_annotation_suffix =
        ...
        .push($ -> new SingleElementAnnotation($.$0(), $.$1()),
            LOOKBACK(1));
    ...
    public rule class_type_part =
        ...
        .push($ -> new ClassTypePart($.$0(), $.$1(), $.$2()));

    public rule class_type =
        class_type_part.sep(1, DOT)
        .push($ -> new ClassType($.$list()));
    ...
    public rule dim_expr_array_creator =
        ...
        .push($ -> new ArrayConstructorCall($.$0(), $.$1(), $.$2(), null));

    public rule init_array_creator =
        seq(stem_type, dims1, array_init)
        .push($ -> new ArrayConstructorCall($.$0(), emptyList(), $.$1(), $.$2()));
    ...
    public rule method_ref_suffix =
        iden
        .push($ -> new TypeMethodReference($.$0(), $.$1(), $.$2()),
            LOOKBACK(2));
    ...
    public rule postfix_expr = left_expression()
        ...
        .suffix(seq(DOT, _this),
            $ -> new UnaryExpression(DOT_THIS, $.$0()))
        .suffix(seq(DOT, _super),
            $ -> new UnaryExpression(DOT_SUPER, $.$0()))
        .suffix(seq(DOT, ctor_call),
            $ -> new DotNew($.$0(), $.$1()))
        .suffix(seq(LBRACKET, _expr, RBRACKET),
            $ -> new ArrayAccess($.$0(), $.$1()))
        .suffix(PLUSPLUS,
            $ -> new UnaryExpression(POSTFIX_INCREMENT, $.$0()))
        .suffix(SUBSUB,
            $ -> new UnaryExpression(POSTFIX_DECREMENT, $.$0()))
        .suffix(seq(COLCOL, opt_type_args, iden),
            $ -> new BoundMethodReference($.$0(), $.$1(), $.$2()));

    public rule prefix_expr = right_expression()
        .right(postfix_expr)
        .prefix(prefix_op,
            $ -> new UnaryExpression($.$0(), $.$1()))
    ...
    public rule variadic_param_suffix =
        ...
        .push($ -> new VariadicParameter($.$0(), $.$1(), $.$2(), $.$3()),
            LOOKBACK(2));
    ...
    public rule untyped_params =
        ...
        .push($ -> new UntypedParameters(list()));
    ...
    public rule constructor_decl_suffix =
        ...
        .push($ -> new ConstructorDeclaration(
            $.$0(), $.$1(), $.$2(), $.$3(), $.$4(), $.$5()),
                LOOKBACK(1));
    ...
    public rule enum_decl_suffix =
        ...
        .push($ -> new TypeDeclaration(Kind.ENUM,
            $.$0(), $.$1(), $.$2(), $.$3(), $.$4(), $.$5()),
                LOOKBACK(1));
    ...
    public rule annot_elem_decl =
        ...
        .push($ -> new AnnotationElementDeclaration(
            $.$0(), $.$1(), $.$2(), $.$3(), $.$4()));
    ...
    public rule annotation_decl_suffix =
        ...
        .push($ -> new TypeDeclaration(Kind.ANNOTATION,
            $.$0(), $.$1(), $.$2(), $.$3(), $.$4(), $.$5()),
                LOOKBACK(1));
    ...
    public rule class_decl_suffix =
        ...
        .push($ -> new TypeDeclaration(Kind.CLASS,
            $.$0(), $.$1(), $.$2(), $.$3(), $.$4(), $.$5()),
                LOOKBACK(1));

    public rule interface_declaration_suffix =
        seq(_interface, type_sig, type_body)
        .push($ -> new TypeDeclaration(Kind.INTERFACE,
            $.$0(), $.$1(), $.$2(), $.$3(), $.$4(), $.$5()),
                LOOKBACK(1));
    ...
    public rule default_label =
        seq(_default, COL)
        .push($ -> new DefaultLabel());

    public rule case_label =
        seq(_case, expr, COL)
        .push($ -> new CaseLabel($.$0()));
    ...
    public rule package_decl =
        ...
        .push($ -> new PackageDeclaration($.$0(), $.$1()));
