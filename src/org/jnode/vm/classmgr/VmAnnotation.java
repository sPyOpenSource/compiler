...
public final class VmAnnotation extends VmSystemObject {
     ...
     */
    private int indexOfElementValue(String name) {
        for (int i = 0;; i++) {
    ...
    static final class ElementValue extends VmSystemObject {
        ...
        private Object resolve(Object value, VmClassLoader loader, VmType<?> valueType)
            throws ClassNotFoundException {
    ...
    public static final class ImplBase implements Annotation {
        ...
        private VmType getReturnType(VmType<?> type, String elemName) {
            for (int i = 0;; i++) {
