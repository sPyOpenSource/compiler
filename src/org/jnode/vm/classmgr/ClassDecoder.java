...
public final class ClassDecoder {
     ...
     */
    private static VmLineNumberMap readLineNrTable(ByteBuffer data) {
     ...
     * @return The line number map
     */
    private static VmLocalVariableTable readLocalVariableTable(
    ...
    private static void skip(ByteBuffer data, int delta) {
        data.position(data.position() + delta);
    }

    private static ByteBuffer readBytes(ByteBuffer data, int length) {
        final ByteBuffer result = (ByteBuffer) data.slice().limit(length);
        data.position(data.position() + length);
        return result;
    }

    private static String readUTF(ByteBuffer data) {
    ...
    private static char[] getUtfConversionBuffer(int utfLength) {
