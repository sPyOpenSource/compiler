...
public final class VmX86Architecture32 extends VmX86Architecture {
     ...
     * @param vmAddress
     */
    private void mapPage(Address vmAddress, Address physAddr, Extent pageSize, boolean debug) {
     ...
     * @param end
     */
    private void removeVirtualMMap(Word start, Word end, Extent pageSize) {
