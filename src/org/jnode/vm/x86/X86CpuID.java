...
public class X86CpuID extends CpuID {
    ...
    public static final int FEAT_FPU = (1);
    ...
    private void getFeatureString(StringBuilder buf, int feature, String featName) {
    ...
    private void getFeatureString(StringBuilder buf, long feature, String featName) {
        if (hasFeature(feature)) {
            if (buf.length() > 0) {
                buf.append(',');
            }
