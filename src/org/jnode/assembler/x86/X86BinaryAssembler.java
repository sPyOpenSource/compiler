...
public class X86BinaryAssembler extends X86Assembler implements X86Operation {
    ...
    public class X86ObjectRef extends NativeStream.ObjectRef {
         ...
         * @param offset
         */
        private void resolve8(int addr, int offset) {
...
//            System.out.println("offset " + offset);
         ...
         * @param offset
         */
        private void resolve32(int addr, int offset) {
         ...
         * @param offset
         */
        private void resolve64(int addr, int offset) {
    ...
    public final Collection<ObjectRef> getUnresolvedObjectRefs() {
        ...
        final LinkedList<ObjectRef> result = new LinkedList<>();
    ...
    public final boolean hasUnresolvedObjectRefs() {
        final Collection<X86ObjectRef> coll = getObjectRefs();
        if (coll.stream().filter((ref) -> (!ref.isResolved())).anyMatch((ref) -> (!(ref.getObject() instanceof Label)))) {
            return true;
        }
        return false;
    }
