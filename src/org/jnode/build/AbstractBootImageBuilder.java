...
public abstract class AbstractBootImageBuilder extends AbstractPluginsTask {
     ...
     */
    private void compileClasses(NativeStream os, BaseVmArchitecture arch)
        throws ClassNotFoundException {
...
//                log("  " + name);
    ...
    private void doExecute() throws BuildException {
        ...
        try {
            ...
            for (VmType<?> systemClasse : systemClasses)
                clsMgr.addLoadedClass(systemClasse.getName(), systemClasse);
            ...
            for (NativeCodeCompiler cmp : cmps) {
            ...
            if (testCmps != null) {
                for (NativeCodeCompiler cmp : testCmps) {
                    cmp.initialize(clsMgr);
                    os.getObjectRef(cmp);
                }
            }
...
//            copyJarFile(blockedObjects, piRegistry);
     ...
     * @throws BuildException
     */
    private void emitObjects(NativeStream os, BaseVmArchitecture arch,
     ...
     * @return Set&lt;String&gt;
     */
    protected final Set<String> setupLegalInstanceClasses() {
